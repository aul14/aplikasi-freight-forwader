...
return new class extends Migration
{
    ...
    public function up()
    {
        Schema::create('sea_quotation_s_d1', function (Blueprint $table) {
            $table->id();
            $table->foreignId('sea_quotation_id')->nullable();
            $table->foreignId('sea_quotation_d1_id')->nullable();
            $table->string('sea_quotation_d1_code', 25)->nullable();
    ...
    {
        Schema::dropIfExists('sea_quotation_s_d1');
    }
};
