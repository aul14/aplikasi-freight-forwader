        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="row">
                    ...
                    <div class="col-md-2">
                        <a href="javascript:void(0)" target="_blank" class="link-jc">JOB COSTING (P&L)</a>
                    </div>
                </div>
                {{-- 
                <div class="row">
                    ...
                    <div class="col-md-2">
                        <a href="javascript:void(0)">SHIPPING INSTRUCTION</a>
                    </div>
                </div>
                <div class="row">
                    <div class="col-md-2">
                    ...
                    <div class="col-md-2">
                        <a href="javascript:void(0)">BILL OF LADING</a>
                    </div>
                </div>
                <div class="row">
                    <div class="col-md-2">
                    ...
                    <div class="col-md-2">
                        <a href="javascript:void(0)">EXPORT CARGO MANIFEST</a>
                    </div>
                </div> --}}
                <div class="row">
                    <div class="col-md-2">
...
<script>
    $(function() {
        ...
        $(`.btn-print`).click(function(e) {
            ...
            // 1. JOB SHEET
            let url_js = '{{ route('pdf.sea_ex_job', ':id') }}';
            url_js = url_js.replace(':id', `${id}/js`);
            $('.link-js').attr('href', url_js);
            // 2. JOB ORDER
            let url_jo = '{{ route('pdf.sea_ex_job', ':id') }}';
            url_jo = url_jo.replace(':id', `${id}/jo`);
            $('.link-jo').attr('href', url_jo);
            // 3. JOB COSTING
            let url_jc = '{{ route('pdf.sea_ex_job', ':id') }}';
            url_jc = url_jc.replace(':id', `${id}/jc`);
            $('.link-jc').attr('href', url_jc);
