        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                {{-- <div class="row">
                    ...
                    <div class="col-md-2">
                        <a href="javascript:void(0)">AIR CARGO MANIFEST</a>
                    </div>
                </div>
                <div class="row">
                    <div class="col-md-2">
                    ...
                    <div class="col-md-2">
                        <a href="javascript:void(0)">HOUSE AWB</a>
                    </div>
                </div>
                <div class="row">
                    <div class="col-md-2">
                    ...
                    <div class="col-md-2">
                        <a href="javascript:void(0)">MASTER AIR WAYBILL</a>
                    </div>
                </div> --}}
            </div>
...
<script>
    $(function() {
        ...
        $(`.btn-print`).click(function(e) {
            ...
            // 1. JOB SHEET
            let url_js = '{{ route('pdf.air_ex_job', ':id') }}';
            url_js = url_js.replace(':id', `${id}/js`);
            $('.link-js').attr('href', url_js);
            // 2. JOB ORDER
            let url_jo = '{{ route('pdf.air_ex_job', ':id') }}';
