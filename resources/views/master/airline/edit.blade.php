                        ...
                        <div class="row">
                            <div class="col-md-6">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" value="{{ old('airline_id', $airline->airline_id) }}"
                                        class="form-control @error('airline_id') is-invalid @enderror" autofocus
                                        autocomplete="off" readonly name="airline_id" id="airline_id">
                                    @error('airline_id')
                                        <div class="invalid-feedback">
                                            {{ $message }}
                                        </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" value="{{ old('name', $airline->name) }}"
                                ...
                                <div class="form-group">
                                    ...
                                    <select class="bisnis_party-select" name="bisnis_party_id">
                                        <option value="{{ $airline->bisnis_party_id }}">
                                            {{ $airline->bisnis_party_id != null ? $airline->bisnis_party->code : '' }}
                                        </option>
                                    </select>
                                ...
                                <div class="row">
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <div class="form-check">
                                                <input class="form-check-input" type="checkbox" @checked(old('is_vendor', $airline->is_vendor) == '1')
                                                    value="1" id="is_vendor" name="is_vendor"
                                                    @disabled($airline->is_vendor == '1')>
                                    ...
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            ...
                                            <input type="text" value="{{ old('vendor_code', $airline->vendor_code) }}"
                                    ...
                                    <div class="col-md-5">
                                        <div class="form-group">
                                            ...
                                            <input type="text"
                                                value="{{ old('vendor_acc_code', $airline->vendor_acc_code) }}"
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" value="{{ old('email', $airline->email) }}"
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" value="{{ old('web_site', $airline->web_site) }}"
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" value="{{ old('contact', $airline->contact) }}"
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" value="{{ old('comission', $comission) }}"
                                        data-type='currency3'
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" value="{{ old('left_margin', $left_margin) }}"
                                        data-type='currency'
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" value="{{ old('top_margin', $top_margin) }}"
                                        data-type='currency'
                                ...
                                <div class="form-group">
                                    ...
                                    @if ($airline->image_airline)
                                        <img class="img-preview img-fluid mb-3 col-sm-5 d-block"
                                            src="{{ asset("storage/{$airline->image_airline}") }}">
                                    @else
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" value="{{ old('address_1', $airline->address_1) }}"
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" value="{{ old('address_2', $airline->address_2) }}"
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" value="{{ old('address_3', $airline->address_3) }}"
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" value="{{ old('address_4', $airline->address_4) }}"
                                ...
                                <div class="row">
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <select class="city-select" name="city_id">
                                                <option value="{{ $airline->city_id }}">
                                                    {{ $airline->city_id != null ? $airline->city->code : '' }}
                                                </option>
                                            </select>
                                    ...
                                    <div class="col-md-8">
                                        <div class="form-group">
                                            ...
                                            <input type="text"
                                                value="{{ old('city_desc', $airline->city_id != null ? $airline->city->name : '') }}"
                                ...
                                <div class="row mt-1">
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <select class="country-select" name="country_id">
                                                <option value="{{ $airline->country_id }}">
                                                    {{ $airline->country_id != null ? $airline->country->code : '' }}
                                                </option>
                                            </select>
                                    ...
                                    <div class="col-md-8">
                                        <div class="form-group">
                                            ...
                                            <input type="text"
                                                value="{{ old('country_desc', $airline->country_id != null ? $airline->country->name : '') }}"
                                ...
                                <div class="row">
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="telp_idd"
                                                value="{{ $airline->country_id != null ? $airline->country->idd : '' }}"
                                    ...
                                    <div class="col-md-8">
                                        <div class="form-group">
                                            ...
                                            <input type="text" value="{{ old('telp', $airline->telp) }}"
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-8">
                                        <div class="form-group">
                                            <label for="fax"> &nbsp;</label>
                                            <input type="text" value="{{ old('fax', $airline->fax) }}"
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" value="{{ old('terminal', $airline->terminal) }}"
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" value="{{ old('analysis_code', $airline->analysis_code) }}"
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-6">
                                        <input type="checkbox" name="neutral" @checked(old('neutral', $airline->neutral) == 'yes') value="yes"
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-6">
                                        <input type="checkbox" name="ccn" @checked(old('ccn', $airline->ccn) == 'yes') value="yes"
                                            data-toggle="toggle" data-on="Yes" data-off="No" data-onstyle="primary"
                                            data-offstyle="danger">
                                    </div>
                                </div>
