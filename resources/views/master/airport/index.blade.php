            ...
            <div class="card">
                <div class="card-header pb-0">
                    <div class="d-flex align-items-center">
                        @permission('create-airport')
                            <a href="{{ route('airport.create') }}" type="button" class="btn btn-sm btn-primary">Add</a>
                        @endpermission()
                    </div>
                </div>
                        ...
                        <table id="myTable" class="my-table1 table my-tableview my-table-striped table-hover w-100">
                            <thead>
                                <tr>
                                    <th>Action</th>
                                    <th>No</th>
                                    <th class="select-filter">Airport Code</th>
                                    <th class="select-filter">Airport Name</th>
