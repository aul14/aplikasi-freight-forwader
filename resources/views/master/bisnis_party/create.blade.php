                                                ...
                                                <div class="col-md-6">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text"
                                                            ...
                                                            name="place" id="place" value="{{ old('place') }}">
                                                        @error('place')
                                                            <div class="invalid-feedback">
                                                                {{ $message }}
                                                            </div>
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text"
                                                            ...
                                                            name="marking" id="marking" value="{{ old('marking') }}">
                                                        @error('marking')
                                                            <div class="invalid-feedback">
                                                                {{ $message }}
                                                            </div>
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-md-8">
                                                            <div class="form-group">
                                                                ...
                                                                <input type="text" value="{{ old('type_desc') }}"
                                                            ...
                                                            <div class="form-group">
                                                                ...
                                                                <div class="form-check">
                                                                    <input class="form-check-input"
                                                                        @checked(old('is_customer') == '1') type="checkbox"
                                                    ...
                                                    <div class="row mt-1">
                                                        ...
                                                        <div class="col-md-8">
                                                            <div class="form-group">
                                                                ...
                                                                <input type="text"
                                                                    value="{{ old('vendortype_desc') }}" disabled
                                                                    class="form-control" name="vendortype_desc"
                                                                    id="vendortype_desc">
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="row mt-1">
                                                            ...
                                                            <div class="form-group">
                                                                ...
                                                                <div class="form-check">
                                                                    <input class="form-check-input" type="checkbox"
                                                                        @checked(old('is_vendor') == '1') value="1"
                                                        ...
                                                        <div class="col-md-3">
                                                            <div class="form-group">
                                                                ...
                                                                <input type="text" value="{{ old('vendor_code') }}"
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        @foreach ($p_type as $key => $item)
                                                            <div class="form-check">
                                                                <input class="form-check-input" type="checkbox"
                                                                    value="{{ $item->id }}"
                                                                    @checked(old("party_type_id.{$key}") == $item->id)
