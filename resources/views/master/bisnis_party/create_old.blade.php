            ...
            <div class="card">
                ...
                <form action="{{ route('bisnis_party.store') }}" method="post">
                    ...
                    <div class="card-body">
                                            ...
                                            <div class="row">
                                                <div class="col-md-6">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" value="{{ old('name') }}"
                                                            ...
                                                            autocomplete="off" required name="name" id="name">
                                                        @error('name')
                                                            <div class="invalid-feedback">
                                                                {{ $message }}
                                                            </div>
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-md-8">
                                                            <div class="form-group">
                                                                ...
                                                                <input type="text" value="{{ old('term_desc') }}"
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-md-8">
                                                            <div class="form-group">
                                                                ...
                                                                <input type="text" value="{{ old('vat_desc') }}"
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" disabled
                                                            class="form-control @error('credit_limit_detail') is-invalid @enderror"
                                                            name="credit_limit_detail" id="credit_limit_detail">
                                                    ...
                                                    <div class="row">
                                                        <div class="col-md-4">
                                                            <div class="form-group">
                                                                ...
                                                                <input type="text" name="telp_idd" readonly
                                                                    class="form-control">
                                                    ...
                                                    <div class="row">
                                                        <div class="col-md-4">
                                                            <div class="form-group">
                                                                ...
                                                                <input type="text" name="fax_idd" readonly
                                                                    class="form-control">
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-md-8">
                                                            <div class="form-group">
                                                                ...
                                                                <input type="text" value="{{ old('salesman_desc') }}"
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-md-6">
                                                            <input type="checkbox" name="nomination"
                                                                @checked(old('nomination') == 'yes') value="yes"
                                                ...
                                                <div class="col-md-6">
                                                    <div class="row align-items-center mt-1">
                                                        ...
                                                        <div class="col-md-6">
                                                            <div class="form-group">
                                                                ...
                                                                <input type="text" value="{{ old('customer_desc') }}"
                                                                    disabled class="form-control" name="customer_desc"
                                                                    id="customer_desc">
                                                            </div>
                                                        </div>
                                                        <div class="col-md-3 mt-2">
                                                            <a href="javascript:void(0)"
                                                                class="btn btn-sm btn-primary btn-cus"
                                                                title="Update Customer"><i class="fa fa-edit"></i></a>
                                                    ...
                                                    <div class="row align-items-center mt-1">
                                                        ...
                                                        <div class="col-md-6">
                                                            <div class="form-group">
                                                                ...
                                                                <input type="text" value="{{ old('vendor_desc') }}"
                                                                    disabled class="form-control" name="vendor_desc"
                                                                    id="vendor_desc">
                                                            </div>
                                                        </div>
                                                        <div class="col-md-3 mt-2">
                                                            <a href="javascript:void(0)" class="btn btn-sm btn-primary"
                                                                title="Update Vendor"><i class="fa fa-edit"></i></a>
                                                        ...
                                                        @foreach ($p_type as $key => $item)
                                                            <div class="form-check">
                                                                <input class="form-check-input" type="checkbox"
                                                                    value="{{ $item->id }}" name="party_type[]"
                                                                    id="party_type{{ $key + 1 }}">
                                                                <label class="form-check-label"
                                                                    for="party_type{{ $key + 1 }}">
                                                                    {{ $item->description }}
                                                                </label>
                                                            </div>
                                                        @endforeach
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-md-8">
                                                            <div class="form-group">
                                                                ...
                                                                <input type="text" value="{{ old('city_desc') }}"
                                                    ...
                                                    <div class="row mt-1">
                                                        ...
                                                        <div class="col-md-8">
                                                            <div class="form-group">
                                                                ...
                                                                <input type="text" value="{{ old('country_desc') }}"
                                                    ...
                                                    <div class="row mt-1">
                                                        ...
                                                        <div class="col-md-8">
                                                            <div class="form-group">
                                                                ...
                                                                <input type="text" value="{{ old('port_desc') }}"
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" value="{{ old('cr_roc_rob') }}"
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" value="{{ old('tax_id') }}"
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-md-6">
                                                            <input type="checkbox" name="sales_lead"
                                                                @checked(old('sales_lead') == 'yes') value="yes"
                                                                data-toggle="toggle" data-on="Yes" data-off="No"
                                                                data-onstyle="primary" data-offstyle="danger">
                                                            @error('sales_lead')
                                                                <div class="invalid-feedback">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-md-6">
                                                            <input type="checkbox" name="cold_call"
                                                                @checked(old('cold_call') == 'yes') value="yes"
                                                                data-toggle="toggle" data-on="Yes" data-off="No"
                                                                data-onstyle="primary" data-offstyle="danger">
                                                            @error('cold_call')
                                                                <div class="invalid-feedback">
                                            ...
                                            <div class="row mt-2">
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" value="{{ old('notify_contact_name') }}"
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" value="{{ old('notify_email') }}"
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <a href="{{ route('bisnis_party.store') }}" class="btn btn-danger btn-back">Back</a>
