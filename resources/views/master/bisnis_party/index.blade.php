            ...
            <div class="card">
                <div class="card-header pb-0">
                    <div class="d-flex align-items-center">
                        @permission('create-bisnis_party')
                            <a href="{{ route('bisnis_party.create') }}" type="button"
                        ...
                        <table id="myTable" class="my-table1 table my-tableview my-table-striped table-hover w-100">
                            <thead>
                                <tr>
                                    <th>Action</th>
                                    <th>No</th>
                                    <th class="select-filter">Business Party Code</th>
                                    <th class="select-filter">Business Party Name</th>
                                    <th class="select-filter">Telephone</th>
                                    <th class="select-filter">Is Customer?</th>
                                    <th class="select-filter">Customer Code</th>
                                    <th class="select-filter">Is Vendor?</th>
                            ...
                            <tfoot>
                                <tr>
                                    <th></th>
                                    <th></th>
                                    <th>Business Party Code</th>
                                    <th>Business Party Name</th>
                                    <th>Telephone</th>
                                    <th>Is Customer?</th>
                                    <th>Customer Code</th>
                                    <th>Is Vendor?</th>
