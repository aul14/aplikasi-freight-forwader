        ...
        <div class="col-12">
            ...
            <div class="card mb-4 ">
                <div class="card-header pb-0">
                    <h6>Form Edit Charge Code</h6>
                </div>
                <div class="card-body">
                    <form action="{{ route('charge_code.update', $charge_code->id) }}" method="post">
                        @csrf
                        @method('PUT')
                        <div class="row">
                            <div class="col-md-5">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text"
                                        value="{{ old('item_description', $charge_code->item_description) }}"
                                ...
                                <div class="form-group">
                                    ...
                                    <select name="split_by_method" id="split_by_method" class="form-control chosen-select">
                                        ...
                                        <option value="J - Job" @selected(old('split_by_method', $charge_code->split_by_method) == 'J - Job')>J - Job</option>
                                        <option value="C - Charge Weight" @selected(old('split_by_method', $charge_code->split_by_method) == 'C - Charge Weight')>C - Charge Weight
                                        </option>
                                        <option value="V - Volume" @selected(old('split_by_method', $charge_code->split_by_method) == 'V - Volume')>V - Volume</option>
                                        <option value="W - Gross Weight" @selected(old('split_by_method', $charge_code->split_by_method) == 'W - Gross Weight')>W - Gross Weight
                                        </option>
                                    </select>
                                ...
                                <div class="form-group">
                                    ...
                                    <select name="charge_unit" id="charge_unit" class="form-control chosen-select">
                                        <option value="">Select an option</option>
                                        <option value="20FT CONTAINER" @selected(old('charge_unit', $charge_code->charge_unit) == '20FT CONTAINER')>20FT CONTAINER</option>
                                        <option value="40FT CONTAINER" @selected(old('charge_unit', $charge_code->charge_unit) == '40FT CONTAINER')>40FT CONTAINER
                                        </option>
                                        <option value="45FT CONTAINER" @selected(old('charge_unit', $charge_code->charge_unit) == '45FT CONTAINER')>45FT CONTAINER
                                        </option>
                                        <option value="TOTAL CONTAINER" @selected(old('charge_unit', $charge_code->charge_unit) == 'TOTAL CONTAINER')>TOTAL CONTAINER
                                        </option>
                                        <option value="REV TON/CHARGE WEIGHT" @selected(old('charge_unit', $charge_code->charge_unit) == 'REV TON/CHARGE WEIGHT')>REV TON/CHARGE
                                            WEIGHT
                                        </option>
                                        <option value="REV TON RND UP" @selected(old('charge_unit', $charge_code->charge_unit) == 'REV TON RND UP')>REV TON RND UP
                                        </option>
                                        <option value="SHIPMENT" @selected(old('charge_unit', $charge_code->charge_unit) == 'SHIPMENT')>SHIPMENT</option>
                                        <option value="HOUSE" @selected(old('charge_unit', $charge_code->charge_unit) == 'HOUSE')>HOUSE</option>
                                        <option value="SUBHOUSE B/L" @selected(old('charge_unit', $charge_code->charge_unit) == 'SUBHOUSE B/L')>SUBHOUSE B/L</option>
                                        <option value="VOLUME" @selected(old('charge_unit', $charge_code->charge_unit) == 'VOLUME')>VOLUME</option>
                                        <option value="WEIGHT" @selected(old('charge_unit', $charge_code->charge_unit) == 'WEIGHT')>WEIGHT</option>
                                        <option value="PCS" @selected(old('charge_unit', $charge_code->charge_unit) == 'PCS')>PCS</option>
                                        <option value="CCFEE" @selected(old('charge_unit', $charge_code->charge_unit) == 'CCFEE')>CCFEE</option>
                                        <option value="BLOCK OF 4 M3" @selected(old('charge_unit', $charge_code->charge_unit) == 'BLOCK OF 4 M3')>BLOCK OF 4 M3</option>
                                        <option value="BLOCK OF 3 M3" @selected(old('charge_unit', $charge_code->charge_unit) == 'BLOCK OF 3 M3')>BLOCK OF 3 M3</option>
                                        <option value="INVOICE CHARGE WEIGHT" @selected(old('charge_unit', $charge_code->charge_unit) == 'INVOICE CHARGE WEIGHT')>INVOICE CHARGE
                                            WEIGHT
                                        </option>
                                    </select>
                                    @error('charge_unit')
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text"
                                        value="{{ old('cost_center_code', $charge_code->cost_center_code) }}"
                                ...
                                <div class="form-group">
                                    ...
                                    <select name="sales_cost" id="sales_cost"
                                        ...
                                        <option value="">Select an Option</option>
                                        <option value="S - Sales" @selected(old('sales_cost', $charge_code->sales_cost) == 'S - Sales')>S - Sales</option>
                                        <option value="C - Cost" @selected(old('sales_cost', $charge_code->sales_cost) == 'C - Cost')>C - Cost</option>
                                    </select>
                                    @error('sales_cost')
                                        <div class="invalid-feedback">
                                            {{ $message }}
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text"
                                                value="{{ old('sales_acc_code', $charge_code->sales_acc_code) }}"
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text"
                                                value="{{ old('cost_acc_code', $charge_code->cost_acc_code) }}"
                                ...
                                <div class="row mt-1">
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <select class="currency-select" name="currency_id">
                                                <option value="{{ $charge_code->currency_id }}">
                                                    {{ $charge_code->currency_id ? $charge_code->currency->code : '' }}
                                                </option>
                                            </select>
                                    ...
                                    <div class="col-md-8">
                                        <div class="form-group">
                                            ...
                                            <input type="text"
                                                value="{{ old('currency_desc', $charge_code->currency_id ? $charge_code->currency->description : '') }}"
                                                disabled class="form-control" name="currency_desc" id="currency_desc">
                                        </div>
                                    </div>
                                </div>
                                <div class="row mt-2">
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <select class="uom-select" name="uom_id">
                                                <option value="{{ $charge_code->uom_id }}">
                                                    {{ $charge_code->uom_id ? $charge_code->uom->code : '' }}
                                                </option>
                                            </select>
                                    ...
                                    <div class="col-md-8">
                                        <div class="form-group">
                                            ...
                                            <input type="text"
                                                value="{{ old('uom_desc', $charge_code->uom_id ? $charge_code->uom->description : '') }}"
                                                disabled class="form-control" name="uom_desc" id="uom_desc">
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="row mt-2">
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <select class="wt-select" name="wt_code_id">
                                                <option value="{{ $charge_code->wt_code_id }}">
                                                    {{ $charge_code->wt_code_id ? $charge_code->wt_code->code : '' }}
                                                </option>
                                            </select>
                                    ...
                                    <div class="col-md-8">
                                        <div class="form-group">
                                            ...
                                            <input type="text"
                                                value="{{ old('wt_code_desc', $charge_code->wt_code_id ? $charge_code->wt_code->description : '') }}"
                                                readonly class="form-control" name="wt_code_desc" id="wt_code_desc">
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <input type="text" value="{{ old('cost_percent', $cost_percent) }}"
                                    ...
                                    <div class="col-md-8">
                                        <div class="form-group">
                                            ...
                                            <input type="text" value="{{ old('cost_ammount', $cost_ammount) }}"
                                                data-type='currency' autocomplete="off"
                                ...
                                <div class="row mt-2">
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <select class="vat-select" name="vat_code_id">
                                                <option value="{{ $charge_code->vat_code_id }}">
                                                    {{ $charge_code->vat_code_id ? $charge_code->vat_code->code : '' }}
                                                </option>
                                            </select>
                                    ...
                                    <div class="col-md-8">
                                        <div class="form-group">
                                            ...
                                            <input type="text"
                                                value="{{ old('vat_code_desc', $charge_code->vat_code_id ? $charge_code->vat_code->description : '') }}"
                                                disabled class="form-control" name="vat_code_desc" id="vat_code_desc">
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <select class="costvat-select" name="cost_code">
                                                <option value="{{ $charge_code->cost_code }}">
                                                    {{ $charge_code->cost_code }}</option>
                                            </select>
                                    ...
                                    <div class="col-md-8">
                                        <div class="form-group">
                                            ...
                                            <input type="text"
                                                value="{{ old('cost_code_desc', $charge_code->cost_code_desc) }}" readonly
                                            ...
                                            @foreach ($c_detail as $key => $item)
                                                <tr class="dynamic-field" id="dynamic-field-{{ $key + 1 }}">
                                                    ...
                                                    <td>
                                                        <div class="form-group">
                                                            <select name="module[]"
                                                                id="module-detail-select-{{ $key + 1 }}"
                                                                class="module-detail-select">
                                                                <option value="{{ $item->module }}">{{ $item->module }}
                                                                </option>
                                                    ...
                                                    <td>
                                                        <div class="form-group">
                                                            <select name="job_type[]" id="job-select-{{ $key + 1 }}"
                                                                class="job-select">
                                                                <option value="{{ $item->job_type }}">
                                                    ...
                                                    <td>
                                                        <div class="form-group">
                                                            <input type="text" class="form-control"
                                                                value="{{ $item->sales_acc_code }}" autocomplete="off"
                                                    ...
                                                    <td>
                                                        <div class="form-group">
                                                            <input type="text" class="form-control"
                                                                value="{{ $item->cost_acc_code }}" autocomplete="off"
                                                    ...
                                                    <td>
                                                        <div class="form-group">
                                                            <input type="text" value="{{ $item->adv_acc_code }}"
