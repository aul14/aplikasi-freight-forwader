            ...
            <div class="card">
                <div class="card-header pb-0">
                    <div class="d-flex align-items-center">
                        @permission('create-charge_code')
                            <a href="{{ route('charge_code.create') }}" type="button"
                        ...
                        <table id="myTable" class="my-table1 table my-tableview my-table-striped table-hover w-100">
                            <thead>
                                <tr>
                                    ...
                                    <th class="select-filter">Item Description</th>
                                    <th class="select-filter">Job Type</th>
                                    <th class="select-filter">VAT Code</th>
                                    <th class="select-filter">Charge Type</th>
