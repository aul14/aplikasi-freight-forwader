...
@section('content')
    @include('layouts.navbars.auth.topnav', ['title' => 'City', 'title_2' => 'Master'])
                ...
                <div class="card-header pb-0">
                    <div class="d-flex align-items-center">
                        @permission('create-city')
                            <a href="{{ route('city.create') }}" type="button" class="btn btn-sm btn-primary">Add</a>
                        @endpermission()
                    </div>
                </div>
                        ...
                        <table id="myTable" class="my-table1 table my-tableview my-table-striped table-hover w-100">
                            <thead>
                                <tr>
                                    <th>Action</th>
                                    <th>No</th>
                                    <th class="select-filter">City Code</th>
                                    <th class="select-filter">City Name</th>
                                    <th class="select-filter">Country Code</th>
                                    <th class="select-filter">Country Name</th>
                                    <th class="select-filter">IDD</th>
                                    <th class="select-filter">Region Code</th>
        ...
        $(document).ready(function() {
            ...
            $('#myTable').DataTable({
                ...
                columns: [{
                    ...
                    {
                        data: 'country.region_code',
                        name: 'country.region_code'
                    },
