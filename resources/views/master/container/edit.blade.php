                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" value="{{ old('type', $container->type) }}"
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" value="{{ old('description', $container->description) }}"
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-16">
                                        <select name="size" id="size" class="form-control chosen-select"
                                            ...
                                            <option value=""></option>
                                            <option value="20 FT" @selected(old('size', $container->size) == '20 FT')>20 FT</option>
                                            <option value="40 FT" @selected(old('size', $container->size) == '40 FT')>40 FT</option>
                                            <option value="45 FT" @selected(old('size', $container->size) == '45 FT')>45 FT</option>
                                            <option value="LCL" @selected(old('size', $container->size) == 'LCL')>LCL</option>
                                        </select>
                                    </div>
                                    @error('size')
                                        <div class="invalid-feedback">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" value="{{ old('iso_size', $container->iso_size) }}"
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" value="{{ old('no_of_teu', $no_of_teu) }}"
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" value="{{ old('max_cubic', $max_cubic) }}"
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" value="{{ old('max_volume', $max_volume) }}"
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" value="{{ old('max_weight', $max_weight) }}"
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-6">
                                        <input type="checkbox" name="temp_flag" @checked(old('temp_flag', $container->temp_flag) == 'yes')
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" value="{{ old('temp_degree', $container->temp_degree) }}"
                            ...
                            <div class="col-md-12">
                                <a href="{{ route('container.index') }}" class="btn btn-danger">Back</a>
