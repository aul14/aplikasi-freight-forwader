    ...
    <div class="row mt-1 px-1">
        <div class="col-12">
            ...
            <div class="card mb-4 ">
                ...
                <div class="card-body">
                    <form action="{{ route('cost_table.update', $cost_table->id) }}" method="post">
                        @csrf
                        @method('PUT')
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control @error('code') is-invalid @enderror" readonly
                                        value="{{ $cost_table->code }}" name="code" id="code">
                                    @error('code')
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" value="{{ old('description', $cost_table->description) }}"
                                        ...
                                        <div class="col-md-6">
                                            <select name="job_type_id"
                                                ...
                                                <option value="{{ $cost_table->job_type_id }}">
                                                    {{ $cost_table->job_type_id != null ? $cost_table->job_type->type : '' }}
                                                </option>
                                            </select>
                                            @error('job_type_id')
                                                <div class="invalid-feedback">
                                ...
                                <div class="row">
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <select class="viaport-select" name="via_port_code">
                                                <option value="{{ $cost_table->via_port_code }}">
                                                    {{ $cost_table->via_port_code }}</option>
                                            </select>
                                    ...
                                    <div class="col-md-8">
                                        <div class="form-group">
                                            ...
                                            <input type="text"
                                                value="{{ old('via_port_name', $cost_table->via_port_name) }}" readonly
                                ...
                                <div class="row">
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <select class="secondport-select" name="second_port_code">
                                                <option value="{{ $cost_table->second_port_code }}">
                                                    {{ $cost_table->second_port_code }}</option>
                                            </select>
                                    ...
                                    <div class="col-md-8">
                                        <div class="form-group">
                                            ...
                                            <input type="text"
                                                value="{{ old('second_port_name', $cost_table->second_port_name) }}"
                                                readonly class="form-control" name="second_port_name" id="second_port_name">
                                        </div>
                                    </div>
                                </div>
                                <div class="form-group">
                                    ...
                                    <div class="col-md-6">
                                        <input type="checkbox" name="valid_flag" @checked(old('valid_flag', $cost_table->valid_flag) == 'yes')
                            ...
                            <div class="col-md-6">
                                <div class="row ">
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <select class="vendor-select" name="bisnis_party_id">
                                                <option value="{{ $cost_table->bisnis_party_id }}">
                                                    {{ $cost_table->bisnis_party_id != null ? $cost_table->bisnis_party->code : '' }}
                                                </option>
                                            </select>
                                    ...
                                    <div class="col-md-8">
                                        <div class="form-group">
                                            ...
                                            <input type="text"
                                                value="{{ old('bisnis_party_name', $cost_table->bisnis_party_id != null ? $cost_table->bisnis_party->name : '') }}"
                                ...
                                <div class="row mt-1">
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <select class="portloading-select" name="port_loading_code">
                                                <option value="{{ $cost_table->port_loading_code }}">
                                                    {{ $cost_table->port_loading_code }}</option>
                                            </select>
                                    ...
                                    <div class="col-md-8">
                                        <div class="form-group">
                                            ...
                                            <input type="text"
                                                value="{{ old('port_loading_name', $cost_table->port_loading_name) }}"
                                ...
                                <div class="row mt-1">
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <select class="portdischarge-select" name="port_discharge_code">
                                                <option value="{{ $cost_table->port_discharge_code }}">
                                                    {{ $cost_table->port_discharge_code }}</option>
                                            </select>
                                    ...
                                    <div class="col-md-8">
                                        <div class="form-group">
                                            ...
                                            <input type="text"
                                                value="{{ old('port_discharge_name', $cost_table->port_discharge_name) }}"
                                ...
                                <div class="row mt-1">
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <select class="city-select" name="city_id">
                                                <option value="{{ $cost_table->city_id }}">
                                                    {{ $cost_table->city_id != null ? $cost_table->city->code : '' }}
                                                </option>
                                            </select>
                                    ...
                                    <div class="col-md-8">
                                        <div class="form-group">
                                            ...
                                            <input type="text"
                                                value="{{ old('city_desc', $cost_table->city_id != null ? $cost_table->city->name : '') }}"
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea name="note" id="note" cols="30" rows="4"
                                        class="form-control @error('note') is-invalid @enderror">{{ old('note', $cost_table->note) }}</textarea>
                                    @error('note')
                                        <div class="invalid-feedback">
                                            {{ $message }}
                                        </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-6">
                                        <input type="checkbox" name="standard_flag" @checked(old('standard_flag', $cost_table->standard_flag) == 'yes')
                                            value="yes" data-toggle="toggle" data-on="Yes" data-off="No"
                                            data-onstyle="primary" data-offstyle="danger">
                                        @error('standard_flag')
                                            <div class="invalid-feedback">
