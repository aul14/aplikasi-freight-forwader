            ...
            <div class="card">
                <div class="card-header pb-0">
                    <div class="d-flex align-items-center">
                        @permission('create-cost_table')
                            <a href="{{ route('cost_table.create') }}" type="button"
                        ...
                        <table id="myTable" class="my-table1 table my-tableview my-table-striped table-hover w-100">
                            <thead>
                                <tr>
                                    <th>Action</th>
                                    <th>No</th>
                                    <th class="select-filter">Cost Table No</th>
                                    <th class="select-filter">Cost Table Description</th>
