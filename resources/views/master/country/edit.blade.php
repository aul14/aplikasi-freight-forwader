                ...
                <div class="card-body px-0 pt-0 pb-0">
                    <div class="container-fluid">
                        <form action="{{ route('country.update', $country->id) }}" method="POST"
                            ...
                            @csrf
                            @method('PUT')
                            <input type="hidden" name="oldImage" value="{{ $country->image_country }}">
                                    ...
                                    <div class="tab-panels col-md-12">
                                            ...
                                            <div class="row">
                                                <div class="col-md-6">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        @if ($country->image_country)
                                                            <img class="img-preview img-fluid mb-3 col-sm-5 d-block"
                                                                src="{{ asset("storage/{$country->image_country}") }}">
                                                        @else
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <input type="number" value="{{ old('idd', $country->idd) }}"
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text"
                                                            value="{{ old('region_code', $country->region_code) }}"
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text"
                                                            value="{{ old('zone_code', $country->zone_code) }}"
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <textarea name="handling_instructions" id="handling_instructions"
                                                            class="form-control @error('handling_instructions') is-invalid @enderror" cols="30" rows="10">{{ old('handling_instructions', $country->handling_instructions) }}</textarea>
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <textarea name="special_instructions" id="special_instructions"
                                                            class="form-control @error('special_instructions') is-invalid @enderror" cols="30" rows="8">{{ old('special_instructions', $country->special_instructions) }}</textarea>
                                        ...
                                        <section id="port" class="tab-panel">
                                            <div class="row">
                                                <div class="col md-12">
                                                    <div class="row">
                                                        @if (count($detail_cp) > 0)
                                                            @foreach ($detail_cp as $val)
                                                                    ...
                                                                    <div class="col-md-12">
                                                                        <div class="clearfix">
                                                                            ...
                                                                            <button type="button" id="remove-button"
                                                                                class="btn btn-danger float-left text-uppercase ml-1"><i
                                                ...
                                                <div class="col-md-12">
                                                    <div class="form-group">
                                                        ...
                                                        <textarea name="handling_instructions_port" id="handling_instructions_port"
                                                            class="form-control @error('handling_instructions_port') is-invalid @enderror" cols="30" rows="10">{{ old('handling_instructions_port', $country->handling_instructions_port) }}</textarea>
                                                ...
                                                <div class="col-md-12">
                                                    <div class="form-group">
                                                        ...
                                                        <textarea name="handling_instructions_symbol" id="handling_instructions_symbol"
                                                            class="form-control @error('handling_instructions_symbol') is-invalid @enderror" cols="30" rows="10">{{ old('handling_instructions_symbol', $country->handling_instructions_symbol) }}</textarea>
...
@section('script')
    <script>
        ...
        function addNewField() {
            ...
            field.find(".port-select").val(null).trigger('change');
