            ...
            <div class="card mb-4 ">
                ...
                <div class="card-body">
                    <form action="{{ route('currency.store') }}" method="post">
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="large_name" id="large_name" value="{{ old('large_name') }}"
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="small_name" id="small_name" value="{{ old('small_name') }}"
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="markup_percent" id="markup_percent" data-type='currency'
                                        value="{{ old('markup_percent') }}" autocomplete="off"
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="variance_percent" id="variance_percent"
                                        value="{{ old('variance_percent') }}" data-type='currency3' autocomplete="off"
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <a href="{{ route('currency.index') }}" class="btn btn-danger">Back</a>
