                        ...
                        <div class="row">
                            <div class="col-md-6">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-8">
                                        <div class="form-group">
                                            ...
                                            <input type="text" value="{{ old('vendor_desc') }}" disabled
                                                class="form-control" name="vendor_desc" id="vendor_desc">
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" value="{{ old('credit_limit') }}" data-type='currency'
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-8">
                                        <div class="form-group">
                                            ...
                                            <input type="text" value="{{ old('salesman_desc') }}" disabled
                                                class="form-control" name="salesman_desc" id="salesman_desc">
                                        </div>
                                    </div>
                                </div>
                            </div>
