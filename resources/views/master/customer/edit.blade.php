            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form action="{{ route('customer.update', $customer->id) }}" method="post">
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" value="{{ $customer->code }}" readonly class="form-control"
                                        name="code">
                                    @error('code')
                                ...
                                <div class="row">
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <input type="text" value="{{ $customer->acc_code }}"
                                    ...
                                    <div class="col-md-8">
                                        <div class="form-group">
                                            ...
                                            <input type="text" value="{{ $customer->acc_desc }}"
                                ...
                                <div class="row">
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <select class="type-select" name="customer_type_id">
                                                <option value="{{ $customer->customer_type_id }}">
                                                    {{ $customer->customer_type_id != null ? $customer->customer_type->type : '' }}
                                                </option>
                                            </select>
                                    ...
                                    <div class="col-md-8">
                                        <div class="form-group">
                                            ...
                                            <input type="text"
                                                value="{{ old('type_desc', $customer->customer_type_id != null ? $customer->customer_type->type_name : '') }}"
                                                disabled class="form-control" name="type_desc" id="type_desc">
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            <label for="vendor_id">Contra Vendor Code </label>
                                            <select class="vendor-select" name="vendor_id">
                                                <option value="{{ $customer->vendor_id }}">
                                                    {{ $customer->vendor_id != null ? $customer->vendor->code : '' }}
                                                </option>
                                            </select>
                                    ...
                                    <div class="col-md-8">
                                        <div class="form-group">
                                            ...
                                            <input type="text"
                                                value="{{ old('vendor_desc', $customer->vendor_id != null ? $customer->vendor->name : '') }}"
                                                disabled class="form-control" name="vendor_desc" id="vendor_desc">
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <select class="currency-select" required name="currency_id">
                                                <option value="{{ $customer->currency_id }}">
                                                    {{ $customer->currency_id != null ? $customer->currency->code : '' }}
                                                </option>
                                            </select>
                                    ...
                                    <div class="col-md-8">
                                        <div class="form-group">
                                            ...
                                            <input type="text"
                                                value="{{ $customer->currency_id != null ? $customer->currency->description : '' }}"
                                ...
                                <div class="row">
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <select class="term-select" required name="payment_term_id">
                                                <option value="{{ $customer->payment_term_id }}">
                                                    {{ $customer->payment_term_id != null ? $customer->payment_term->code : '' }}
                                                </option>
                                            </select>
                                    ...
                                    <div class="col-md-8">
                                        <div class="form-group">
                                            ...
                                            <input type="text"
                                                value="{{ old('term_desc', $customer->payment_term_id != null ? $customer->payment_term->description : '') }}"
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" value="{{ old('local_name', $customer->local_name) }}"
                                ...
                                <div class="row">
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="telp_idd"
                                                value="{{ $customer->country_id != null ? $customer->country->idd : '' }}"
                                    ...
                                    <div class="col-md-8">
                                        <div class="form-group">
                                            ...
                                            <input type="text" value="{{ old('telp', $customer->telp) }}"
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" value="{{ old('telex', $customer->telex) }}"
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" value="{{ old('credit_limit', $customer->credit_limit) }}"
                                        data-type='currency'
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" value="{{ old('address_1', $customer->address_1) }}"
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" value="{{ old('address_2', $customer->address_2) }}"
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" value="{{ old('address_3', $customer->address_3) }}"
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" value="{{ old('address_4', $customer->address_4) }}"
                                ...
                                <div class="row">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select class="city-select" name="city_id">
                                                <option value="{{ $customer->city_id }}">
                                                    {{ $customer->city_id != null ? $customer->city->code : '' }}</option>
                                            </select>
                                    ...
                                    <div class="col-md-8">
                                        <div class="form-group">
                                            ...
                                            <input type="text"
                                                value="{{ old('city_desc', $customer->city_id != null ? $customer->city->name : '') }}"
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-8">
                                        <div class="form-group">
                                            ...
                                            <input type="text" value="{{ old('province', $customer->province) }}"
                                ...
                                <div class="row">
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <select class="country-select" name="country_id">
                                                <option value="{{ $customer->country_id }}">
                                                    {{ $customer->country_id != null ? $customer->country->code : '' }}
                                                </option>
                                            </select>
                                    ...
                                    <div class="col-md-8">
                                        <div class="form-group">
                                            ...
                                            <input type="text"
                                                value="{{ old('country_desc', $customer->country_id != null ? $customer->country->name : '') }}"
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" value="{{ old('place', $customer->place) }}"
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-8">
                                        <div class="form-group">
                                            <label for="fax"> &nbsp;</label>
                                            <input type="text" value="{{ old('fax', $customer->fax) }}"
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-8">
                                        <div class="form-group">
                                            ...
                                            <input type="text" value="{{ old('web_site', $customer->web_site) }}"
                                ...
                                <div class="row">
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <select class="salesman-select" name="salesman_id">
                                                <option value="{{ $customer->salesman_id }}">
                                                    {{ $customer->salesman_id != null ? $customer->salesman->code : '' }}
                                                </option>
                                            </select>
                                    ...
                                    <div class="col-md-8">
                                        <div class="form-group">
                                            ...
                                            <input type="text"
                                                value="{{ old('salesman_desc', $customer->salesman_id != null ? $customer->salesman->name : '') }}"
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <a href="{{ route('customer.index') }}" class="btn btn-danger btn-back">Back</a>
