                ...
                <div class="card-header pb-0">
                    <div class="d-flex align-items-center">
                        @permission('create-jobtype')
                            <a href="{{ route('job_type.create') }}" type="button" class="btn btn-sm btn-primary mb-2">Add</a>
                        @endpermission
                    </div>
                </div>
                        ...
                        <table id="myTable" class="my-table1 table my-tableview my-table-striped table-hover w-100">
                            <thead>
                                <tr>
                                    ...
                                    <th class="select-filter">Job Description</th>
                                    <th class="select-filter">Module Code</th>
