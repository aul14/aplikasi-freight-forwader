        ...
        <div class="col-12">
            ...
            <div class="card">
                <div class="card-header pb-0">
                    <h6>Form Add Payment Term</h6>
                </div>
                <div class="card-body">
                    <form action="{{ route('pay_term.store') }}" method="post">
                        @csrf
                        @method('POST')
                        <div class="row">
                            <div class="col-md-6">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" value="{{ old('net_days') }}" data-type='currency0' maxlength="6"
                                        class="form-control @error('net_days') is-invalid @enderror" autocomplete="off"
                                        required name="net_days" id="net_days">
                                    @error('net_days')
                                        <div class="invalid-feedback">
                                            {{ $message }}
                                        </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-6">
                                        <input type="checkbox" name="net_date" @checked(old('net_date') == 'yes') value="yes"
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-6">
                                        <input type="checkbox" name="shipment_date_flag" @checked(old('shipment_date_flag') == 'yes')
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" value="{{ old('discount_days') }}" data-type='currency0'
                                        maxlength="6" class="form-control @error('discount_days') is-invalid @enderror"
                                        autocomplete="off" name="discount_days" id="discount_days">
                                    @error('discount_days')
                                        <div class="invalid-feedback">
                                            {{ $message }}
                                        </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-6">
                                        <input type="checkbox" name="discount_date" @checked(old('discount_date') == 'yes')
                                            value="yes" data-toggle="toggle" data-on="Yes" data-off="No"
                                            data-onstyle="primary" data-offstyle="danger">
                                        @error('discount_date')
                                            <div class="invalid-feedback">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" value="{{ old('discount_percent') }}" data-type='currency3'
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" value="{{ old('service_charge_min') }}" data-type='currency'
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" value="{{ old('service_charge_percent') }}"
                                        data-type='currency3'
