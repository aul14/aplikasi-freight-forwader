            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form action="{{ route('port.update', $port->id) }}" method="post">
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" value="{{ old('code', $port->code) }}"
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" value="{{ old('name', $port->name) }}"
                                ...
                                <div class="form-group">
                                    ...
                                    <select class="country-select" name="country_id" required>
                                        <option value="{{ $port->country->id }}">{{ $port->country->name }}</option>
                                    </select>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-6">
                                        <input type="checkbox" name="dg_cargo" @checked(old('dg_cargo', $port->dg_cargo) == 'yes') value="yes"
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="group_code" id="group_code"
                                        value="{{ old('group_code', $port->group_code) }}"
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="region_code" value="{{ $port->country->region_code }}"
                                ...
                                <div class="form-group">
                                    ...
                                    <select class="port-select" name="via_port" id="via_port">
                                        <option value="{{ $port->via_port }}">{{ $port->via_port }}</option>
                                    </select>
                                    @error('via_port')
                                        <div class="invalid-feedback">
                                            {{ $message }}
                        ...
                        <hr>
                        @if (count($detail_pc) > 0)
                            @foreach ($detail_pc as $key => $item)
                                                ...
                                                <div class="row">
                                                    <div class="col-md-4">
                                                        <div class="form-group">
                                                            ...
                                                            <select class="city-select"
                                                                id="city-select-{{ $key + 1 }}" name="city_id[]">
                                                                <option value="{{ $item->city->id }}">
                                                                    {{ $item->city->code . '|' . $item->city->name }}
                                                                </option>
                                                            </select>
                                                        </div>
                                                    </div>
                                                    <div class="col-md-2">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text"
                                                                value="{{ $item->city->country->code }}"
                                                                class="form-control country-code"
                                                                id="country-code-{{ $key + 1 }}" disabled />
                                                        </div>
                                                    </div>
                                                    <div class="col-md-4">
                                                        <div class="form-group">
                                                            <label>Dest Name</label>
                                                            <input type="text" value="{{ $item->city->name }}"
                                                                class="form-control city-name"
                                                                id="city-name-{{ $key + 1 }}" disabled>
                                                        </div>
                                                    </div>
                                                    <div class="col-md-2">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="number" class="form-control"
                                                                value="{{ $item->no_of_day }}" name="no_of_day[]"
                                                                id="no_of_day">
                                                        </div>
                                                    </div>
                                                </div>
                                        ...
                                        <div class="col-md-10">
                                            <div class="row">
                                                ...
                                                <div class="col-md-4">
                                                    <div class="form-group">
                                                        <label>Dest Name</label>
                                                        <input type="text" class="form-control city-name"
                                                            id="city-name-1" disabled>
                                                    </div>
                                                </div>
                                                <div class="col-md-2">
                                                    <div class="form-group">
