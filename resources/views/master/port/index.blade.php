...
@section('content')
    @include('layouts.navbars.auth.topnav', ['title' => 'Sea Port', 'title_2' => 'Master'])
                ...
                <div class="card-header pb-0">
                    <div class="d-flex align-items-center">
                        @permission('create-port')
                            <a href="{{ route('port.create') }}" type="button" class="btn btn-sm btn-primary mb-2">Add</a>
                        @endpermission()
                    </div>
                </div>
                        ...
                        <table id="myTable" class="my-table1 table my-tableview my-table-striped table-hover w-100">
                            <thead>
                                <tr>
                                    <th>Action</th>
                                    <th>No</th>
                                    <th class="select-filter">Port Code</th>
                                    <th class="select-filter">Port Name</th>
                                    <th class="select-filter">Country Code</th>
                                    <th class="select-filter">Country Name</th>
                                    <th class="select-filter">Dg Cargo Flag</th>
