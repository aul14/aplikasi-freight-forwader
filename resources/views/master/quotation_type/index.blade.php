            ...
            <div class="card">
                <div class="card-header pb-0">
                    <div class="d-flex align-items-center">
                        @permission('create-quotation_type')
                            <a href="{{ route('quotation_type.create') }}" type="button"
                        ...
                        <table id="myTable" class="my-table1 table my-tableview my-table-striped table-hover w-100">
                            <thead>
                                <tr>
                                    ...
                                    <th class="select-filter">Quotation Description</th>
    ...
    <script>
        $(document).ready(function() {
            ...
            $('#myTable').DataTable({
                ...
                scrollCollapse: true,
                scrollX: true,
                ajax: '{{ route('quotation_type.index') }}',
                oLanguage: {
                    oPaginate: {
