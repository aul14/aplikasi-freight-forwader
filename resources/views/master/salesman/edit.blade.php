                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" value="{{ old('code', $salesman->code) }}" readonly
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" value="{{ old('name', $salesman->name) }}"
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" value="{{ old('employee_code', $salesman->employee_code) }}"
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="password" value="{{ old('password', $salesman->password) }}"
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" value="{{ old('area', $salesman->area) }}"
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" value="{{ old('division', $salesman->division) }}"
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" value="{{ old('title', $salesman->title) }}"
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" value="{{ old('email', $salesman->email) }}"
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="number" value="{{ old('telp', $salesman->telp) }}"
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="number" value="{{ old('hanphone', $salesman->handphone) }}"
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" value="{{ old('join_date', $join_date) }}"
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" value="{{ old('resign_date', $resign_date) }}"
                            ...
                            <div class="col-md-12 mt-2">
                                <a href="{{ route('salesman.index') }}" class="btn btn-danger btn-back">Back</a>
