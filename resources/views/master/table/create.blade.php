        ...
        <div class="col-12">
            ...
            <div class="card mb-4 ">
                <div class="card-header pb-0">
                    <h6>Form Add Charge Table</h6>
                </div>
                <div class="card-body">
                    <form action="{{ route('charge_table.store') }}" method="post">
                        @csrf
                        @method('POST')
                        <div class="row">
                            <div class="col-md-6">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" maxlength="5" data-type='currency0'
                                        ...
                                        class="form-control @error('transit_time') is-invalid @enderror"
                                        name="transit_time" id="transit_time">
                                    @error('transit_time')
                                        <div class="invalid-feedback">
                                            {{ $message }}
                                        </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" value="{{ old('frequency') }}"
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" value="{{ old('note_code') }}"
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea name="note" id="note" cols="30" rows="8"
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-6">
                                        <input type="checkbox" name="frt_collect" @checked(old('frt_collect') == 'yes')
                                            value="yes" data-toggle="toggle" data-on="Yes" data-off="No"
                                            data-onstyle="primary" data-offstyle="danger">
                                        @error('frt_collect')
                                            <div class="invalid-feedback">
                        ...
                        <div class="row my-3">
                            <div class="col-md-12">
                                <a href="{{ route('charge_table.index') }}" class="btn btn-danger btn-back">Back</a>
