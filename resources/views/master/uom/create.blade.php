        ...
        <div class="col-12">
            ...
            <div class="card">
                <div class="card-header pb-0">
                    <h6>Form Add Unit Of Measurement</h6>
                </div>
                <div class="card-body">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <select name="type" id="type" class="form-control chosen-select">
                                        ...
                                        <option value="QUANTITY" @selected(old('type') == 'QUANTITY')>QUANTITY</option>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" value="{{ old('conversion_factor') }}" autocomplete="off"
                                        data-type='currency6'
