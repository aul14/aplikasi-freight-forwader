        ...
        <div class="col-12">
            ...
            <div class="card mb-4 ">
                <div class="card-header pb-0">
                    <h6>Form Add VAT Code</h6>
                </div>
                <div class="card-body">
                    <form action="{{ route('vat_code.store') }}" method="post">
                        @csrf
                        @method('POST')
                        <div class="row">
                            <div class="col-md-5">
                                ...
                                {{-- <div class="form-group">
                                    ...
                                    <input type="text" name="vat_rate" id="vat_rate" data-type='currency33'
                                        autocomplete="off" value="{{ old('vat_rate') }}"
                                ...
                                <div class="form-group">
                                    ...
                                    <select name="type" id="type"
                                        ...
                                        <option value="ZER" @selected(old('type') == 'ZER')>ZER</option>
                                        <option value="STD" @selected(old('type') == 'STD')>STD</option>
                                        <option value="EXM" @selected(old('type') == 'EXM')>EXM</option>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-6">
                                        <input type="checkbox" name="inclusice" @checked(old('inclusice') == 'yes') value="yes"
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="input_ta_code" id="input_ta_code"
                                                value="{{ old('input_ta_code') }}" autocomplete="off"
                                    ...
                                    <div class="col-md-8">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="input_ta_desc" id="input_ta_desc"
                                                value="{{ old('input_ta_desc') }}" autocomplete="off"
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="output_ta_code" id="output_ta_code"
                                                value="{{ old('output_ta_code') }}" autocomplete="off"
                                    ...
                                    <div class="col-md-8">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="output_ta_desc" id="output_ta_desc"
                                                value="{{ old('output_ta_desc') }}" autocomplete="off"
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="paid_in_ta_code" id="paid_in_ta_code"
                                                value="{{ old('paid_in_ta_code') }}" autocomplete="off"
                                    ...
                                    <div class="col-md-8">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="paid_in_ta_desc" id="paid_in_ta_desc"
                                                value="{{ old('paid_in_ta_desc') }}" autocomplete="off"
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="paid_out_ta_code" id="paid_out_ta_code"
                                                value="{{ old('paid_out_ta_code') }}" autocomplete="off"
                                    ...
                                    <div class="col-md-8">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="paid_out_ta_desc" id="paid_out_ta_desc"
                                                value="{{ old('paid_out_ta_desc') }}" autocomplete="off"
