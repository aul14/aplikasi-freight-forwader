                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" value="{{ $vendor->code }}" readonly class="form-control"
                                        name="code">
                                    @error('code')
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" value="{{ old('name', $vendor->name) }}"
                                ...
                                <div class="row">
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <input type="text" value="{{ $vendor->acc_code }}"
                                    ...
                                    <div class="col-md-8">
                                        <div class="form-group">
                                            ...
                                            <input type="text" value="{{ $vendor->acc_desc }}"
                                ...
                                <div class="row">
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <select class="type-select" name="vendor_type_id">
                                                <option value="{{ $vendor->vendor_type_id }}">
                                                    {{ $vendor->vendor_type_id != null ? $vendor->vendor_type->type : '' }}
                                                </option>
                                            </select>
                                    ...
                                    <div class="col-md-8">
                                        <div class="form-group">
                                            ...
                                            <input type="text"
                                                value="{{ old('type_desc', $vendor->vendor_type_id != null ? $vendor->vendor_type->type_name : '') }}"
                                ...
                                <div class="row">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select class="customer-select" name="customer_id">
                                                <option value="{{ $vendor->customer_id }}">
                                                    {{ $vendor->customer_id != null ? $vendor->customer->code : '' }}
                                                </option>
                                            </select>
                                    ...
                                    <div class="col-md-8">
                                        <div class="form-group">
                                            ...
                                            <input type="text"
                                                value="{{ old('customer_desc', $vendor->customer_id != null ? $vendor->customer->name : '') }}"
                                                disabled class="form-control" name="customer_desc" id="customer_desc">
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <select class="currency-select" required name="currency_id">
                                                <option value="{{ $vendor->currency_id }}">
                                                    {{ $vendor->currency_id != null ? $vendor->currency->code : '' }}
                                                </option>
                                            </select>
                                    ...
                                    <div class="col-md-8">
                                        <div class="form-group">
                                            ...
                                            <input type="text"
                                                value="{{ $vendor->currency_id != null ? $vendor->currency->description : '' }}"
                                ...
                                <div class="row">
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <select class="term-select" required name="payment_term_id">
                                                <option value="{{ $vendor->payment_term_id }}">
                                                    {{ $vendor->payment_term_id != null ? $vendor->payment_term->code : '' }}
                                                </option>
                                            </select>
                                    ...
                                    <div class="col-md-8">
                                        <div class="form-group">
                                            ...
                                            <input type="text"
                                                value="{{ old('term_desc', $vendor->payment_term_id != null ? $vendor->payment_term->description : '') }}"
                                ...
                                <div class="row">
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <select class="vat-select" name="vat_code_id">
                                                <option value="{{ $vendor->vat_code_id }}">
                                                    {{ $vendor->vat_code_id != null ? $vendor->vat_code->code : '' }}
                                                </option>
                                            </select>
                                    ...
                                    <div class="col-md-8">
                                        <div class="form-group">
                                            ...
                                            <input type="text"
                                                value="{{ old('vat_desc', $vendor->vat_code_id != null ? $vendor->vat_code->description : '') }}"
                                                disabled class="form-control" name="vat_desc" id="vat_desc">
                                        </div>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label for="local_name">Local Name </label>
                                    <input type="text" value="{{ old('local_name', $vendor->local_name) }}"
                                ...
                                <div class="row">
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="telp_idd"
                                                value="{{ $vendor->country_id != null ? $vendor->country->idd : '' }}"
                                    ...
                                    <div class="col-md-8">
                                        <div class="form-group">
                                            ...
                                            <input type="text" value="{{ old('telp', $vendor->telp) }}"
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" value="{{ old('telex', $vendor->telex) }}"
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" value="{{ old('address_1', $vendor->address_1) }}"
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" value="{{ old('address_2', $vendor->address_2) }}"
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" value="{{ old('address_3', $vendor->address_3) }}"
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" value="{{ old('address_4', $vendor->address_4) }}"
                                ...
                                <div class="row">
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <select class="city-select" name="city_id">
                                                <option value="{{ $vendor->city_id }}">
                                                    {{ $vendor->city_id != null ? $vendor->city->code : '' }}</option>
                                            </select>
                                    ...
                                    <div class="col-md-8">
                                        <div class="form-group">
                                            ...
                                            <input type="text"
                                                value="{{ old('city_desc', $vendor->city_id != null ? $vendor->city->name : '') }}"
                                ...
                                <div class="row">
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <input type="text" value="{{ old('postal_code', $vendor->postal_code) }}"
                                    ...
                                    <div class="col-md-8">
                                        <div class="form-group">
                                            ...
                                            <input type="text" value="{{ old('province', $vendor->province) }}"
                                ...
                                <div class="row">
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <select class="country-select" name="country_id">
                                                <option value="{{ $vendor->country_id }}">
                                                    {{ $vendor->country_id != null ? $vendor->country->code : '' }}
                                                </option>
                                            </select>
                                    ...
                                    <div class="col-md-8">
                                        <div class="form-group">
                                            ...
                                            <input type="text"
                                                value="{{ old('country_desc', $vendor->country_id != null ? $vendor->country->name : '') }}"
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" value="{{ old('place', $vendor->place) }}"
                                        class="form-control" name="place" id="place">
                                </div>
                                <div class="form-group">
                                    <label for="email">Email </label>
                                    <input type="text" value="{{ old('email', $vendor->email) }}"
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-8">
                                        <div class="form-group">
                                            <label for="fax"> &nbsp;</label>
                                            <input type="text" value="{{ old('fax', $vendor->fax) }}"
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" value="{{ old('web_site', $vendor->web_site) }}"
