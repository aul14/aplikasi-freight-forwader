                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" value="{{ old('code', $vessel->code) }}"
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" value="{{ old('name', $vessel->name) }}"
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="short_name" id="short_name"
                                        value="{{ old('short_name', $vessel->short_name) }}"
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="classification" id="classification"
                                        value="{{ old('classification', $vessel->classification) }}"
                            ...
                            <div class="col-md-6">
                                <div class="row">
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <select class="shipline-select" name="shipping_line_id">
                                                <option value="{{ $vessel->shipping_line_id }}">
                                                    {{ $vessel->shipping_line_id != null ? $vessel->shipping_line->code : '' }}
                                                </option>
                                            </select>
                                    ...
                                    <div class="col-md-8">
                                        <div class="form-group">
                                            ...
                                            <input type="text"
                                                value="{{ old('shipline_desc', $vessel->shipping_line_id != null ? $vessel->shipping_line->name : '') }}"
                                                disabled class="form-control" name="shipline_desc" id="shipline_desc">
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <select class="bisnis_party-select" name="bisnis_party_id">
                                                <option value="{{ $vessel->bisnis_party_id }}">
                                                    {{ $vessel->bisnis_party_id != null ? $vessel->bisnis_party->code : '' }}
                                                </option>
                                            </select>
                                    ...
                                    <div class="col-md-8">
                                        <div class="form-group">
                                            ...
                                            <input type="text"
                                                value="{{ old('bisnis_party_desc', $vessel->bisnis_party_id != null ? $vessel->bisnis_party->name : '') }}"
                                                disabled class="form-control" name="bisnis_party_desc"
                                                id="bisnis_party_desc">
                                        </div>
                                    </div>
                                </div>
                                <div class="form-group">
                                    ...
                                    <input type="text" name="nrt" id="nrt" data-type='currency'
                                        value="{{ old('nrt', $nrt) }}" autocomplete="off"
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="grt" id="grt" data-type='currency'
                                        value="{{ old('grt', $grt) }}" autocomplete="off"
                                ...
                                <div class="row">
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <select class="country-select" name="country_id">
                                                <option value="{{ $vessel->country_id }}">
                                                    {{ $vessel->country_id != null ? $vessel->country->code : '' }}
                                                </option>
                                            </select>
                                    ...
                                    <div class="col-md-8">
                                        <div class="form-group">
                                            ...
                                            <input type="text"
                                                value="{{ old('country_desc', $vessel->country_id != null ? $vessel->country->name : '') }}"
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="year_build" id="year_build" data-type='currency'
                                        value="{{ old('year_build', $year_build) }}" autocomplete="off"
