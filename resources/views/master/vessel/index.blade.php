            ...
            <div class="card">
                <div class="card-header pb-0">
                    <div class="d-flex align-items-center">
                        @permission('create-vessel')
                            <a href="{{ route('vessel.create') }}" type="button" class="btn btn-sm btn-primary mb-2">Add</a>
                        @endpermission
                    </div>
                </div>
                        ...
                        <table id="myTable" class="my-table1 table my-tableview my-table-striped table-hover w-100">
                            <thead>
                                <tr>
                                    <th>Action</th>
                                    <th>No</th>
                                    <th class="select-filter">Vessel Code</th>
                                    <th class="select-filter">Vessel Name</th>
                                    <th class="select-filter">Shippingline Code</th>
                                    <th class="select-filter">Vessel Type</th>
                                    <th class="select-filter">Nrt</th>
                                    <th class="select-filter">Grt</th>
        ...
        $(document).ready(function() {
            ...
            $('#myTable').DataTable({
                ...
                columns: [{
                    ...
                    {
                        data: 'shipping_line.code',
                        name: 'shipping_line.code',
