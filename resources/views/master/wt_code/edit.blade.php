        ...
        <div class="col-12">
            ...
            <div class="card">
                <div class="card-header pb-0">
                    <h6>Form Edit W/T Code</h6>
                </div>
                <div class="card-body">
                    <form action="{{ route('wt_code.update', $wt_code->id) }}" method="post">
                        @csrf
                        @method('PUT')
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" value="{{ old('code', $wt_code->code) }}"
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" value="{{ old('description', $wt_code->description) }}"
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" value="{{ old('tax_rate', $tax_rate) }}"
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <select name="vendor_type_id" class="vendor_type">
                                        <option value="{{ $wt_code->vendor_type_id }}">
                                            {{ $wt_code->vendor_type_id != null ? $wt_code->vendor_type->type . ' | ' . $wt_code->vendor_type->type_name : '' }}
                                        </option>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" value="{{ old('wht_c_acc_code', $wt_code->wht_c_acc_code) }}"
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" value="{{ old('wht_p_acc_code', $wt_code->wht_p_acc_code) }}"
                            ...
                            <div class="col-md-12">
                                <a href="{{ route('wt_code.index') }}" class="btn btn-danger btn-back">Back</a>
