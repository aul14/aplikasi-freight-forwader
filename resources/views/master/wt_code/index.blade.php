...
@section('content')
    @include('layouts.navbars.auth.topnav', ['title' => 'Withholding Tax', 'title_2' => 'Master'])
            ...
            <div class="card">
                <div class="card-header pb-0">
                    <div class="d-flex align-items-center">
                        @permission('create-wt_code')
                            <a href="{{ route('wt_code.create') }}" type="button" class="btn btn-sm btn-primary mb-2">Add</a>
                        @endpermission
                    </div>
                </div>
                        ...
                        <table id="myTable" class="my-table1 table my-tableview my-table-striped table-hover w-100">
                            <thead>
                                <tr>
                                    <th>Action</th>
                                    <th>No</th>
                                    <th class="select-filter">Withholding Tax Code</th>
                                    <th class="select-filter">Withholding Tax Description</th>
                                    <th class="select-filter">Withholding Tax Rate</th>
