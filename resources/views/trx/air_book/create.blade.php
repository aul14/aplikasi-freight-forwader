        ...
        <div class="col-12">
            ...
            <div class="card">
                <div class="card-header pb-0">
                    <h6>Form Add Air Export Booking</h6>
                </div>
                <form action="{{ route('air_book.store') }}" method="post">
                    @csrf
                    @method('POST')
                    <div class="card-body">
                        <div class="row">
                            <div class="col-md-7">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" value="{{ old('booking_date', date('Y/m/d H:i')) }}"
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control @error('booking_from') is-invalid @enderror"
                                        name="booking_from" value="{{ old('booking_from') }}" id="booking_from">
                                    @error('booking_from')
                                        <div class="invalid-feedback">
                                            {{ $message }}
                                        </div>
                                ...
                                <div class="row">
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <select class="shipper-select @error('shipper_code') is-invalid @enderror"
                                                name="shipper_code">
                                                <option value="{{ old('shipper_code') }}">{{ old('shipper_code') }}
                                                </option>
                                            </select>
                                            @error('shipper_code')
                                                <div class="invalid-feedback">
                                    ...
                                    <div class="col-md-8">
                                        <div class="form-group">
                                            ...
                                            <input type="shipper_name" value="{{ old('shipper_name') }}"
                                ...
                                <div class="row">
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <select class="consignee-select @error('consignee_code') is-invalid @enderror"
                                                name="consignee_code">
                                                <option value="{{ old('consignee_code') }}">{{ old('consignee_code') }}
                                                </option>
                                            </select>
                                    ...
                                    <div class="col-md-8">
                                        <div class="form-group">
                                            ...
                                            <input type="consignee_name" value="{{ old('consignee_name') }}"
                                ...
                                <div class="row">
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <select class="coloader-select @error('coloader_code') is-invalid @enderror"
                                                name="coloader_code">
                                                <option value="{{ old('coloader_code') }}">{{ old('coloader_code') }}
                                                </option>
                                            </select>
                                            @error('coloader_code')
                                                <div class="invalid-feedback">
                                    ...
                                    <div class="col-md-8">
                                        <div class="form-group">
                                            ...
                                            <input type="coloader_name" value="{{ old('coloader_name') }}"
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-8">
                                        <div class="form-group">
                                            ...
                                            <input type="agent_name" value="{{ old('agent_name') }}"
                                    ...
                                    <div class="col-md-8">
                                        <div class="form-group">
                                            ...
                                            <input type="text" readonly
                                                ...
                                                name="air_dest_name" value="{{ old('air_dest_name') }}"
                                                id="airdest-name-1">
                                        </div>
                                    </div>
                                </div>
                                <div class="form-group">
                                    ...
                                    <select class="country-select @error('country_origin_code') is-invalid @enderror"
                                        ...
                                        <option value="{{ old('country_origin_code') }}">
                                            {{ old('country_origin_code') }}
                                        </option>
                                    </select>
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <select
                                                ...
                                                <option value="{{ old('delivery_type_code') }}">
                                                    {{ old('delivery_type_code') }}</option>
                                            </select>
                                    ...
                                    <div class="col-md-8">
                                        <div class="form-group">
                                            ...
                                            <input type="text" readonly class="form-control"
                                                value="{{ old('delivery_type_name') }}" name="delivery_type_name"
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <select class="commodity-select @error('commodity_code') is-invalid @enderror"
                                                name="commodity_code">
                                                <option value="{{ old('commodity_code') }}">{{ old('commodity_code') }}
                                                </option>
                                            </select>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="service_level" value="{{ old('service_level') }}"
                            ...
                            <div class="col-md-5">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select class="select-2 @error('job_type') is-invalid @enderror job-type"
                                                ...
                                                @foreach ($job_type as $item)
                                                    <option value="{{ $item->type }}" @selected($item->type == 'AE')>
                                                        {{ $item->type }}
                                                    </option>
                                                @endforeach
                                            </select>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" value="{{ old('job_date', date('Y/m/d')) }}"
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-6">
                                        <input type="checkbox" name="nomination_cargo" @checked(old('nomination_cargo') == 'yes')
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="awb_no" value="{{ old('awb_no') }}"
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="mawb_no" value="{{ old('mawb_no') }}"
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <select class="select-2 @error('weight_val_flag') is-invalid @enderror"
                                                ...
                                                <option value="PREPAID" @selected(old('weight_val_flag') == 'PREPAID')>PREPAID</option>
                                                <option value="COLLECT" @selected(old('weight_val_flag') == 'COLLECT')>COLLECT</option>
                                            </select>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <select class="select-2 @error('other_flag') is-invalid @enderror"
                                                name="other_flag">
                                                <option value="PREPAID" @selected(old('other_flag') == 'PREPAID')>PREPAID</option>
                                                <option value="COLLECT" @selected(old('other_flag') == 'COLLECT')>COLLECT</option>
                                            </select>
                                            @error('other_flag')
                                                <div class="invalid-feedback">
                                                    {{ $message }}
                                ...
                                <div class="row align-items-center">
                                    ...
                                    <div class="col-md-8 mt-2">
                                        <div class="form-group">
                                            <input type="text" value="{{ old('notify_name') }}"
                                    ...
                                    <div class="col-md-8 mt-2">
                                        <div class="form-group">
                                            <select
                                                ...
                                                <option value="{{ old('overseas_agent_code') }}">
                                                    {{ old('overseas_agent_code') }}</option>
                                            </select>
                                ...
                                <div class="row align-items-center">
                                    ...
                                    <div class="col-md-8">
                                        <div class="form-group">
                                            <input type="text" value="{{ old('overseas_agent_name') }}"
                                ...
                                <div class="row align-items-center">
                                    ...
                                    <div class="col-md-8 mt-2">
                                        <div class="form-group">
                                            <input type="text" value="{{ old('overseas_agent_address_1') }}"
                                    ...
                                    <div class="col-md-8 mt-2">
                                        <div class="form-group">
                                            <input type="text" value="{{ old('overseas_agent_address_2') }}"
                                    ...
                                    <div class="col-md-8 mt-2">
                                        <div class="form-group">
                                            <input type="text" value="{{ old('overseas_agent_address_3') }}"
                                    ...
                                    <div class="col-md-8 mt-2">
                                        <div class="form-group">
                                            <input type="text" value="{{ old('overseas_agent_address_4') }}"
                                    ...
                                    <div class="col-md-12" style="margin-top: -12px">
                                        <div class="form-group">
                                            ...
                                            <textarea name="footnote" id="footnote" cols="30" rows="5"
                                                class="form-control @error('footnote') is-invalid @enderror">{{ old('footnote') }}</textarea>
                                            @error('footnote')
                                                <div class="invalid-feedback">
                                                    {{ $message }}
                                                </div>
                                    ...
                                    <div class="d-flex flex-row">
                                        ...
                                        <div class="p-2" style="width: 20%">
                                            <input type="text" value="{{ old('flight_date_1') }}" autocomplete="off"
                                                required placeholder="First Flight Date"
                                    ...
                                    <div class="d-flex flex-row">
                                        ...
                                        <div class="p-2" style="width: 20%">
                                            <input type="number"
                                                ...
                                                title="Second Flight No" value="{{ old('flight_no_2') }}"
                                                id="flight_no_2">
                                            @error('flight_no_2')
                                                <div class="invalid-feedback">
                                                    {{ $message }}
                                    ...
                                    <div class="d-flex flex-row">
                                        ...
                                        <div class="p-2" style="width: 20%">
                                            <input type="number"
                                                ...
                                                title="Fourth Flight No" value="{{ old('flight_no_4') }}"
                                                id="flight_no_4">
                                            @error('flight_no_4')
                                                <div class="invalid-feedback">
                                                    {{ $message }}
                                ...
                                <div class="row" style="overflow:auto;">
                                    <div class="d-flex flex-row">
                                        ...
                                        <div class="p-2" style="width: 15%">
                                            <input type="text" value="{{ old('pcs') }}" title="Pcs/Rcp"
                                        ...
                                        <div class="p-2" style="width: 20%">
                                            <input type="text" class="form-control @error('uom') is-invalid @enderror"
                                                readonly name="uom" value="{{ old('uom') }}" id="uom">
                                            @error('uom')
                                                <div class="invalid-feedback">
                                                    {{ $message }}
                                                </div>
                                        ...
                                        <div class="p-2" style="width: 20%">
                                            <input type="text" data-type='currency4' autocomplete="off"
                                                title="Volume Weight" value="{{ old('volume_weight') }}"
                                ...
                                <div class="row">
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <input type="text" value="{{ old('footer_7') }}"
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <input type="text" value="{{ old('footer_8') }}"
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <input type="text" value="{{ old('footer_9') }}"
                                                ...
                                                <table id="table-condition"
                                                    ...
                                                    <tbody class="tbody-condition" id="tbody-condition-1">
                                                        <tr class="dynamic-field" id="dynamic-field-1">
                                                            ...
                                                            <td>
                                                                <div class="form-group">
                                                                    <input type="number" name="s_no[]"
                                                                        class="form-control s-no" id="s-no-1" readonly
                                                                        value="1">
                                                                </div>
                                                            </td>
                                                            ...
                                                            <td>
                                                                <div class="form-group">
                                                                    <input type="number" name="loose_qty[]"
                                                                        class="form-control loose-qty" id="loose-qty-1">
                                                                </div>
                                                            </td>
                                                            ...
                                                            <td>
                                                                <div class="form-group">
                                                                    <input type="text" class="form-control length"
                                                                        id="length-1" autocomplete="off"
                                                                        onkeyup="sumDimension(1, 1)" data-type='currency1'
                                                                        name="length[]">
                                                                </div>
                                                            </td>
                                                            ...
                                                            <td>
                                                                <div class="form-group">
                                                                    <input type="hidden" id="sum-m3-1" name="sum_m3[]"
