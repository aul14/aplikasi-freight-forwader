<div class="row">
    <div class="col-md-6">
        ...
        <div class="form-group">
            ...
            <input type="text" class="form-control @error('mawb_no') is-invalid @enderror" readonly
                placeholder="M AWB No" value="{{ old('mawb_no', $jm->mawb_no) }}" required name="mawb_no"
                id="mawb_no">
            @error('mawb_no')
                <div class="invalid-feedback">
                    {{ $message }}
            ...
            <div class="col-md-8">
                <div class="form-group">
                    ...
                    <input type="text" class="form-control @error('booking_no') is-invalid @enderror"
                        name="booking_no" value="{{ old('booking_no', $aj->booking_no) }}" id="booking_no">
                    @error('booking_no')
                        <div class="invalid-feedback">
                            {{ $message }}
                        </div>
    ...
    <div class="col-md-6">
        ...
        <div class="row">
            <div class="col-md-4">
                <div class="form-group">
                    ...
                    <select class="agent-select @error('agent_code') is-invalid @enderror" name="agent_code">
                        <option value="{{ old('agent_code', $aj->agent_code) }}">
                            {{ old('agent_code', $aj->agent_code) }}
                        </option>
                    </select>
            ...
            <div class="col-md-8">
                <div class="form-group">
                    ...
                    <input type="text" value="{{ old('agent_name', $aj->agent_name) }}" readonly
                        placeholder="Agent Name" class="form-control @error('agent_name') is-invalid @enderror"
        ...
        <div class="form-group">
            ...
            <input type="text" value="{{ old('agent_iata_code', $aj->agent_iata_code) }}"
                placeholder="Agent IATA Name" class="form-control @error('agent_iata_code') is-invalid @enderror"
                name="agent_iata_code" id="agent_iata_code">
        ...
        <div class="form-group">
            ...
            <input type="text" value="{{ old('agent_acc_no', $aj->agent_acc_no) }}"
                placeholder="Agent Account No." class="form-control @error('agent_acc_no') is-invalid @enderror"
                name="agent_acc_no" id="agent_acc_no">
            @error('agent_acc_no')
                <div class="invalid-feedback">
                    {{ $message }}
                </div>
        ...
        <div class="form-group">
            ...
            <input type="text" class="form-control @error('awb_prefix') is-invalid @enderror" name="awb_prefix"
                value="{{ old('awb_prefix', $aj->awb_prefix) }}" id="awb_prefix">
            @error('awb_prefix')
                <div class="invalid-feedback">
                    {{ $message }}
                </div>
        ...
        <div class="form-group">
            ...
            <input type="text" value="{{ old('shipper_acc_no', $aj->shipper_acc_no) }}"
                placeholder="Shipper Account No." class="form-control @error('shipper_acc_no') is-invalid @enderror"
                name="shipper_acc_no" id="shipper_acc_no">
        ...
        <div class="form-group">
            ...
            <input type="text" value="{{ old('consignee_acc_no', $aj->consignee_acc_no) }}"
                placeholder="Consignee Account No."
