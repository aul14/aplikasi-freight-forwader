        ...
        <div class="col-12">
            ...
            <div class="card">
                <div class="card-header pb-0">
                    <h6>Form Add Air Export Job</h6>
                </div>
                <form action="{{ route('air_ex_job.store') }}" method="post">
                    @csrf
                    @method('POST')
                    <div class="card-body">
                        <div class="row">
                                ...
                                <div class="tabset">
                                    ...
                                    <div class="tab-panels col-md-12">
                                        <section id="awb" class="tab-panel">
                                            @include('trx.air_ex_job.awb')
                                        </section>

                                        <section id="s_i" class="tab-panel">
                                            @include('trx.air_ex_job.si')
                                        </section>

                                        <section id="d_m" class="tab-panel">
                                            @include('trx.air_ex_job.dm')
                                        </section>

                                        <section id="r_d" class="tab-panel">
                                            @include('trx.air_ex_job.rd')
                                        </section>

                                        <section id="j_c" class="tab-panel">
                                            @include('trx.air_ex_job.jc')
                                        </section>
                                    </div>
                                </div>
                            </div>
