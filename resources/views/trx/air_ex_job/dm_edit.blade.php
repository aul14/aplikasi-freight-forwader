            ...
            <div class="col-md-2">
                <div class="form-group">
                    ...
                    <input type="text" class="form-control @error('vol_wt_ratio') is-invalid @enderror"
                        name="vol_wt_ratio"
                        value="{{ old('vol_wt_ratio', !empty($aj->vol_wt_ratio) ? $aj->vol_wt_ratio : '6000') }}"
                        id="vol_wt_ratio">
                    @error('vol_wt_ratio')
            ...
            <div class="col-md-2">
                <div class="form-group">
                    ...
                    <select class="select-2 @error('satuan_dimension') is-invalid @enderror" name="satuan_dimension">
                        <option value="CM" @selected(old('satuan_dimension', $aj->satuan_dimension) == 'CM')>CM</option>
                        <option value="IN" @selected(old('satuan_dimension', $aj->satuan_dimension) == 'IN')>IN</option>
                    </select>
            ...
            <div class="col-md-2">
                <div class="form-group">
                    ...
                    <select class="select-2 @error('kg_lb_flag') is-invalid @enderror" name="kg_lb_flag">
                        <option value="KILO" @selected(old('kg_lb_flag', $aj->kg_lb_flag) == 'KILO')>KILO</option>
                        <option value="LB" @selected(old('kg_lb_flag', $aj->kg_lb_flag) == 'LB')>LB</option>
                    </select>
                    @error('kg_lb_flag')
                        <div class="invalid-feedback">
                            {{ $message }}
            ...
            <div class="col-md-2">
                <div class="form-group">
                    ...
                    <input type="text" data-type="currency"
                        ...
                        value="{{ old('no_high_pallet', !empty($aj->no_high_pallet) ? number_format($aj->no_high_pallet, 2, '.', ',') : '') }}"
                        id="no_high_pallet">
            ...
            <div class="col-md-2">
                <div class="form-group">
                    ...
                    <input type="text" data-type="currency"
                        ...
                        value="{{ old('no_low_pallet', !empty($aj->no_low_pallet) ? number_format($aj->no_low_pallet, 2, '.', ',') : '') }}"
                        id="no_low_pallet">
                    @error('no_low_pallet')
                        <div class="invalid-feedback">
                            {{ $message }}
            ...
            <div class="col-md-2">
                <div class="form-group">
                    ...
                    <input type="text" data-type="currency"
                        ...
                        value="{{ old('no_container', !empty($aj->no_container) ? number_format($aj->no_container, 2, '.', ',') : '') }}"
                        id="no_container">
                    @error('no_container')
                        <div class="invalid-feedback">
                            {{ $message }}
                            ...
                            @foreach ($ad2 as $key => $val)
                                <tr class="dynamic-fieldsi" id="dynamic-fieldsi-1">
                                    <td class="text-center">
                                        <button type="button" onclick="addNewFieldSi(this.id)"
                                            id="add-buttonsi-{{ $key + 1 }}"
                                            class="btn btn-xs btn-primary float-left text-uppercase shadow-sm add-button"><i
                                                class="fa fa-plus fa-fw"></i>
                                        </button>
                                        <button type="button" onclick="removeLastFieldSi(this)"
                                            id="remove-buttonsi-{{ $key + 1 }}"
                                    ...
                                    <td>
                                        <div class="form-group">
                                            <input type="number" name="pcs_rcp[]" class="form-control pcs-rcp"
                                                data-pcs="1" id="pcs-rcp-{{ $key + 1 }}"
                                    ...
                                    <td>
                                        <div class="form-group">
                                            <input type="text" class="form-control length"
                                                id="length-{{ $key + 1 }}" autocomplete="off"
                                                onkeyup="sumDimension({{ $key + 1 }}, 1)" data-type='currency1'
                                                name="length[]"
                                    ...
                                    <td>
                                        <div class="form-group">
                                            <input type="text" class="form-control width"
                                                id="width-{{ $key + 1 }}" autocomplete="off"
                                                onkeyup="sumDimension({{ $key + 1 }}, 1)" data-type='currency1'
                                                name="width[]" value="{{ number_format($val->width, 1, '.', ',') }}">
                                        </div>
                                    </td>
                                    ...
                                    <td>
                                        <div class="form-group">
                                            <input type="text" class="form-control height"
                                                id="height-{{ $key + 1 }}" autocomplete="off"
                                                onkeyup="sumDimension({{ $key + 1 }}, 1)" data-type='currency1'
                                                name="height[]"
                                    ...
                                    <td>
                                        <div class="form-group">
                                            <input type="hidden" id="sum-m3-{{ $key + 1 }}" name="sum_m3[]"
                                                class="sum-m3" data-m3="1" value="{{ $val->sum_m3 }}">
                                            <input type="hidden" id="sum-volwt-1{{ $key + 1 }}"
                                                name="sum_volwt[]" class="sum-volwt" data-volwt="1"
                                                value="{{ $val->sum_volwt }}">
                                            <input type="text" class="form-control dimension"
                                                id="dimension-{{ $key + 1 }}" data-dimension="1"
                                                autocomplete="off" readonly data-type='currency1' name="dimension[]"
                        ...
                        @else
                            <tr class="dynamic-fieldsi" id="dynamic-fieldsi-1">
                                ...
                                <td>
                                    <div class="form-group">
                                        <input type="number" name="pcs_rcp[]" class="form-control pcs-rcp"
                                            data-pcs="1" id="pcs-rcp-1" onkeyup="sumDimension(1, 1)">
                                    </div>
                                </td>
                    ...
                    <div class="col-md-6 d-flex justify-content-end">
                        <div class="form-group">
                            ...
                            <input type="text" data-type='currency0' readonly title="Total M3"
                                ...
                                id="total-m3-1"
                                value="{{ old('total_m3', number_format($aj->total_m3, 3, '.', ',')) }}">
                            @error('total_m3')
                                <div class="invalid-feedback">
                                    {{ $message }}
                                </div>
                    ...
                    <div class="col-md-6 d-flex justify-content-end">
                        <div class="form-group">
                            ...
                            <input type="text" data-type='currency0' readonly title="Total Dimension"
                                ...
                                value="{{ old('total_dimension', number_format($aj->total_dimension, 1, '.', ',')) }}">
                    ...
                    <div class="col-md-6 d-flex justify-content-end">
                        <div class="form-group">
                            ...
                            <input type="text" data-type='currency0' readonly title="Total Pcs"
                                ...
                                value="{{ old('total_pcs', number_format($aj->total_pcs, 0, '.', ',')) }}">
                            @error('total_pcs')
                                <div class="invalid-feedback">
                                    {{ $message }}
                                </div>
                    ...
                    <div class="col-md-6 d-flex justify-content-end">
                        <div class="form-group">
                            ...
                            <input type="text" data-type='currency0' readonly title="Total Volume Weight"
                                ...
                                value="{{ old('total_vol_wt', number_format($aj->total_vol_wt, 1, '.', ',')) }}">
                            @error('total_vol_wt')
                                <div class="invalid-feedback">
                                    {{ $message }}
                                </div>
