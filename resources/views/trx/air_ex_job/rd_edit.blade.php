            ...
            <div class="col-md-2">
                <div class="form-group">
                    ...
                    <select name="uom" id="uom-rd-1" class="uom-rd @error('uom') is-invalid @enderror">
                        <option value="{{ old('uom', $ad3->uom) }}">{{ old('uom', $ad3->uom) }}</option>
                    </select>
                    @error('uom')
                        <div class="invalid-feedback">
                            {{ $message }}
            ...
            <div class="col-md-2">
                <div class="form-group">
                    ...
                    <input type="text" data-type="currency"
                        ...
                        value="{{ old('gross_weight', !empty($ad3->gross_weight) ? number_format($ad3->gross_weight, 2, '.', ',') : '') }}"
                        id="gross_weight">
                    @error('gross_weight')
                        <div class="invalid-feedback">
                            {{ $message }}
            ...
            <div class="col-md-2">
                <div class="form-group">
                    ...
                    <select name="rate_class" id="rate_class-rd-1"
                        ...
                        <option value="Minimum Charge" @selected(old('rate_class', $ad3->rate_class) == 'Minimum Charge')>Minimum Charge</option>
                        <option value="Normal Rate" @selected(old('rate_class', $ad3->rate_class) == 'Normal Rate')>Normal Rate</option>
                        <option value="Quantity Rate" @selected(old('rate_class', $ad3->rate_class) == 'Quantity Rate')>Quantity Rate</option>
                        <option value="Specific Commodity Rate" @selected(old('rate_class', $ad3->rate_class) == 'Specific Commodity Rate')>
                            Specific Commodity Rate
                        </option>
                        <option value="Class Rate Reduction" @selected(old('rate_class', $ad3->rate_class) == 'Class Rate Reduction')>
                            Class Rate Reduction
                        </option>
                        <option value="Class Rate Surcharge" @selected(old('rate_class', $ad3->rate_class) == 'Class Rate Surcharge')>
                            Class Rate Surcharge
                        </option>
                        <option value="ULD Basic Charge" @selected(old('rate_class', $ad3->rate_class) == 'ULD Basic Charge')>
                            ULD Basic Charge
                        </option>
                        <option value="ULD Additioal Rate" @selected(old('rate_class', $ad3->rate_class) == 'ULD Additioal Rate')>
                            ULD Additioal Rate
                        </option>
                        <option value="ULD Discount" @selected(old('rate_class', $ad3->rate_class) == 'ULD Discount')>
                            ULD Discount
                        </option>
                        <option value="Base Charge" @selected(old('rate_class', $ad3->rate_class) == 'Base Charge')>
                            Base Charge
                        </option>
                        <option value="Rate Per Kilo" @selected(old('rate_class', $ad3->rate_class) == 'Rate Per Kilo')>
                            Rate Per Kilo
                        </option>
                    </select>
                    @error('rate_class')
            ...
            <div class="col-md-2">
                <div class="form-group">
                    ...
                    <select name="commodity_code" id="commodity_code-rd-1"
                        ...
                        <option value="{{ old('commodity_code', $ad3->commodity_code) }}">
                            {{ old('commodity_code', $ad3->commodity_code) }}</option>
                    </select>
            ...
            <div class="col-md-2">
                <div class="form-group">
                    ...
                    <select class="salesman-select @error('salesman_code') is-invalid @enderror" name="salesman_code">
                        <option value="{{ old('salesman_code', $aj->jm->salesman_code) }}">
                            {{ old('salesman_code', $aj->jm->salesman_code) }}</option>
                    </select>
                    <input type="hidden" name="salesman" value="{{ old('salesman', $aj->jm->salesman) }}">
                    @error('salesman_code')
                        <div class="invalid-feedback">
                            {{ $message }}
                        </div>
            ...
            <div class="col-md-2">
                <div class="form-group">
                    ...
                    <input type="text" data-type="currency" readonly
                        ...
                        value="{{ old('chargeable_wt', !empty($ad3->chargeable_wt) ? number_format($ad3->chargeable_wt, 2, '.', ',') : '') }}"
                        id="chargeable_wt">
                    @error('chargeable_wt')
                        <div class="invalid-feedback">
                            {{ $message }}
            ...
            <div class="col-md-2">
                <div class="form-group">
                    ...
                    <input type="text" data-type="currency"
                        ...
                        value="{{ old('doc_rate', !empty($ad3->doc_rate) ? number_format($ad3->doc_rate, 2, '.', ',') : '') }}"
                        id="doc_rate">
                    @error('doc_rate')
                        <div class="invalid-feedback">
                            {{ $message }}
            ...
            <div class="col-md-2">
                <div class="form-group">
                    ...
                    <input type="text" data-type="currency"
                        ...
                        value="{{ old('doc_total_amt', !empty($ad3->doc_total_amt) ? number_format($ad3->doc_total_amt, 2, '.', ',') : '') }}"
                        id="doc_total_amt">
                    @error('doc_total_amt')
                        <div class="invalid-feedback">
                            {{ $message }}
            ...
            <div class="col-md-2">
                <div class="form-group">
                    ...
                    <input type="text" data-type="currency"
                        ...
                        value="{{ old('slac_qty', !empty($ad3->slac_qty) ? number_format($ad3->slac_qty, 2, '.', ',') : '') }}"
                        id="slac_qty">
                    @error('slac_qty')
                        <div class="invalid-feedback">
                            {{ $message }}
            ...
            <div class="col-md-2">
                <div class="form-group">
                    ...
                    <select name="slac_uom" id="slac_uom-rd-1"
                        ...
                        <option value="{{ old('slac_uom', $ad3->slac_uom) }}">{{ old('slac_uom', $ad3->slac_uom) }}
                        </option>
                    </select>
                    @error('slac_uom')
                        <div class="invalid-feedback">
            ...
            <div class="col-md-2">
                <div class="form-group">
                    ...
                    <input type="text" data-type="currency"
                        ...
                        value="{{ old('user_charge_wt', !empty($ad3->user_charge_wt) ? number_format($ad3->user_charge_wt, 2, '.', ',') : '') }}"
                        id="user_charge_wt">
            ...
            <div class="col-md-6">
                <div class="form-group">
                    ...
                    <input type="text" placeholder="Description 01"
                        ...
                        value="{{ old('desc_1', $ad3->desc_1) }}" id="desc_1">
                    @error('desc_1')
                        <div class="invalid-feedback">
                            {{ $message }}
                        </div>
                ...
                <div class="form-group">
                    <input type="text" placeholder="Description 02"
                        ...
                        value="{{ old('desc_2', $ad3->desc_2) }}" id="desc_2">
                    @error('desc_2')
                        <div class="invalid-feedback">
                            {{ $message }}
                        </div>
                ...
                <div class="form-group">
                    <input type="text" placeholder="Description 03"
                        ...
                        value="{{ old('desc_3', $ad3->desc_3) }}" id="desc_3">
                    @error('desc_3')
                        <div class="invalid-feedback">
                            {{ $message }}
                        </div>
                ...
                <div class="form-group">
                    <input type="text" placeholder="Description 04"
                        ...
                        value="{{ old('desc_4', $ad3->desc_4) }}" id="desc_4">
                    @error('desc_4')
                        <div class="invalid-feedback">
                            {{ $message }}
                        </div>
                ...
                <div class="form-group">
                    <input type="text" placeholder="Description 05"
                        ...
                        value="{{ old('desc_5', $ad3->desc_5) }}" id="desc_5">
                    @error('desc_5')
                        <div class="invalid-feedback">
                            {{ $message }}
                        </div>
                ...
                <div class="form-group">
                    <input type="text" placeholder="Description 06"
                        ...
                        value="{{ old('desc_6', $ad3->desc_6) }}" id="desc_6">
                    @error('desc_6')
                        <div class="invalid-feedback">
                            {{ $message }}
                        </div>
                ...
                <div class="form-group">
                    <input type="text" placeholder="Description 07"
                        ...
                        value="{{ old('desc_7', $ad3->desc_7) }}" id="desc_7">
                    @error('desc_7')
                        <div class="invalid-feedback">
                            {{ $message }}
                        </div>
                ...
                <div class="form-group">
                    <input type="text" placeholder="Description 08"
                        ...
                        value="{{ old('desc_8', $ad3->desc_8) }}" id="desc_8">
                    @error('desc_8')
                        <div class="invalid-feedback">
                            {{ $message }}
                        </div>
                ...
                <div class="form-group">
                    <input type="text" placeholder="Description 09"
                        ...
                        value="{{ old('desc_9', $ad3->desc_9) }}" id="desc_9">
                    @error('desc_9')
                        <div class="invalid-feedback">
                            {{ $message }}
                        </div>
                ...
                <div class="form-group">
                    <input type="text" placeholder="Description 10"
                        ...
                        value="{{ old('desc_10', $ad3->desc_10) }}" id="desc_10">
                    @error('desc_10')
                        <div class="invalid-feedback">
                            {{ $message }}
                        </div>
                ...
                <div class="form-group">
                    <input type="text" placeholder="Description 11"
                        ...
                        value="{{ old('desc_11', $ad3->desc_11) }}" id="desc_11">
                    @error('desc_11')
                        <div class="invalid-feedback">
                            {{ $message }}
                        </div>
                ...
                <div class="form-group">
                    <input type="text" placeholder="Description 12"
                        ...
                        value="{{ old('desc_12', $ad3->desc_12) }}" id="desc_12">
                    @error('desc_12')
                        <div class="invalid-feedback">
                            {{ $message }}
                        </div>
            ...
            <div class="col-md-6">
                <div class="form-group">
                    ...
                    <input type="text" placeholder="Commodity Description 01"
                        ...
                        value="{{ old('commodity_desc_1', $ad3->commodity_desc_1) }}" id="commodity_desc_1">
                ...
                <div class="form-group">
                    <input type="text" placeholder="Commodity Description 02"
                        ...
                        value="{{ old('commodity_desc_2', $ad3->commodity_desc_2) }}" id="commodity_desc_2">
                ...
                <div class="form-group">
                    <input type="text" placeholder="Commodity Description 03"
                        ...
                        value="{{ old('commodity_desc_3', $ad3->commodity_desc_3) }}" id="commodity_desc_3">
                ...
                <div class="form-group">
                    <input type="text" placeholder="Commodity Description 04"
                        ...
                        value="{{ old('commodity_desc_4', $ad3->commodity_desc_4) }}" id="commodity_desc_4">
                ...
                <div class="form-group">
                    <input type="text" placeholder="Commodity Description 05"
                        ...
                        value="{{ old('commodity_desc_5', $ad3->commodity_desc_5) }}" id="commodity_desc_5">
                ...
                <div class="form-group">
                    <input type="text" placeholder="Commodity Description 06"
                        ...
                        value="{{ old('commodity_desc_6', $ad3->commodity_desc_6) }}" id="commodity_desc_6">
                ...
                <div class="form-group">
                    <input type="text" placeholder="Commodity Description 07"
                        ...
                        value="{{ old('commodity_desc_7', $ad3->commodity_desc_7) }}" id="commodity_desc_7">
                ...
                <div class="form-group">
                    <input type="text" placeholder="Commodity Description 08"
                        ...
                        value="{{ old('commodity_desc_8', $ad3->commodity_desc_8) }}" id="commodity_desc_8">
                ...
                <div class="form-group">
                    <input type="text" placeholder="Commodity Description 09"
                        ...
                        value="{{ old('commodity_desc_9', $ad3->commodity_desc_9) }}" id="commodity_desc_9">
                ...
                <div class="form-group">
                    <input type="text" placeholder="Commodity Description 10"
                        ...
                        name="commodity_desc_10" value="{{ old('commodity_desc_10', $ad3->commodity_desc_10) }}"
                        id="commodity_desc_10">
                ...
                <div class="form-group">
                    <input type="text" placeholder="Commodity Description 11"
                        ...
                        name="commodity_desc_11" value="{{ old('commodity_desc_11', $ad3->commodity_desc_11) }}"
                        id="commodity_desc_11">
                ...
                <div class="form-group">
                    <input type="text" placeholder="Commodity Description 12"
                        ...
                        name="commodity_desc_12" value="{{ old('commodity_desc_12', $ad3->commodity_desc_12) }}"
                        id="commodity_desc_12">
