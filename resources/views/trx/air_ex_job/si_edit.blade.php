                ...
                <div class="col-md-4">
                    <div class="form-group">
                        ...
                        <select class="airdept-select @error('air_dept_code') is-invalid @enderror" id="airdept-select-1"
                            ...
                            <option
                                value="{{ old('air_dept_code', !empty($ad1->air_dept_code) ? $ad1->air_dept_code : 'JKT') }}">
                                {{ old('air_dept_code', !empty($ad1->air_dept_code) ? $ad1->air_dept_code : 'JKT') }}
                            </option>
                        </select>
                        @error('air_dept_code')
                ...
                <div class="col-md-8">
                    <div class="form-group">
                        ...
                        <input type="text"
                            ...
                            name="air_dept_name"
                            value="{{ old('air_dept_name', !empty($ad1->air_dept_name) ? $ad1->air_dept_name : 'JAKARTA SOEKARNO HATTA') }}"
                            id="airdept-name-1">
                    </div>
                </div>
            </div>
                    ...
                    <div class="d-flex flex-row">
                        <div class="p-2" style="width: 20%">
                            <select class="flight-select @error('to_dest_code_1') is-invalid @enderror" required
                                name="to_dest_code_1">
                                <option value="{{ old('to_dest_code_1', $ad1->to_dest_code_1) }}">
                                    {{ old('to_dest_code_1', $ad1->to_dest_code_1) }}
                                </option>
                            </select>
                        ...
                        <div class="p-2" style="width: 20%">
                            <select name="by_airline_id_1"
                                ...
                                <option value="{{ old('by_airline_id_1', $ad1->by_airline_id_1) }}">
                                    {{ old('by_airline_id_1', $ad1->by_airline_id_1) }}</option>
                            </select>
                        ...
                        <div class="p-2" style="width: 20%">
                            <input type="number" class="form-control @error('flight_no_1') is-invalid @enderror"
                                ...
                                value="{{ old('flight_no_1', $ad1->flight_no_1) }}" id="flight_no_1">
                            @error('flight_no_1')
                                <div class="invalid-feedback">
                                    {{ $message }}
                                </div>
                        ...
                        <div class="p-2" style="width: 20%">
                            <input type="text"
                                value="{{ old('eta_date_1', !empty($ad1->eta_date_1) ? date('Y/m/d H:i', strtotime($ad1->eta_date_1)) : '') }}"
                    ...
                    <div class="d-flex flex-row">
                        <div class="p-2" style="width: 20%">
                            <select class="flight-select @error('to_dest_code_2') is-invalid @enderror"
                                name="to_dest_code_2">
                                <option value="{{ old('to_dest_code_2', $ad1->to_dest_code_2) }}">
                                    {{ old('to_dest_code_2', $ad1->to_dest_code_2) }}
                                </option>
                            </select>
                        ...
                        <div class="p-2" style="width: 20%">
                            <select name="by_airline_id_2"
                                ...
                                <option value="{{ old('by_airline_id_2', $ad1->by_airline_id_2) }}">
                                    {{ old('by_airline_id_2', $ad1->by_airline_id_2) }}</option>
                            </select>
                        ...
                        <div class="p-2" style="width: 20%">
                            <input type="number" class="form-control @error('flight_no_2') is-invalid @enderror"
                                ...
                                value="{{ old('flight_no_2', $ad1->flight_no_2) }}" id="flight_no_2">
                            @error('flight_no_2')
                                <div class="invalid-feedback">
                                    {{ $message }}
                                </div>
                        ...
                        <div class="p-2" style="width: 20%">
                            <input type="text"
                                value="{{ old('flight_date_2', !empty($ad1->flight_date_2) ? date('Y/m/d H:i', strtotime($ad1->flight_date_2)) : '') }}"
                        ...
                        <div class="p-2" style="width: 20%">
                            <input type="text"
                                value="{{ old('eta_date_2', !empty($ad1->eta_date_2) ? date('Y/m/d H:i', strtotime($ad1->eta_date_2)) : '') }}"
                    ...
                    <div class="d-flex flex-row">
                        <div class="p-2" style="width: 20%">
                            <select class="flight-select @error('to_dest_code_3') is-invalid @enderror"
                                name="to_dest_code_3">
                                <option value="{{ old('to_dest_code_3', $ad1->to_dest_code_3) }}">
                                    {{ old('to_dest_code_3', $ad1->to_dest_code_3) }}
                                </option>
                            </select>
                        ...
                        <div class="p-2" style="width: 20%">
                            <select name="by_airline_id_3"
                                ...
                                <option value="{{ old('by_airline_id_3', $ad1->by_airline_id_3) }}">
                                    {{ old('by_airline_id_3', $ad1->by_airline_id_3) }}</option>
                            </select>
                        ...
                        <div class="p-2" style="width: 20%">
                            <input type="number" class="form-control @error('flight_no_3') is-invalid @enderror"
                                ...
                                value="{{ old('flight_no_3', $ad1->flight_no_3) }}" id="flight_no_3">
                            @error('flight_no_3')
                                <div class="invalid-feedback">
                                    {{ $message }}
                                </div>
                        ...
                        <div class="p-2" style="width: 20%">
                            <input type="text"
                                value="{{ old('flight_date_3', !empty($ad1->flight_date_3) ? date('Y/m/d H:i', strtotime($ad1->flight_date_3)) : '') }}"
                        ...
                        <div class="p-2" style="width: 20%">
                            <input type="text"
                                value="{{ old('eta_date_3', !empty($ad1->eta_date_3) ? date('Y/m/d H:i', strtotime($ad1->eta_date_3)) : '') }}"
                    ...
                    <div class="d-flex flex-row">
                        <div class="p-2" style="width: 20%">
                            <select class="flight-select @error('to_dest_code_4') is-invalid @enderror"
                                name="to_dest_code_4">
                                <option value="{{ old('to_dest_code_4', $ad1->to_dest_code_4) }}">
                                    {{ old('to_dest_code_4', $ad1->to_dest_code_4) }}
                                </option>
                            </select>
                        ...
                        <div class="p-2" style="width: 20%">
                            <select name="by_airline_id_4"
                                ...
                                <option value="{{ old('by_airline_id_4', $ad1->by_airline_id_4) }}">
                                    {{ old('by_airline_id_4', $ad1->by_airline_id_4) }}</option>
                            </select>
                        ...
                        <div class="p-2" style="width: 20%">
                            <input type="number" class="form-control @error('flight_no_4') is-invalid @enderror"
                                ...
                                value="{{ old('flight_no_4', $ad1->flight_no_4) }}" id="flight_no_4">
                            @error('flight_no_4')
                                <div class="invalid-feedback">
                                    {{ $message }}
                                </div>
                        ...
                        <div class="p-2" style="width: 20%">
                            <input type="text"
                                value="{{ old('flight_date_4', !empty($ad1->flight_date_4) ? date('Y/m/d H:i', strtotime($ad1->flight_date_4)) : '') }}"
                        ...
                        <div class="p-2" style="width: 20%">
                            <input type="text"
                                value="{{ old('eta_date_4', !empty($ad1->eta_date_4) ? date('Y/m/d H:i', strtotime($ad1->eta_date_4)) : '') }}"
                ...
                <div class="col-md-4">
                    <div class="form-group">
                        ...
                        <select class="airdest-select @error('air_dest_code') is-invalid @enderror"
                            ...
                            <option value="{{ old('air_dest_code', $ad1->air_dest_code) }}">
                                {{ old('air_dest_code', $ad1->air_dest_code) }}
                            </option>
                        </select>
                        @error('air_dest_code')
                            <div class="invalid-feedback">
                ...
                <div class="col-md-8">
                    <div class="form-group">
                        ...
                        <input type="text"
                            ...
                            name="air_dest_name" value="{{ old('air_dest_name', $ad1->air_dest_name) }}"
                            id="airdest-name-1">
                        @error('air_dest_name')
                            <div class="invalid-feedback">
                                {{ $message }}
        ...
        <div class="col-md-3">
            <div class="form-group">
                ...
                <input type="text" class="form-control currsi-rate @error('curr_rate') is-invalid @enderror"
                    data-type='currency' name="curr_rate"
        ...
        <div class="col-md-3">
            <div class="form-group">
                ...
                <select class="collectsi-code @error('collect_curr_code') is-invalid @enderror"
                    ...
                    <option
                        value="{{ old('collect_curr_code', !empty($ad1->collect_curr_code) ? $ad1->collect_curr_code : 'IDR') }}">
                        {{ old('collect_curr_code', !empty($ad1->collect_curr_code) ? $ad1->collect_curr_code : 'IDR - INDONESIA RUPIAH') }}
                    </option>
                </select>
        ...
        <div class="col-md-3">
            <div class="form-group">
                ...
                <input type="text"
                    ...
                    data-type='currency' name="collect_curr_rate"
                    value="{{ old('collect_curr_rate', !empty($ad1->collect_curr_rate) ? number_format($ad1->collect_curr_rate, 2, '.', ',') : '1.00') }}">
        ...
        <div class="col-md-3">
            <div class="form-group">
                ...
                <select class="select-null @error('weight_val_flag') is-invalid @enderror" required
                    ...
                    <option value="PREPAID" @selected($ad1->weight_val_flag == 'PREPAID')>PREPAID</option>
                </select>
        ...
        <div class="col-md-3">
            <div class="form-group">
                ...
                <select class="bill-party @error('frt_bill_party') is-invalid @enderror" name="frt_bill_party">
                    <option value="{{ old('frt_bill_party', $ad1->frt_bill_party) }}">
                        {{ old('frt_bill_party', $ad1->frt_bill_party) }}</option>
                </select>
        ...
        <div class="col-md-3">
            <div class="form-group">
                ...
                <select class="select-null @error('other_flag') is-invalid @enderror" required name="other_flag">
                    <option value=""></option>
                    <option value="COLLECT" @selected($ad1->other_flag == 'COLLECT')>COLLECT</option>
                    <option value="PREPAID" @selected($ad1->other_flag == 'PREPAID')>PREPAID</option>
                </select>
                @error('other_flag')
                    <div class="invalid-feedback">
                        {{ $message }}
        ...
        <div class="col-md-3">
            <div class="form-group">
                ...
                <select class="bill-party @error('other_bill_party') is-invalid @enderror" name="other_bill_party">
                    <option value="{{ old('other_bill_party', $ad1->other_bill_party) }}">
                        {{ old('other_bill_party', $ad1->other_bill_party) }}</option>
                </select>
        ...
        <div class="col-md-3">
            <div class="form-group">
                ...
                <input type="text" class="form-control @error('declare_val_carriage') is-invalid @enderror"
                    name="declare_val_carriage"
                    value="{{ old('declare_val_carriage', !empty($ad1->declare_val_carriage) ? $ad1->declare_val_carriage : 'N.V.D') }}">
        ...
        <div class="col-md-3">
            <div class="form-group">
                ...
                <select class="currency-only @error('custom_curr_code') is-invalid @enderror"
                    ...
                    <option value="{{ old('custom_curr_code', $ad1->custom_curr_code) }}">
                        {{ old('custom_curr_code', $ad1->custom_curr_code) }}
                    </option>
                </select>
        ...
        <div class="col-md-3">
            <div class="form-group">
                ...
                <input type="text" class="form-control @error('custom_declare_val') is-invalid @enderror"
                    name="custom_declare_val"
                    value="{{ old('custom_declare_val', !empty($ad1->custom_declare_val) ? $ad1->custom_declare_val : 'N.C.V') }}">
        ...
        <div class="col-md-3">
            <div class="form-group">
                ...
                <input type="text" class="form-control @error('custom_local_amt') is-invalid @enderror"
                    data-type='currency' name="custom_local_amt"
                    value="{{ old('custom_local_amt', !empty($ad1->custom_local_amt) ? number_format($ad1->custom_local_amt, 2, '.', ',') : '') }}">
        ...
        <div class="col-md-3">
            <div class="form-group">
                ...
                <select class="select-2 @error('shipmode') is-invalid @enderror" name="shipmode">
                    <option value=""></option>
                    <option value="ROUTING ORDER" @selected(old('shipmode', $ad1->shipmode) == 'ROUTING ORDER')>ROUTING ORDER</option>
                    <option value="FREE HANDS" @selected(old('shipmode', $ad1->shipmode) == 'FREE HANDS')>FREE HANDS</option>
                    <option value="TRANSIT" @selected(old('shipmode', $ad1->shipmode) == 'TRANSIT')>TRANSIT</option>
                </select>
                @error('shipmode')
                    <div class="invalid-feedback">
                        {{ $message }}
        ...
        <div class="col-md-3">
            <div class="form-group">
                ...
                <select class="currency-only @error('insure_curr_code') is-invalid @enderror"
                    ...
                    <option
                        value="{{ old('insure_curr_code', !empty($ad1->insure_curr_code) ? $ad1->insure_curr_code : 'IDR') }}">
                        {{ old('insure_curr_code', !empty($ad1->insure_curr_code) ? $ad1->insure_curr_code : 'IDR - INDONESIA RUPIAH') }}
                    </option>
                </select>
        ...
        <div class="col-md-3">
            <div class="form-group">
                ...
                <input type="text" class="form-control @error('insure_amt') is-invalid @enderror"
                    data-type='currency' name="insure_amt"
                    value="{{ old('insure_amt', !empty($ad1->insure_amt) ? number_format($ad1->insure_amt, 2, '.', ',') : '') }}">
                @error('insure_amt')
                    <div class="invalid-feedback">
                        {{ $message }}
                    </div>
        ...
        <div class="col-md-3">
            <div class="form-group">
                ...
                <input type="text" class="form-control @error('insure_local_amt') is-invalid @enderror"
                    data-type='currency' name="insure_local_amt"
                    value="{{ old('insure_local_amt', !empty($ad1->insure_local_amt) ? number_format($ad1->insure_local_amt, 2, '.', ',') : '') }}">
        ...
        <div class="col-md-4">
            <div class="form-group">
                ...
                <input type="text" class="form-control @error('handling_info_1') is-invalid @enderror"
                    name="handling_info_1" value="{{ old('handling_info_1', $ad1->handling_info_1) }}"
        ...
        <div class="col-md-4">
            <div class="form-group">
                ...
                <input type="text" class="form-control @error('handling_info_2') is-invalid @enderror"
                    name="handling_info_2" value="{{ old('handling_info_2', $ad1->handling_info_2) }}"
        ...
        <div class="col-md-4">
            <div class="form-group">
                ...
                <input type="text" class="form-control @error('handling_info_3') is-invalid @enderror"
                    name="handling_info_3" value="{{ old('handling_info_3', $ad1->handling_info_3) }}"
    ...
    <div class="row">
        <div class="col-md-4">
            <div class="form-group">
                ...
                <input type="text" class="form-control @error('account_info_1') is-invalid @enderror"
                    name="account_info_1" value="{{ old('account_info_1', $ad1->account_info_1) }}"
        ...
        <div class="col-md-4">
            <div class="form-group">
                ...
                <input type="text" class="form-control @error('account_info_2') is-invalid @enderror"
                    name="account_info_2" value="{{ old('account_info_2', $ad1->account_info_2) }}"
        ...
        <div class="col-md-4">
            <div class="form-group">
                ...
                <input type="text" class="form-control @error('account_info_3') is-invalid @enderror"
                    name="account_info_3" value="{{ old('account_info_3', $ad1->account_info_3) }}"
        ...
        <div class="col-md-4">
            <div class="form-group">
                ...
                <input type="text" class="form-control @error('account_info_4') is-invalid @enderror"
                    name="account_info_4" value="{{ old('account_info_4', $ad1->account_info_4) }}"
        ...
        <div class="col-md-4">
            <div class="form-group">
                ...
                <input type="text" class="form-control @error('account_info_5') is-invalid @enderror"
                    name="account_info_5" value="{{ old('account_info_5', $ad1->account_info_5) }}"
        ...
        <div class="col-md-4">
            <div class="form-group">
                ...
                <input type="text" class="form-control @error('account_info_6') is-invalid @enderror"
                    name="account_info_6" value="{{ old('account_info_6', $ad1->account_info_6) }}"
        ...
        <div class="col-md-4">
            <div class="form-group">
                ...
                <input type="text" class="form-control @error('account_info_7') is-invalid @enderror"
                    name="account_info_7" value="{{ old('account_info_7', $ad1->account_info_7) }}"
        ...
        <div class="col-md-4">
            <div class="form-group">
                ...
                <input type="text" class="form-control @error('permit_no') is-invalid @enderror" name="permit_no"
                    value="{{ old('permit_no', $ad1->permit_no) }}" placeholder="Permit No.">
                @error('permit_no')
                    <div class="invalid-feedback">
                        {{ $message }}
                    </div>
        ...
        <div class="col-md-4">
            <div class="form-group">
                ...
                <div class="col-md-6">
                    <input type="checkbox" name="dg_cargo" @checked(old('dg_cargo', $ad1->dg_cargo) == 'yes') value="yes"
        ...
        <div class="col-md-4">
            <div class="form-group">
                ...
                <select class="bill-party @error('coloader_code') is-invalid @enderror" name="coloader_code">
                    <option value="{{ old('coloader_code', $ad1->coloader_code) }}">
                        {{ old('coloader_code', $ad1->coloader_code) }}</option>
                </select>
                @error('coloader_code')
                    <div class="invalid-feedback">
                        {{ $message }}
        ...
        <div class="col-md-4">
            <div class="form-group">
                ...
                <select class="deltype-select @error('delivery_type_code') is-invalid @enderror"
                    ...
                    <option value="{{ old('delivery_type_code', $ad1->delivery_type_code) }}">
                        {{ old('delivery_type_code', $ad1->delivery_type_code) }}</option>
                </select>
        ...
        <div class="col-md-4">
            <div class="form-group">
                ...
                <input type="text" readonly class="form-control @error('delivery_type') is-invalid @enderror"
                    name="delivery_type" value="{{ old('delivery_type', $ad1->delivery_type) }}"
                    id="delivery_type">
                @error('delivery_type')
                    <div class="invalid-feedback">
                        {{ $message }}
