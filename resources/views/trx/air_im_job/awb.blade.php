<div class="row">
    <div class="col-md-6">
        ...
        <div class="form-group">
            ...
            <input type="text" class="form-control @error('mawb_no') is-invalid @enderror" placeholder="M AWB No"
                value="{{ old('mawb_no') }}" name="mawb_no" id="mawb_no">
            @error('mawb_no')
                <div class="invalid-feedback">
                    {{ $message }}
                </div>
        ...
        <div class="form-group">
            ...
            <input type="text" class="form-control @error('origin_awb_no') is-invalid @enderror"
                placeholder="Origin AWB No" value="{{ old('origin_awb_no') }}" name="origin_awb_no" id="origin_awb_no">
            @error('origin_awb_no')
                <div class="invalid-feedback">
                    {{ $message }}
                </div>
            ...
            <div class="col-md-6">
                <div class="form-group">
                    ...
                    <input type="text" class="form-control @error('customer_contact') is-invalid @enderror"
                        name="customer_contact" value="{{ old('customer_contact') }}" id="customer_contact">
            ...
            <div class="col-md-4">
                <div class="form-group">
                    ...
                    <input type="text" class="form-control @error('consignee_postal_code') is-invalid @enderror"
                        name="consignee_postal_code" value="{{ old('consignee_postal_code') }}"
            ...
            <div class="col-md-4">
                <div class="form-group">
                    ...
                    <input type="text" class="form-control @error('consignee_contact') is-invalid @enderror"
                        name="consignee_contact" value="{{ old('consignee_contact') }}" id="consignee_contact">
            ...
            <div class="col-md-4">
                <div class="form-group">
                    ...
                    <input type="text" class="form-control @error('consignee_telp') is-invalid @enderror"
                        name="consignee_telp" value="{{ old('consignee_telp') }}" id="consignee_telp">
    ...
    <div class="col-md-6">
                ...
                <div class="form-group">
                    ...
                    <select class="select-2 @error('job_type') is-invalid @enderror job-type" required
                        ...
                        @foreach ($job_type as $item)
                            <option value="{{ $item->type }}" @selected($item->type == 'AI')>{{ $item->type }}
                            </option>
                        @endforeach
                    </select>
                    @error('job_type')
        ...
        <div class="form-group">
            ...
            <div class="col-md-6">
                <input type="checkbox" name="transhipment" @checked(old('transhipment') == 'yes') value="yes"
        ...
        <div class="form-group">
            ...
            <select class="select-2 @error('shipmode') is-invalid @enderror" name="shipmode">
                <option value=""></option>
                <option value="ROUTING ORDER">ROUTING ORDER</option>
                <option value="FREE HANDS">FREE HANDS</option>
        ...
        <div class="row">
            <div class="col-md-4">
                <div class="form-group">
                    ...
                    <select class="warehouse_agent-select @error('warehouse_agent_code') is-invalid @enderror"
                        ...
                        <option value="{{ old('warehouse_agent_code') }}">{{ old('warehouse_agent_code') }}
                        </option>
                    </select>
            ...
            <div class="col-md-8">
                <div class="form-group">
                    ...
                    <input type="text" value="{{ old('warehouse_agent_name') }}"
        ...
        <div class="row">
            <div class="col-md-4">
                <div class="form-group">
                    ...
                    <select class="agent-select @error('appt_agent_code') is-invalid @enderror"
                        ...
                        <option value="{{ old('appt_agent_code') }}">{{ old('appt_agent_code') }}
                        </option>
                    </select>
            ...
            <div class="col-md-8">
                <div class="form-group">
                    ...
                    <input type="text" value="{{ old('appt_agent_name') }}" readonly
        ...
        <div class="row">
            <div class="col-md-6">
                <div class="form-group">
                    ...
                    <input type="text" value="{{ old('appt_contact') }}"
            ...
            <div class="col-md-6">
                <div class="form-group">
                    ...
                    <input type="text" value="{{ old('appt_telp') }}"
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="form-group">
                    ...
                    <input type="text" value="{{ old('remark_1') }}" placeholder="Footer 1"
            ...
            <div class="col-md-12">
                <div class="form-group">
                    ...
                    <input type="text" value="{{ old('remark_2') }}" placeholder="Footer 2"
            ...
            <div class="col-md-12">
                <div class="form-group">
                    ...
                    <input type="text" value="{{ old('remark_3') }}" placeholder="Footer 3"
            ...
            <div class="col-md-12">
                <div class="form-group">
                    ...
                    <input type="text" value="{{ old('remark_4') }}" placeholder="Footer 4"
