<div class="row">
    <div class="col-md-6">
        ...
        <div class="form-group">
            ...
            <input type="text" value="{{ old('pickup') }}" autocomplete="off" placeholder="Pickup Date/Time"
            ...
            <div class="col-md-8 mt-2">
                <div class="form-group">
                    <select class="collect-select @error('collect_code') is-invalid @enderror" name="collect_code">
                        <option value="{{ old('collect_code') }}">{{ old('collect_code') }}</option>
                    </select>
        ...
        <div class="row align-items-center">
            ...
            <div class="col-md-8 mt-2">
                <div class="form-group">
                    <input type="text" value="{{ old('collect_name') }}" placeholder="Collection Name"
        ...
        <div class="row align-items-center">
            ...
            <div class="col-md-8 mt-2">
                <div class="form-group">
                    <input type="text" value="{{ old('collect_address_1') }}" placeholder="Collection Address 1"
            ...
            <div class="col-md-8 mt-2">
                <div class="form-group">
                    <input type="text" value="{{ old('collect_address_2') }}" placeholder="Collection Address 2"
            ...
            <div class="col-md-8 mt-2">
                <div class="form-group">
                    <input type="text" value="{{ old('collect_address_3') }}" placeholder="Collection Address 3"
            ...
            <div class="col-md-8 mt-2">
                <div class="form-group">
                    <input type="text" value="{{ old('collect_address_4') }}" placeholder="Collection Address 4"
    ...
    <div class="col-md-6">
        <div class="form-group">
            ...
            <input type="text" value="{{ old('delivery') }}" autocomplete="off" placeholder="Delivery Date/Time"
        ...
        <div class="row">
            <div class="col-md-6">
                <div class="form-group">
                    ...
                    <input type="text" value="{{ old('delivery_ins_1') }}" placeholder="Delivery Instruction 1"
            ...
            <div class="col-md-6">
                <div class="form-group">
                    ...
                    <input type="text" value="{{ old('delivery_ins_2') }}" placeholder="Delivery Instruction 2"
            ...
            <div class="col-md-6">
                <div class="form-group">
                    ...
                    <input type="text" value="{{ old('delivery_ins_3') }}" placeholder="Delivery Instruction 3"
            ...
            <div class="col-md-6">
                <div class="form-group">
                    ...
                    <input type="text" value="{{ old('delivery_ins_4') }}" placeholder="Delivery Instruction 4"
            ...
            <div class="col-md-6">
                <div class="form-group">
                    ...
                    <input type="text" value="{{ old('delivery_ins_5') }}" placeholder="Delivery Instruction 5"
            ...
            <div class="col-md-6">
                <div class="form-group">
                    ...
                    <input type="text" value="{{ old('delivery_ins_6') }}" placeholder="Delivery Instruction 6"
