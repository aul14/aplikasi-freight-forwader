        ...
        <div class="col-12">
            ...
            <div class="card">
                <div class="card-header pb-0">
                    <h6>Form Edit Air Import Job</h6>
                </div>
                <form action="{{ route('air_im_job.update', $aj->id) }}" method="post">
                    @csrf
                    @method('PUT')
                    <div class="card-body">
                        <div class="row">
                            <div class="col-md-12">
                                <div class="tabset">
                                    ...
                                    <!-- Tab 3 -->
                                    <input type="radio" name="tabset" id="tab3" aria-controls="d_i">
                                    <label for="tab3">Delivery Info</label>
                                    <!-- Tab 4 -->
                                    <input type="radio" name="tabset" id="tab4" aria-controls="j_c">
                                    <label for="tab4">Job Costing</label>

                                    <div class="tab-panels col-md-12">
                                        <section id="awb" class="tab-panel">
                                            @include('trx.air_im_job.awb_edit', ['jm' => $aj->jm])
                                        </section>

                                        <section id="s_i" class="tab-panel">
                                            @include('trx.air_im_job.si_edit', ['ad1' => $aj->ad1])
                                        </section>

                                        <section id="d_i" class="tab-panel">
                                            @include('trx.air_im_job.di_edit', ['ad2' => $aj->ad2])
                                        </section>

                                        <section id="j_c" class="tab-panel">
                                            @include('trx.air_im_job.jc_edit', ['ad3' => $aj->ad3])
                                        </section>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <a href="{{ route('air_im_job.index') }}" class="btn btn-danger btn-back">Back</a>
