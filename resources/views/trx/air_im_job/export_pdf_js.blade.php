...
<body>
    ...
    <div class="page_break">
        <h6 style="text-align: center;">PROFIT & LOSS AIR IMPORT</h6>
        ...
        <div class="row">
            <table class="no-table">
                ...
                <tr>
                    <td>JOB DATE</td>
                    <td style="text-align: center;">:</td>
                    <td>{{ !empty($aj->jm->job_date) ? date('d/M/Y', strtotime($aj->jm->job_date)) : '' }}</td>
                ...
                <tr>
                    ...
                    <td>ARRIVAL DATE</td>
                    <td style="text-align: center;">:</td>
                    <td>{{ !empty($aj->ad1->arrival_date_time) ? date('d/M/Y', strtotime($aj->ad1->arrival_date_time)) : '' }}
                    </td>
                </tr>
                <tr>
                    <td>FREIGHT</td>
                    <td style="text-align: center;">:</td>
                    <td>{{ $aj->ad1->weight_val_flag }}</td>

                    <td>WEIGHT</td>
                    <td style="text-align: center;">:</td>
                    <td>{{ number_format($aj->ad1->gross_weight, 2, '.', ',') }} KGS</td>
                </tr>
                <tr>
                    ...
                    <td>VOLUME</td>
                    <td style="text-align: center;">:</td>
                    <td>{{ number_format($aj->ad1->volume_weight, 2, '.', ',') }} M3</td>
                </tr>
                <tr>
            ...
            <table class="pdf-table">
                ...
                <tbody>
                    <tr>
                        <td style="text-align: center;">&nbsp;<br><br><br><br> {{ $aj->create_by }}</td>
                        <td>&nbsp;<br><br><br><br></td>
                        <td>&nbsp;<br><br><br><br></td>
                        <td>&nbsp;<br><br><br><br></td>
                        <td>&nbsp;<br><br><br><br></td>
