                ...
                <div class="col-md-4">
                    <div class="form-group">
                        ...
                        <select class="airdept-select @error('air_dept_code') is-invalid @enderror" id="airdept-select-1"
                            ...
                            <option value="{{ old('air_dept_code') }}">
                                {{ old('air_dept_code') }}
                            </option>
                        </select>
                        @error('air_dept_code')
                ...
                <div class="col-md-8">
                    <div class="form-group">
                        ...
                        <input type="text"
                            ...
                            name="air_dept_name" value="{{ old('air_dept_name') }}" id="airdept-name-1">
                    </div>
                </div>
            </div>
        </div>
                ...
                <div class="col-md-4">
                    <div class="form-group">
                        ...
                        <select class="airdest-select @error('air_dest_code') is-invalid @enderror"
                            ...
                            <option value="{{ old('air_dest_code', 'JKT') }}">
                                {{ old('air_dest_code', 'JKT') }}
                            </option>
                        </select>
                        @error('air_dest_code')
                            <div class="invalid-feedback">
                ...
                <div class="col-md-8">
                    <div class="form-group">
                        ...
                        <input type="text"
                            ...
                            name="air_dest_name" value="{{ old('air_dest_name', 'JAKARTA SOEKARNO HATTA') }}"
                            id="airdest-name-1">
                        @error('air_dest_name')
                            <div class="invalid-feedback">
                                {{ $message }}
        ...
        <div class="row">
            ...
            <div class="col-md-4">
                <div class="form-group">
                    ...
                    <input type="text" value="{{ old('flight_date_1') }}" autocomplete="off"
                ...
                <div class="row" style="overflow:auto;">
                    <div class="d-flex flex-row">
                        ...
                        <div class="p-2" style="width: 23%">
                            <input type="text" value="{{ old('etd_1') }}" autocomplete="off"
                                placeholder="Etd Date 1"
                        ...
                        <div class="p-2" style="width: 23%">
                            <input type="text" value="{{ old('eta_1') }}" autocomplete="off"
                                placeholder="Eta Date 1"
            ...
            <div class="col-md-10 mt-2">
                <div class="row" style="overflow:auto;">
                    <div class="d-flex flex-row">
                        ...
                        <div class="p-1 my-2">On</div>
                        <div class="p-2" style="width: 23%">
                            <input type="text" value="{{ old('etd_2') }}" autocomplete="off"
                                placeholder="Etd Date 2"
                        ...
                        <div class="p-2" style="width: 23%">
                            <input type="text" value="{{ old('eta_2') }}" autocomplete="off"
                                placeholder="Eta Date 2"
            ...
            <div class="col-md-10 mt-2">
                <div class="row" style="overflow:auto;">
                    <div class="d-flex flex-row">
                        ...
                        <div class="p-1 my-2">On</div>
                        <div class="p-2" style="width: 23%">
                            <input type="text" value="{{ old('etd_3') }}" autocomplete="off"
                                placeholder="Etd Date 3"
                        ...
                        <div class="p-2" style="width: 23%">
                            <input type="text" value="{{ old('eta_3') }}" autocomplete="off"
                                placeholder="Eta Date 3"
        ...
        <div class="col-md-4">
            <div class="form-group">
                ...
                <select class="commodity-code @error('commodity_code') is-invalid @enderror" name="commodity_code">
                    <option value="{{ old('commodity_code') }}">
                        {{ old('commodity_code') }}
                    </option>
                </select>
        ...
        <div class="col-md-3">
            <div class="form-group">
                ...
                <select class="bill-party @error('bill_party_code_1') is-invalid @enderror" name="bill_party_code_1">
                    <option value="{{ old('bill_party_code_1') }}">{{ old('bill_party_code_1') }}</option>
                </select>
        ...
        <div class="col-md-3">
            <div class="form-group">
                ...
                <select class="bill-party @error('bill_party_code_2') is-invalid @enderror" name="bill_party_code_2">
                    <option value="{{ old('bill_party_code_2') }}">{{ old('bill_party_code_2') }}</option>
                </select>
    ...
    <div class="row">
        <div class="col-md-3">
            <div class="form-group">
                ...
                <input type="number" value="{{ old('pcs') }}" autocomplete="off"
        ...
        <div class="col-md-3">
            <div class="form-group">
                ...
                <input type="text" data-type='currency' value="{{ old('gross_weight') }}" autocomplete="off"
        ...
        <div class="col-md-3">
            <div class="form-group">
                ...
                <input type="text" data-type='currency' value="{{ old('volume_weight') }}" autocomplete="off"
                    class="form-control @error('volume_weight') is-invalid @enderror" name="volume_weight"
                    id="volume_weight">
                @error('volume_weight')
                    <div class="invalid-feedback">
                        {{ $message }}
    ...
    <div class="row">
        ...
        <div class="col-md-2">
            <div class="form-group">
                ...
                <input type="text" data-type='currency' value="{{ old('charge_weight') }}" autocomplete="off"
                    class="form-control @error('charge_weight') is-invalid @enderror" name="charge_weight"
                    id="charge_weight">
                @error('charge_weight')
                    <div class="invalid-feedback">
                        {{ $message }}
        ...
        <div class="col-md-3">
            <div class="form-group">
                ...
                <input type="text" placeholder="Iata Rate" data-type='currency' value="{{ old('iata_rate') }}"
        ...
        <div class="col-md-3">
            <div class="form-group">
                ...
                <input type="text" readonly placeholder="Iata Total Amt" data-type='currency'
                    value="{{ old('iata_total_amt') }}" autocomplete="off"
                    class="form-control @error('iata_total_amt') is-invalid @enderror" name="iata_total_amt"
                    id="iata_total_amt">
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <input type="text" placeholder="Weight Charge Prepaid Amt" data-type='currency'
                            value="{{ old('weight_charge_pp') }}" autocomplete="off"
                            class="form-control @error('weight_charge_pp') is-invalid @enderror"
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <input type="text" placeholder="Value Charge Prepaid Amt" data-type='currency'
                            value="{{ old('value_charge_pp') }}" autocomplete="off"
                            class="form-control @error('value_charge_pp') is-invalid @enderror"
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <input type="text" placeholder="Tax Prepaid Amt" data-type='currency'
                            value="{{ old('tax_pp') }}" autocomplete="off"
                            class="form-control @error('tax_pp') is-invalid @enderror" name="tax_pp"
                            id="tax_pp">
                        @error('tax_pp')
                            <div class="invalid-feedback">
                                {{ $message }}
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <input type="text" placeholder="Due Agent Prepaid Amt" data-type='currency'
                            value="{{ old('agent_pp') }}" autocomplete="off"
                            class="form-control @error('agent_pp') is-invalid @enderror" name="agent_pp"
                            id="agent_pp">
                        @error('agent_pp')
                            <div class="invalid-feedback">
                                {{ $message }}
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <input type="text" placeholder="Due Carrier Prepaid Amt" data-type='currency'
                            value="{{ old('carrier_pp') }}" autocomplete="off"
                            class="form-control @error('carrier_pp') is-invalid @enderror" name="carrier_pp"
                            id="carrier_pp">
                        @error('carrier_pp')
                            <div class="invalid-feedback">
                                {{ $message }}
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <input type="text" readonly placeholder="Total Prepaid Amt" data-type='currency'
                            value="{{ old('total_pp') }}" autocomplete="off"
                            class="form-control @error('total_pp') is-invalid @enderror" name="total_pp"
                            id="total_pp">
                        @error('total_pp')
                            <div class="invalid-feedback">
                                {{ $message }}
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <input type="text" placeholder="Weight Charge Collect Amt" data-type='currency'
                            value="{{ old('weight_charge_cc') }}" autocomplete="off"
                            class="form-control @error('weight_charge_cc') is-invalid @enderror"
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <input type="text" placeholder="Value Charge Collect Amt" data-type='currency'
                            value="{{ old('value_charge_cc') }}" autocomplete="off"
                            class="form-control @error('value_charge_cc') is-invalid @enderror"
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <input type="text" placeholder="Tax Collect Amt" data-type='currency'
                            value="{{ old('tax_cc') }}" autocomplete="off"
                            class="form-control @error('tax_cc') is-invalid @enderror" name="tax_cc"
                            id="tax_cc">
                        @error('tax_cc')
                            <div class="invalid-feedback">
                                {{ $message }}
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <input type="text" placeholder="Due Agent Collect Amt" data-type='currency'
                            value="{{ old('agent_cc') }}" autocomplete="off"
                            class="form-control @error('agent_cc') is-invalid @enderror" name="agent_cc"
                            id="agent_cc">
                        @error('agent_cc')
                            <div class="invalid-feedback">
                                {{ $message }}
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <input type="text" placeholder="Due Carrier Collect Amt" data-type='currency'
                            value="{{ old('carrier_cc') }}" autocomplete="off"
                            class="form-control @error('carrier_cc') is-invalid @enderror" name="carrier_cc"
                            id="carrier_cc">
                        @error('carrier_cc')
                            <div class="invalid-feedback">
                                {{ $message }}
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <input type="text" readonly placeholder="Total Collect Amt" data-type='currency'
                            value="{{ old('total_cc') }}" autocomplete="off"
                            class="form-control @error('total_cc') is-invalid @enderror" name="total_cc"
                            id="total_cc">
                        @error('total_cc')
                            <div class="invalid-feedback">
                                {{ $message }}
    ...
    <div class="row">
        <div class="col-md-8">
            <div class="form-group">
                ...
                <input type="text" placeholder="Permit No" value="{{ old('permit_no') }}" autocomplete="off"
        ...
        <div class="col-md-4">
            <div class="form-group">
                ...
                <input type="text" placeholder="Permit Date" value="{{ old('permit') }}" autocomplete="off"
                    class="form-control @error('permit') is-invalid @enderror date-picker" name="permit"
                    id="permit">
                @error('permit')
                    <div class="invalid-feedback">
                        {{ $message }}
                        ...
                        <div class="row">
                            <div class="col-md-3">
                                <select class="collect-curr @error('collect_curr') is-invalid @enderror"
                                    name="collect_curr">
                                    <option value="{{ old('collect_curr', 'IDR') }}">
                                        {{ old('collect_curr', 'IDR') }}
                                    </option>
                                </select>
                                @error('collect_curr')
                                    <div class="invalid-feedback">
                            ...
                            <div class="col-md-5">
                                <input type="text" placeholder="Currency Rate" data-type='currency'
                                    value="{{ old('curr_rate', '1.00') }}" autocomplete="off"
                                    class="form-control @error('curr_rate') is-invalid @enderror" name="curr_rate"
                                    id="curr_rate">
                                @error('curr_rate')
                                    <div class="invalid-feedback">
                                        {{ $message }}
                        ...
                        <div class="row">
                            <div class="col-md-3">
                                <input type="text" placeholder="Factor" data-type='currency'
                                    value="{{ old('curr_markup_rate', '0') }}" autocomplete="off"
                            ...
                            <div class="col-md-5">
                                <input type="text" placeholder="Final Rate" data-type='currency'
                                    value="{{ old('final_rate', '1.00') }}" autocomplete="off" readonly
                ...
                <div class="col-md-8">
                    <div class="form-group">
                        ...
                        <input type="text" placeholder="Final Amount" data-type='currency'
                            value="{{ old('final_amt') }}" autocomplete="off"
                            class="form-control @error('final_amt') is-invalid @enderror" name="final_amt"
                            id="final_amt">
                        @error('final_amt')
                            <div class="invalid-feedback">
                                {{ $message }}
                ...
                <div class="col-md-8">
                    <div class="form-group">
                        ...
                        <input type="text" placeholder="Total Local Amount" data-type='currency'
                            value="{{ old('local_amt') }}" autocomplete="off" readonly
                            class="form-control @error('local_amt') is-invalid @enderror" name="local_amt"
                            id="local_amt">
                        @error('local_amt')
                            <div class="invalid-feedback">
                                {{ $message }}
                ...
                <div class="col-md-8">
                    <div class="form-group">
                        ...
                        <input type="text" placeholder="Collect Fee Percent" data-type='currency'
                            value="{{ old('cc_fee_percent') }}" autocomplete="off"
                            class="form-control @error('cc_fee_percent') is-invalid @enderror" name="cc_fee_percent"
                            id="cc_fee_percent">
