<div class="row">
    <div class="col-md-6">
        <div class="form-group">
            ...
            <input type="text" value="NEW" class="form-control @error('air_quot_no') is-invalid @enderror" readonly
                name="air_quot_no" id="air_quot_no">
            @error('air_quot_no')
        ...
        <div class="row mt-2">
            ...
            <div class="col-md-8">
                <div class="form-group">
                    ...
                    <input type="text" value="{{ old('customer') }}" readonly class="form-control" name="customer"
                        id="customer">
                </div>
            </div>
        </div>
            ...
            <div class="col-md-4">
                <div class="form-group">
                    ...
                    <select class="commodity-select @error('commodity_code_name') is-invalid @enderror"
                        ...
                        <option value="{{ old('commodity_code_name') }}">{{ old('commodity_code_name') }}</option>
                    </select>
        ...
        <div class="row" style="overflow:auto;">
            <div class="d-flex flex-row">
                ...
                <div class="p-2" style="width: 20%">
                    <input type="text" class="form-control" readonly value="{{ old('uom_name') }}"
                        name="uom_name" id="uom_name">
                </div>
