...
@if (count($aq_d1) > 0)
    ...
    @foreach ($aq_d1 as $key => $item)
        ...
        <div id="wrapper-row-list-fch-{{ $key + 1 }}" class="wrapper-row-list-fch ">
            <div class="row row-list-fch">
                ...
                <div class="col-md-5">
                    <div class="row">
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <select class="airdept-select" id="airdept-select-{{ $key + 1 }}"
                                    name="air_dept_code[]">
                                    <option value="{{ $item->air_dept_code }}">{{ $item->air_dept_code }}</option>
                                </select>
                            </div>
                        </div>
                        <div class="col-md-8">
                            <div class="form-group">
                                ...
                                <input type="text" readonly value="{{ $item->air_dept_name }}"
                                    class="form-control airdept-name" name="air_dept_name[]"
                                    id="airdept-name-{{ $key + 1 }}">
                            </div>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <select class="airdest-select" id="airdest-select-{{ $key + 1 }}"
                                    name="air_dest_code[]">
                                    <option value="{{ $item->air_dest_code }}">{{ $item->air_dest_code }}</option>
                                </select>
                            </div>
                        </div>
                        <div class="col-md-8">
                            <div class="form-group">
                                ...
                                <input type="text" readonly value="{{ $item->air_dest_name }}"
                                    class="form-control airdest-name" name="air_dest_name[]"
                                    id="airdest-name-{{ $key + 1 }}">
                            </div>
                        </div>
                    </div>
                    <div class="form-group">
                        <label for="origin_code">Service Level </label>
                        <input type="text" class="form-control service-level" value="{{ $item->service_level }}"
                            id="service-level-{{ $key + 1 }}" name="service_level">
                    </div>
                    ...
                    <div class="row">
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <select class="airline-select" id="airline-select-{{ $key + 1 }}"
                                    name="airline_id[]">
                                    <option value="{{ $item->airline_id }}">{{ $item->airline_id }}</option>
                                </select>
                            </div>
                        </div>
                        <div class="col-md-8">
                            <div class="form-group">
                                ...
                                <input type="text" maxlength="6" data-type='currency0'
                                    value="{{ $item->flight_no }}" class="form-control" name="flight_no[]"
                                    id="flight_no">
                            </div>
                        </div>
                    </div>
                    <div class="form-group">
                        ...
                        <input type="text" maxlength="5" value="{{ $item->transit_time }}" data-type='currency0'
                            class="form-control" name="transit_time[]" id="transit_time">
                ...
                <div class="col-md-5">
                    <div class="row">
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <select class="salesitem-select" id="salesitem-select-{{ $key + 1 }}"
                                    name="sales_item_code[]">
                                    <option value="{{ $item->sales_item_code }}">{{ $item->sales_item_code }}</option>
                                </select>
                            </div>
                        </div>
                        <div class="col-md-8">
                            <div class="form-group">
                                ...
                                <input type="text" value="{{ $item->sales_item_name }}"
                                    class="form-control salesitem-name" name="sales_item_name[]"
                                    id="salesitem-name-{{ $key + 1 }}">
                            </div>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-md-8">
                            <div class="form-group">
                                ...
                                <select class="currencyd1-select" id="currencyd1-select-{{ $key + 1 }}"
                                    name="currency_d1[]">
                                    <option value="{{ $item->currency_d1 }}">{{ $item->currency_d1 }}</option>
                                </select>
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <select class="weight-select form-control" id="weight-select-{{ $key + 1 }}"
                                    name="weight_type[]">
                                    <option value=""></option>
                                    <option value="K" @selected($item->weight_type == 'K')>K</option>
                                    <option value="L" @selected($item->weight_type == 'L')>L</option>
                                </select>
                            </div>
                        </div>
                    </div>
                    <div class="form-group">
                        ...
                        <input type="text" value="{{ $item->frequency }}" class="form-control"
                            name="frequency[]" id="frequency">
                    </div>
                    <div class="form-group">
                        <label for="note">Note </label>
                        <input type="text" value="{{ $item->note }}" class="form-control" name="note[]"
                            id="note">
                    </div>
            ...
            {{-- @include('trx.air_quot.fchsub1_edit', [
                'item_s_d1' => $item->air_quotation_s_d1,
            ]) --}}
            @include('trx.air_quot.fchsub_edit', [
                'item_s_d2' => $item->air_quotation_s_d2,
                'count_s_d2' => 99,
            ])
            <div class="row">
    ...
    <div id="wrapper-row-list-fch-1" class="wrapper-row-list-fch ">
        <div class="row row-list-fch">
            ...
            <div class="col-md-5">
                ...
                <div class="form-group">
                    <label for="origin_code">Service Level </label>
                    <input type="text" class="form-control service-level" id="service-level-1"
                        name="service_level">
                </div>
