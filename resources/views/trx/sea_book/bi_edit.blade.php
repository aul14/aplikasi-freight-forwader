<div class="row">
    <div class="col-md-7">
        <div class="form-group">
            ...
            <input type="text" value="{{ $sb->code }}" class="form-control @error('code') is-invalid @enderror"
                readonly name="code" id="code">
            @error('code')
        ...
        <div class="row">
            <div class="col-md-6">
                <div class="form-group">
                    ...
                    <select class="select-2 @error('cargo_type') is-invalid @enderror cargo-type" required
                        name="cargo_type">
                        <option value="FCL" @selected(old('cargo_type', $sb->cargo_type) == 'FCL')>FCL</option>
                        <option value="LCL" @selected(old('cargo_type', $sb->cargo_type) == 'LCL')>LCL</option>
                    </select>
                    @error('cargo_type')
                        <div class="invalid-feedback">
                            {{ $message }}
            ...
            <div class="col-md-6">
                <div class="form-group">
                    ...
                    <input type="text"
                        value="{{ old('booking_date', empty($sb->booking_date) ? '' : date('Y/m/d H:i', strtotime($sb->booking_date))) }}"
                        autocomplete="off"
        ...
        <div class="show-fcl mt-1">
                ...
                <div class="col-md-10 ">
                    <div class="d-flex flex-row" style="overflow:auto;">
                        <div class="p-2" style="width: 50%">
                            <input type="text" value="{{ old('jml_container_type_1', $sb->jml_container_type_1) }}"
                        ...
                        <div class="p-2" style="width: 50%">
                            <select name="container_type_1"
                                ...
                                <option value="{{ old('container_type_1', $sb->container_type_1) }}">
                                    {{ old('container_type_1', $sb->container_type_1) }}</option>
                            </select>
            ...
            <div class="row align-items-center">
                ...
                <div class="col-md-10 ">
                    <div class="d-flex flex-row" style="overflow:auto;">
                        <div class="p-2" style="width: 50%">
                            <input type="text" value="{{ old('jml_container_type_2', $sb->jml_container_type_2) }}"
                        ...
                        <div class="p-2" style="width: 50%">
                            <select name="container_type_2"
                                ...
                                <option value="{{ old('container_type_2', $sb->container_type_2) }}">
                                    {{ old('container_type_2', $sb->container_type_2) }}
                                </option>
                            </select>
            ...
            <div class="row align-items-center">
                ...
                <div class="col-md-10 ">
                    <div class="d-flex flex-row" style="overflow:auto;">
                        <div class="p-2" style="width: 50%">
                            <input type="text" value="{{ old('jml_container_type_3', $sb->jml_container_type_3) }}"
                        ...
                        <div class="p-2" style="width: 50%">
                            <select name="container_type_3"
                                ...
                                <option value="{{ old('container_type_3', $sb->container_type_3) }}">
                                    {{ old('container_type_3', $sb->container_type_3) }}
                                </option>
                            </select>
            ...
            <div class="row align-items-center">
                ...
                <div class="col-md-10 ">
                    <div class="d-flex flex-row" style="overflow:auto;">
                        <div class="p-2" style="width: 50%">
                            <input type="text"
                                value="{{ old('jml_container_type_4', $sb->jml_container_type_4) }}"
                        ...
                        <div class="p-2" style="width: 50%">
                            <select name="container_type_4"
                                ...
                                <option value="{{ old('container_type_4', $sb->container_type_4) }}">
                                    {{ old('container_type_4', $sb->container_type_4) }}
                                </option>
                            </select>
            ...
            <div class="col-md-9">
                <div class="form-group">
                    ...
                    <input type="text" class="form-control @error('quotation_no') is-invalid @enderror"
                        name="quotation_no" value="{{ old('quotation_no', $sb->quotation_no) }}" id="quotation_no">
                    @error('quotation_no')
                        <div class="invalid-feedback">
                            {{ $message }}
                        </div>
            ...
            <div class="col-md-5">
                <div class="form-group">
                    ...
                    <input type="text" class="form-control @error('customer') is-invalid @enderror"
                        name="customer" value="{{ old('customer', $sb->customer) }}" id="customer">
                    @error('customer')
                        <div class="invalid-feedback">
                            {{ $message }}
                        </div>
        ...
        <div class="form-group">
            ...
            <input type="text" class="form-control @error('contact_name') is-invalid @enderror"
                name="contact_name" value="{{ old('contact_name', $sb->contact_name) }}" id="contact_name">
            @error('contact_name')
                <div class="invalid-feedback">
                    {{ $message }}
                </div>
        ...
        <div class="form-group">
            ...
            <input type="text" class="form-control @error('reference_no') is-invalid @enderror"
                name="reference_no" value="{{ old('reference_no', $sb->reference_no) }}" id="reference_no">
            @error('reference_no')
                <div class="invalid-feedback">
                    {{ $message }}
                </div>
        ...
        <div class="form-group">
            ...
            <input type="text" value="{{ old('telp', $sb->telp) }}"
        ...
        <div class="form-group">
            ...
            <input type="text" value="{{ old('fax', $sb->fax) }}"
        ...
        <div class="form-group">
            ...
            <input type="email" value="{{ old('email', $sb->email) }}"
            ...
            <div class="col-md-4">
                <div class="form-group">
                    ...
                    <select class="deltype-select @error('delivery_type_code') is-invalid @enderror"
                        ...
                        <option value="{{ old('delivery_type_code', $sb->delivery_type_code) }}">
                            {{ old('delivery_type_code', $sb->delivery_type_code) }}</option>
                    </select>
            ...
            <div class="col-md-8">
                <div class="form-group">
                    ...
                    <input type="text" readonly class="form-control @error('delivery_type') is-invalid @enderror"
                        name="delivery_type" value="{{ old('delivery_type', $sb->delivery_type) }}"
                        id="delivery_type">
                    @error('delivery_type')
                        <div class="invalid-feedback">
                            {{ $message }}
        ...
        <div class="row">
            <div class="col-md-4">
                <div class="form-group">
                    ...
                    <select class="commodity-select @error('commodity_code') is-invalid @enderror"
                        name="commodity_code">
                        <option value="{{ old('commodity_code', $sb->commodity_code) }}">
                            {{ old('commodity_code', $sb->commodity_code) }}
                        </option>
                    </select>
            ...
            <div class="col-md-8">
                <div class="form-group">
                    ...
                    <input type="text" value="{{ old('commodity', $sb->commodity) }}" readonly
    ...
    <div class="col-md-5">
            ...
            <div class="col-md-9">
                <div class="form-group">
                    ...
                    <input type="text" class="form-control @error('job_no') is-invalid @enderror" readonly
                        name="job_no" value="{{ old('job_no', $sb->job_no) }}" id="job_no">
                    @error('job_no')
                        <div class="invalid-feedback">
                            {{ $message }}
                        </div>
                ...
                <div class="form-group">
                    ...
                    <select class="select-2 @error('job_type') is-invalid @enderror job-type" required
                        ...
                        @foreach ($job_type as $item)
                            <option value="{{ $item->type }}" @selected($item->type == $sb->job_type)>{{ $item->type }}
                            </option>
                        @endforeach
                    </select>
                    @error('job_type')
        ...
        <div class="form-group">
            ...
            <input type="text" value="{{ old('job_date', date('Y/m/d', strtotime($sb->job_date))) }}"
        ...
        <div class="form-group">
            ...
            <input type="text" class="form-control @error('import_job_no') is-invalid @enderror"
                name="import_job_no" value="{{ old('import_job_no', $sb->import_job_no) }}" id="import_job_no">
            @error('import_job_no')
                <div class="invalid-feedback">
                    {{ $message }}
                </div>
        ...
        <div class="form-group">
            ...
            <input type="text" class="form-control @error('bl_no') is-invalid @enderror" name="bl_no"
                value="{{ old('bl_no', $sb->bl_no) }}" id="bl_no">
            @error('bl_no')
                <div class="invalid-feedback">
                    {{ $message }}
                </div>
        ...
        <div class="form-group">
            ...
            <div class="col-md-6">
                <input type="checkbox" name="dg_cargo" @checked(old('dg_cargo', $sb->dg_cargo) == 'yes') value="yes"
        ...
        <div class="form-group">
            ...
            <div class="col-md-6">
                <input type="checkbox" name="nomination_cargo" @checked(old('nomination_cargo', $sb->nomination_cargo) == 'yes') value="yes"
                    data-toggle="toggle" data-on="Yes" data-off="No" data-onstyle="primary"
                    data-offstyle="danger">
        ...
        <div class="form-group">
            ...
            <div class="col-md-6">
                <input type="checkbox" name="railing" @checked(old('railing', $sb->railing) == 'yes') value="yes"
                    data-toggle="toggle" data-on="Yes" data-off="No" data-onstyle="primary"
                    data-offstyle="danger">
                @error('railing')
                    <div class="invalid-feedback">
        ...
        <div class="form-group">
            ...
            <div class="col-md-6">
                <input type="checkbox" name="refeer_container" @checked(old('refeer_container', $sb->refeer_container) == 'yes') value="yes"
                    data-toggle="toggle" data-on="Yes" data-off="No" data-onstyle="primary"
                    data-offstyle="danger">
        ...
        <div class="row">
            <div class="col-md-6">
                <div class="form-group">
                    ...
                    <input type="text"
                        value="{{ old('etd', !empty($sb->etd) ? date('d/m/Y', strtotime($sb->etd)) : '') }}" required
                        autocomplete="off" class="form-control @error('etd') is-invalid @enderror date-picker"
                        name="etd" id="etd">
                    @error('etd')
                        <div class="invalid-feedback">
                            {{ $message }}
            ...
            <div class="col-md-6">
                <div class="form-group">
                    ...
                    <input type="text"
                        value="{{ old('dest_eta', !empty($sb->dest_eta) ? date('d/m/Y', strtotime($sb->dest_eta)) : '') }}"
        ...
        <div class="form-group">
            ...
            <input type="text" value="{{ old('cargo_class', $sb->cargo_class) }}"
        ...
        <div class="row">
            <div class="col-md-4">
                <div class="form-group">
                    ...
                    <select class="salesman-select @error('salesman_code') is-invalid @enderror"
                        name="salesman_code">
                        <option value="{{ old('salesman_code', $sb->salesman_code) }}">
                            {{ old('salesman_code', $sb->salesman_code) }}
                        </option>
                    </select>
            ...
            <div class="col-md-8">
                <div class="form-group">
                    ...
                    <input type="text" value="{{ old('salesman', $sb->salesman) }}" readonly
            ...
            <div class="col-md-4">
                <div class="form-group">
                    ...
                    <select class="origin-select @error('origin_code') is-invalid @enderror" id="origin-select-1"
                        name="origin_code">
                        <option value="{{ old('origin_code', !empty($sb->origin_code) ? $sb->origin_code : 'JKT') }}">
                            {{ old('origin_code', !empty($sb->origin_code) ? $sb->origin_code : 'JKT') }}
                        </option>
                    </select>
                    @error('origin_code')
                        <div class="invalid-feedback">
            ...
            <div class="col-md-8">
                <div class="form-group">
                    ...
                    <input type="text" readonly
                        value="{{ old('origin_name', !empty($sb->origin_name) ? $sb->origin_name : 'JAKARTA') }}"
        ...
        <div class="row">
            <div class="col-md-4">
                <div class="form-group">
                    ...
                    <select class="dest-select @error('dest_code') is-invalid @enderror" required id="dest-select-1"
                        name="dest_code">
                        <option value="{{ old('dest_code', $sb->dest_code) }}">{{ old('dest_code', $sb->dest_code) }}
                        </option>
                    </select>
                    @error('dest_code')
                        <div class="invalid-feedback">
            ...
            <div class="col-md-8">
                <div class="form-group">
                    ...
                    <input type="text" readonly value="{{ old('dest_name', $sb->dest_name) }}"
        ...
        <div class="row">
            <div class="col-md-4">
                <div class="form-group">
                    ...
                    <input type="text" readonly name="country_code" id="country_code"
                        value="{{ old('country_code', $sb->country_code) }}"
            ...
            <div class="col-md-8">
                <div class="form-group">
                    ...
                    <input type="text" readonly value="{{ old('country_name', $sb->country_name) }}"
        ...
        <div class="row" style="overflow:auto;">
            <div class="d-flex flex-row">
                ...
                <div class="p-2" style="width: 15%">
                    <input type="text" value="{{ old('total_pcs', $sb->total_pcs) }}" title="Total Pcs"
                ...
                <div class="p-2" style="width: 12%">
                    <select name="uom_code" class="uom-select @error('uom_code') is-invalid @enderror">
                        <option value="{{ old('uom_code', $sb->uom_code) }}">{{ old('uom_code', $sb->uom_code) }}
                        </option>
                    </select>
                    @error('uom_code')
                        <div class="invalid-feedback">
                ...
                <div class="p-2" style="width: 20%">
                    <input type="text" class="form-control @error('uom') is-invalid @enderror" readonly
                        name="uom" value="{{ old('uom', $sb->uom) }}" id="uom">
                    @error('uom')
                        <div class="invalid-feedback">
                            {{ $message }}
                        </div>
                ...
                <div class="p-2" style="width: 20%">
                    <input type="text" data-type='currency4' autocomplete="off" title="Total Gross Weight"
                        ...
                        value="{{ old('total_gross', number_format($sb->total_gross, 4, '.', ',')) }}"
                ...
                <div class="p-2" style="width: 20%">
                    <input type="text" data-type='currency4' autocomplete="off" title="Total Volume"
                        value="{{ old('total_volume', number_format($sb->total_volume, 4, '.', ',')) }}"
        ...
        <div class="row">
            <div class="col-md-4">
                <div class="form-group">
                    ...
                    <input type="text" value="{{ old('footer_1', $sb->footer_1) }}"
            ...
            <div class="col-md-4">
                <div class="form-group">
                    ...
                    <input type="text" value="{{ old('footer_2', $sb->footer_2) }}"
            ...
            <div class="col-md-4">
                <div class="form-group">
                    ...
                    <input type="text" value="{{ old('footer_3', $sb->footer_3) }}"
        ...
        <div class="row">
            <div class="col-md-4">
                <div class="form-group">
                    ...
                    <input type="text" value="{{ old('footer_4', $sb->footer_4) }}"
            ...
            <div class="col-md-4">
                <div class="form-group">
                    ...
                    <input type="text" value="{{ old('footer_5', $sb->footer_5) }}"
            ...
            <div class="col-md-4">
                <div class="form-group">
                    ...
                    <input type="text" value="{{ old('footer_6', $sb->footer_6) }}"
