<div class="row">
    <div class="col-md-12">
        ...
        <div class="row align-items-center">
            ...
            <div class="col-md-7 mt-2">
                <div class="form-group">
                    <input type="text" value="{{ old('shipper_name') }}" placeholder="Shipper Name"
        ...
        <div class="row align-items-center">
            ...
            <div class="col-md-7 mt-2">
                <div class="form-group">
                    <input type="text" value="{{ old('shipper_address_1') }}" placeholder="Shipper Address 1"
            ...
            <div class="col-md-7 mt-2">
                <div class="form-group">
                    <input type="text" value="{{ old('shipper_address_2') }}" placeholder="Shipper Address 2"
            ...
            <div class="col-md-7 mt-2">
                <div class="form-group">
                    <input type="text" value="{{ old('shipper_address_3') }}" placeholder="Shipper Address 3"
            ...
            <div class="col-md-7 mt-2">
                <div class="form-group">
                    <input type="text" value="{{ old('shipper_address_4') }}" placeholder="Shipper Address 4"
    ...
    <div class="col-md-12">
        ...
        <div class="row align-items-center">
            ...
            <div class="col-md-7 mt-2">
                <div class="form-group">
                    <input type="text" value="{{ old('consignee_address_1') }}" placeholder="Consignee Address 1"
            ...
            <div class="col-md-7 mt-2">
                <div class="form-group">
                    <input type="text" value="{{ old('consignee_address_2') }}" placeholder="Consignee Address 2"
            ...
            <div class="col-md-7 mt-2">
                <div class="form-group">
                    <input type="text" value="{{ old('consignee_address_3') }}" placeholder="Consignee Address 3"
            ...
            <div class="col-md-7 mt-2">
                <div class="form-group">
                    <input type="text" value="{{ old('consignee_address_4') }}" placeholder="Consignee Address 4"
    ...
    <div class="col-md-12">
        ...
        <div class="row align-items-center">
            ...
            <div class="col-md-7 mt-2">
                <div class="form-group">
                    <input type="text" value="{{ old('agent_name') }}" placeholder="Agent Name"
        ...
        <div class="row align-items-center">
            ...
            <div class="col-md-7 mt-2">
                <div class="form-group">
                    <input type="text" value="{{ old('agent_address_1') }}" placeholder="Agent Address 1"
            ...
            <div class="col-md-7 mt-2">
                <div class="form-group">
                    <input type="text" value="{{ old('agent_address_2') }}" placeholder="Agent Address 2"
            ...
            <div class="col-md-7 mt-2">
                <div class="form-group">
                    <input type="text" value="{{ old('agent_address_3') }}" placeholder="Agent Address 3"
            ...
            <div class="col-md-7 mt-2">
                <div class="form-group">
                    <input type="text" value="{{ old('agent_address_4') }}" placeholder="Agent Address 4"
    ...
    <div class="col-md-12">
            ...
            <div class="col-md-7 mt-2">
                <div class="form-group">
                    <input type="text" value="{{ old('notify_name') }}" placeholder="Notify Name"
                        class="form-control @error('notify_name') is-invalid @enderror" name="notify_name">
                    @error('notify_name')
                        <div class="invalid-feedback">
                            {{ $message }}
                        </div>
        ...
        <div class="row align-items-center">
            ...
            <div class="col-md-7 mt-2">
                <div class="form-group">
                    <input type="text" value="{{ old('notify_address_1') }}" placeholder="Notify Address 1"
            ...
            <div class="col-md-7 mt-2">
                <div class="form-group">
                    <input type="text" value="{{ old('notify_address_2') }}" placeholder="Notify Address 2"
            ...
            <div class="col-md-7 mt-2">
                <div class="form-group">
                    <input type="text" value="{{ old('notify_address_3') }}" placeholder="Notify Address 3"
            ...
            <div class="col-md-7 mt-2">
                <div class="form-group">
                    <input type="text" value="{{ old('notify_address_4') }}" placeholder="Notify Address 4"
