    ...
    <div class="col-md-6">
            ...
            <div class="col-md-5 mt-2">
                <div class="form-group">
                    <select class="fumigationcomp-select @error('fumigation_code') is-invalid @enderror"
                        ...
                        <option value="{{ old('fumigation_code', $sd5->fumigation_code) }}">
                            {{ old('fumigation_code', $sd5->fumigation_code) }}
                        </option>
                    </select>
        ...
        <div class="row align-items-center">
            ...
            <div class="col-md-8 mt-2">
                <div class="form-group">
                    <input type="text" value="{{ old('fumigation_name', $sd5->fumigation_name) }}"
                        placeholder="Fumigation Name"
        ...
        <div class="row align-items-center">
            ...
            <div class="col-md-8 mt-2">
                <div class="form-group">
                    <input type="text" value="{{ old('fumigation_address_1', $sd5->fumigation_address_1) }}"
                        placeholder="Fumigation Address 1"
            ...
            <div class="col-md-8 mt-2">
                <div class="form-group">
                    <input type="text" value="{{ old('fumigation_address_2', $sd5->fumigation_address_2) }}"
                        placeholder="Fumigation Address 2"
            ...
            <div class="col-md-8 mt-2">
                <div class="form-group">
                    <input type="text" value="{{ old('fumigation_address_3', $sd5->fumigation_address_3) }}"
                        placeholder="Fumigation Address 3"
            ...
            <div class="col-md-8 mt-2">
                <div class="form-group">
                    <input type="text" value="{{ old('fumigation_address_4', $sd5->fumigation_address_4) }}"
                        placeholder="Fumigation Address 4"
        ...
        <div class="form-group">
            ...
            <input type="text" value="{{ old('fumigation_contact_name', $sd5->fumigation_contact_name) }}"
        ...
        <div class="row">
            <div class="col-md-6">
                <div class="form-group">
                    ...
                    <input type="text" value="{{ old('fumigation_instruction_1', $sd5->fumigation_instruction_1) }}"
            ...
            <div class="col-md-6">
                <div class="form-group">
                    ...
                    <input type="text" value="{{ old('fumigation_instruction_2', $sd5->fumigation_instruction_2) }}"
            ...
            <div class="col-md-6">
                <div class="form-group">
                    ...
                    <input type="text" value="{{ old('fumigation_instruction_3', $sd5->fumigation_instruction_3) }}"
            ...
            <div class="col-md-6">
                <div class="form-group">
                    ...
                    <input type="text"
                        value="{{ old('fumigation_instruction_4', $sd5->fumigation_instruction_4) }}"
            ...
            <div class="col-md-6">
                <div class="form-group">
                    ...
                    <input type="text"
                        value="{{ old('fumigation_instruction_5', $sd5->fumigation_instruction_5) }}"
            ...
            <div class="col-md-6">
                <div class="form-group">
                    ...
                    <input type="text"
                        value="{{ old('fumigation_instruction_6', $sd5->fumigation_instruction_6) }}"
            ...
            <div class="col-md-6">
                <div class="form-group">
                    ...
                    <input type="text"
                        value="{{ old('fumigation_instruction_7', $sd5->fumigation_instruction_7) }}"
            ...
            <div class="col-md-6">
                <div class="form-group">
                    ...
                    <input type="text"
                        value="{{ old('fumigation_instruction_8', $sd5->fumigation_instruction_8) }}"
        ...
        <div class="row">
            <div class="col-md-6">
                <div class="form-group">
                    ...
                    <input type="text"
                        value="{{ old('stumping_date_time', empty($sd5->stumping_date_time) ? '' : date('Y/m/d H:i', strtotime($sd5->stumping_date_time))) }}"
                        placeholder="Stamping Date Time" autocomplete="off"
            ...
            <div class="col-md-6">
                <div class="form-group">
                    ...
                    <input type="text"
                        value="{{ old('fumigation_date_time', empty($sd5->fumigation_date_time) ? '' : date('Y/m/d H:i', strtotime($sd5->fumigation_date_time))) }}"
        ...
        <div class="row">
            <div class="col-md-6">
                <div class="form-group">
                    ...
                    <input type="text"
                        value="{{ old('ventilation_date_time', empty($sd5->ventilation_date_time) ? '' : date('Y/m/d H:i', strtotime($sd5->ventilation_date_time))) }}"
            ...
            <div class="col-md-6">
                <div class="form-group">
                    ...
                    <input type="text"
                        value="{{ old('ava_date_time', empty($sd5->ava_date_time) ? '' : date('Y/m/d H:i', strtotime($sd5->ava_date_time))) }}"
                        placeholder="Fumigation Date Time" autocomplete="off"
