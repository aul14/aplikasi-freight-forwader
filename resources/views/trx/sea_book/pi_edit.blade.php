<div class="row">
    <div class="col-md-6">
            ...
            <div class="col-md-8 mt-2">
                <div class="form-group">
                    <select class="transport-select @error('trans_company_code') is-invalid @enderror"
                        ...
                        <option value="{{ old('trans_company_code', $sd4->trans_company_code) }}">
                            {{ old('trans_company_code', $sd4->trans_company_code) }}</option>
                    </select>
        ...
        <div class="row align-items-center">
            ...
            <div class="col-md-8 mt-2">
                <div class="form-group">
                    <input type="text" value="{{ old('trans_company_name', $sd4->trans_company_name) }}"
        ...
        <div class="row align-items-center">
            ...
            <div class="col-md-8 mt-2">
                <div class="form-group">
                    <input type="text" value="{{ old('trans_company_address_1', $sd4->trans_company_address_1) }}"
            ...
            <div class="col-md-8 mt-2">
                <div class="form-group">
                    <input type="text" value="{{ old('trans_company_address_2', $sd4->trans_company_address_2) }}"
            ...
            <div class="col-md-8 mt-2">
                <div class="form-group">
                    <input type="text" value="{{ old('trans_company_address_3', $sd4->trans_company_address_3) }}"
            ...
            <div class="col-md-8 mt-2">
                <div class="form-group">
                    <input type="text" value="{{ old('trans_company_address_4', $sd4->trans_company_address_4) }}"
        ...
        <div class="form-group">
            ...
            <input type="text" value="{{ old('trans_company_contact_name', $sd4->trans_company_contact_name) }}"
        ...
        <div class="form-group">
            ...
            <input type="text" value="{{ old('req_trans_no', $sd4->req_trans_no) }}"
        ...
        <div class="form-group">
            ...
            <input type="text" value="{{ old('vehicle_no', $sd4->vehicle_no) }}"
        ...
        <div class="row">
            <div class="col-md-6">
                <div class="form-group">
                    ...
                    <input type="text"
                        value="{{ old('pickup_date_time', empty($sd4->pickup_date_time) ? '' : date('Y/m/d H:i', strtotime($sd4->pickup_date_time))) }}"
                        placeholder="Pickup Date Time" autocomplete="off"
            ...
            <div class="col-md-6">
                <div class="form-group">
                    ...
                    <input type="text" value="{{ old('pickup_date_time_remark', $sd4->pickup_date_time_remark) }}"
        ...
        <div class="form-group">
            ...
            <input type="text"
                value="{{ old('delivery_date_time', empty($sd4->delivery_date_time) ? '' : date('Y/m/d H:i', strtotime($sd4->delivery_date_time))) }}"
                placeholder="Delivery Date Time" autocomplete="off"
            ...
            <div class="col-md-5 mt-2">
                <div class="form-group">
                    <select class="collection-select @error('collection_from_code') is-invalid @enderror"
                        ...
                        <option value="{{ old('collection_from_code', $sd4->collection_from_code) }}">
                            {{ old('collection_from_code', $sd4->collection_from_code) }}</option>
                    </select>
        ...
        <div class="row align-items-center">
            ...
            <div class="col-md-5 mt-2">
                <div class="form-group">
                    <input type="text" value="{{ old('collection_from_name', $sd4->collection_from_name) }}"
        ...
        <div class="row align-items-center">
            ...
            <div class="col-md-5 mt-2">
                <div class="form-group">
                    <input type="text" value="{{ old('collection_address_1', $sd4->collection_address_1) }}"
            ...
            <div class="col-md-8 mt-2">
                <div class="form-group">
                    <input type="text" value="{{ old('collection_address_2', $sd4->collection_address_2) }}"
            ...
            <div class="col-md-8 mt-2">
                <div class="form-group">
                    <input type="text" value="{{ old('collection_address_3', $sd4->collection_address_3) }}"
            ...
            <div class="col-md-8 mt-2">
                <div class="form-group">
                    <input type="text" value="{{ old('collection_address_4', $sd4->collection_address_4) }}"
    ...
    <div class="col-md-6">
            ...
            <div class="col-md-5 mt-2">
                <div class="form-group">
                    <select class="deliveryto-select @error('delivery_to_code') is-invalid @enderror"
                        ...
                        <option value="{{ old('delivery_to_code', $sd4->delivery_to_code) }}">
                            {{ old('delivery_to_code', $sd4->delivery_to_code) }}</option>
                    </select>
        ...
        <div class="row align-items-center">
            ...
            <div class="col-md-5 mt-2">
                <div class="form-group">
                    <input type="text" value="{{ old('delivery_to_name', $sd4->delivery_to_name) }}"
        ...
        <div class="row align-items-center">
            ...
            <div class="col-md-8 mt-2">
                <div class="form-group">
                    <input type="text" value="{{ old('delivery_address_1', $sd4->delivery_address_1) }}"
            ...
            <div class="col-md-8 mt-2">
                <div class="form-group">
                    <input type="text" value="{{ old('delivery_address_2', $sd4->delivery_address_2) }}"
            ...
            <div class="col-md-8 mt-2">
                <div class="form-group">
                    <input type="text" value="{{ old('delivery_address_3', $sd4->delivery_address_3) }}"
            ...
            <div class="col-md-8 mt-2">
                <div class="form-group">
                    <input type="text" value="{{ old('delivery_address_4', $sd4->delivery_address_4) }}"
        ...
        <div class="row">
            <div class="col-md-6">
                <div class="form-group">
                    ...
                    <input type="text" value="{{ old('delivery_instruction_1', $sd4->delivery_instruction_1) }}"
            ...
            <div class="col-md-6">
                <div class="form-group">
                    ...
                    <input type="text" value="{{ old('delivery_instruction_2', $sd4->delivery_instruction_2) }}"
            ...
            <div class="col-md-6">
                <div class="form-group">
                    ...
                    <input type="text" value="{{ old('delivery_instruction_3', $sd4->delivery_instruction_3) }}"
            ...
            <div class="col-md-6">
                <div class="form-group">
                    ...
                    <input type="text" value="{{ old('delivery_instruction_4', $sd4->delivery_instruction_4) }}"
            ...
            <div class="col-md-6">
                <div class="form-group">
                    ...
                    <input type="text" value="{{ old('delivery_instruction_5', $sd4->delivery_instruction_5) }}"
            ...
            <div class="col-md-6">
                <div class="form-group">
                    ...
                    <input type="text" value="{{ old('delivery_instruction_6', $sd4->delivery_instruction_6) }}"
            ...
            <div class="col-md-6">
                <div class="form-group">
                    ...
                    <input type="text" value="{{ old('delivery_instruction_7', $sd4->delivery_instruction_7) }}"
            ...
            <div class="col-md-6">
                <div class="form-group">
                    ...
                    <input type="text" value="{{ old('delivery_instruction_8', $sd4->delivery_instruction_8) }}"
        ...
        <div class="row">
            <div class="col-md-6">
                <div class="form-group">
                    ...
                    <div class="col-md-12">
                        <input type="checkbox" name="stuffing" @checked(old('stuffing', $sd4->stuffing) == 'yes') value="yes"
            ...
            @if ($sd4->stuffing)
                <div class="col-md-6 stuff-remark">
                    <div class="form-group">
                        <label for="stuffing_remark">Stuffing Remark</label>
                        <input type="text" value="{{ old('stuffing_remark', $sd4->stuffing_remark) }}"
                            placeholder="Stuffing Remark"
                            class="form-control @error('stuffing_remark') is-invalid @enderror"
                            name="stuffing_remark" id="stuffing_remark">
        ...
        <div class="row">
            <div class="col-md-6">
                <div class="form-group">
                    ...
                    <div class="col-md-12">
                        <input type="checkbox" name="fumigation" @checked(old('fumigation', $sd4->fumigation) == 'yes') value="yes"
                            data-toggle="toggle" data-on="Yes" data-off="No" data-onstyle="primary"
                            data-offstyle="danger">
                        @error('fumigation')
                            <div class="invalid-feedback">
            ...
            @if ($sd4->fumigation)
                <div class="col-md-6 fumigation-remark">
                    <div class="form-group">
                        <label for="fumigation_remark">Fumigation Remark</label>
                        <input type="text" value="{{ old('fumigation_remark', $sd4->fumigation_remark) }}"
                            placeholder="Fumigation Remark"
        ...
        <div class="row">
            <div class="col-md-6">
                <div class="form-group">
                    ...
                    <div class="col-md-12">
                        <input type="checkbox" name="permit" @checked(old('permit', $sd4->permit) == 'yes') value="yes"
                            data-toggle="toggle" data-on="Yes" data-off="No" data-onstyle="primary"
                            data-offstyle="danger">
                        @error('permit')
                            <div class="invalid-feedback">
            ...
            @if ($sd4->permit)
                <div class="col-md-6 permit-remark">
                    <div class="form-group">
                        <label for="permit_remark">Permit Remark</label>
                        <input type="text" value="{{ old('permit_remark', $sd4->permit_remark) }}"
                            placeholder="Permit Remark"
        ...
        <div class="row">
            <div class="col-md-6">
                <div class="form-group">
                    ...
                    <div class="col-md-12">
                        <input type="checkbox" name="insurance" @checked(old('insurance', $sd4->insurance) == 'yes') value="yes"
                            data-toggle="toggle" data-on="Yes" data-off="No" data-onstyle="primary"
                            data-offstyle="danger">
                        @error('insurance')
                            <div class="invalid-feedback">
            ...
            @if ($sd4->insurance)
                <div class="col-md-6 insurance-remark">
                    <div class="form-group">
                        <label for="insurance_remark">Insurance Remark</label>
                        <input type="text" value="{{ old('insurance_remark', $sd4->insurance_remark) }}"
                            placeholder="Insurance Remark"
                            class="form-control @error('insurance_remark') is-invalid @enderror"
                            name="insurance_remark" id="insurance_remark">
        ...
        <div class="row">
            <div class="col-md-6">
                <div class="form-group">
                    ...
                    <div class="col-md-12">
                        <input type="checkbox" name="railing" @checked(old('railing', $sd4->railing) == 'yes') value="yes"
                            data-toggle="toggle" data-on="Yes" data-off="No" data-onstyle="primary"
                            data-offstyle="danger">
                        @error('railing')
                            <div class="invalid-feedback">
            ...
            @if ($sd4->railing)
                <div class="col-md-6 railing-remark">
                    <div class="form-group">
                        <label for="railing_remark">Railing Remark</label>
                        <input type="text" value="{{ old('railing_remark', $sd4->railing_remark) }}"
                            placeholder="Railing Remark"
