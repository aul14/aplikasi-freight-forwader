    ...
    <div class="col-md-6">
        <div class="form-group">
            ...
            <select class="select-2 @error('shipment_type') is-invalid @enderror" name="shipment_type">
                <option value="HOUSE" @selected(old('shipment_type', $sd2->shipment_type) == 'HOUSE')>HOUSE</option>
                <option value="DIRECT" @selected(old('shipment_type', $sd2->shipment_type) == 'DIRECT')>DIRECT</option>
                <option value="SUB-MASTER" @selected(old('shipment_type', $sd2->shipment_type) == 'SUB-MASTER')>SUB-MASTER</option>
            </select>
            @error('shipment_type')
        ...
        <div class="form-group">
            ...
            <input type="text" value="{{ old('master_job_no', $sd2->master_job_no) }}"
        ...
        <div class="form-group">
            ...
            <input type="text"
                value="{{ old('place_of_receipt', !empty($sd2->place_of_receipt) ? 'JAKARTA CY' : '') }}"
            ...
            <div class="col-md-4">
                <div class="form-group">
                    ...
                    <select class="portloading-select @error('port_loading_code') is-invalid @enderror"
                        ...
                        <option
                            value="{{ old('port_loading_code', !empty($sd2->port_loading_code) ? $sd2->port_loading_code : 'IDJKT') }}">
                            {{ old('port_loading_code', !empty($sd2->port_loading_code) ? $sd2->port_loading_code : 'IDJKT') }}
                        </option>
                    </select>
            ...
            <div class="col-md-8">
                <div class="form-group">
                    ...
                    <input type="text" readonly class="form-control portloading-name"
                        value="{{ old('port_loading_name', !empty($sd2->port_loading_name) ? $sd2->port_loading_name : 'JAKARTA, INDONESIA') }}"
            ...
            <div class="col-md-4">
                <div class="form-group">
                    ...
                    <select class="portdischarge-select @error('port_discharge_code') is-invalid @enderror"
                        ...
                        <option value="{{ old('port_discharge_code', $sd2->port_discharge_code) }}">
                            {{ old('port_discharge_code', $sd2->port_discharge_code) }}</option>
                    </select>
            ...
            <div class="col-md-8">
                <div class="form-group">
                    ...
                    <input type="text" readonly class="form-control portdischarge-name"
                        value="{{ old('port_discharge_name', $sd2->port_discharge_name) }}" name="port_discharge_name"
        ...
        <div class="form-group">
            ...
            <input type="text" value="{{ old('terminal', $sd2->terminal) }}"
        ...
        <div class="form-group">
            ...
            <input type="text" value="{{ old('place_of_delivery', $sd2->place_of_delivery) }}"
        ...
        <div class="form-group">
            ...
            <input type="text" value="{{ old('letter_of_credit', $sd2->letter_of_credit) }}"
        ...
        <div class="form-group">
            ...
            <select class="select-2 @error('freight') is-invalid @enderror" name="freight">
                <option value="PREPAID" @selected(old('freight', $sd2->freight) == 'PREPAID')>PREPAID</option>
                <option value="COLLECT" @selected(old('freight', $sd2->freight) == 'COLLECT')>COLLECT</option>
            </select>
            @error('freight')
                <div class="invalid-feedback">
                    {{ $message }}
        ...
        <div class="form-group">
            ...
            <select class="select-2 @error('other_charges') is-invalid @enderror" name="other_charges">
                <option value="COLLECT" @selected(old('other_charges', $sd2->other_charges) == 'COLLECT')>COLLECT</option>
                <option value="PREPAID" @selected(old('other_charges', $sd2->other_charges) == 'PREPAID')>PREPAID</option>
            </select>
            @error('other_charges')
                <div class="invalid-feedback">
                    {{ $message }}
        ...
        <div class="row">
            <div class="col-md-6">
                <div class="form-group">
                    ...
                    <input type="text"
                        value="{{ old('eta_sub', empty($sd2->eta_sub) ? '' : date('Y/m/d H:i', strtotime($sd2->eta_sub))) }}"
            ...
            <div class="col-md-6">
                <div class="form-group">
                    ...
                    <input type="text"
                        value="{{ old('close_date_time', empty($sd2->close_date_time) ? '' : date('Y/m/d H:i', strtotime($sd2->close_date_time))) }}"
        ...
        <div class="row">
            <div class="col-md-6">
                <div class="form-group">
                    ...
                    <input type="text"
                        value="{{ old('etd_date', !empty($sd2->etd_date) ? date('d/m/Y', strtotime($sd2->etd_date)) : '') }}"
            ...
            <div class="col-md-6">
                <div class="form-group">
                    ...
                    <input type="text"
                        value="{{ old('first_via_ata', !empty($sd2->first_via_ata) ? date('d/m/Y', strtotime($sd2->first_via_ata)) : '') }}"
        ...
        <div class="row">
            ...
            <div class="col-md-6">
                <div class="form-group">
                    ...
                    <input type="text"
                        value="{{ old('first_via_etd', !empty($sd2->first_via_etd) ? date('d/m/Y', strtotime($sd2->first_via_etd)) : '') }}"
        ...
        <div class="row">
            <div class="col-md-6">
                <div class="form-group">
                    ...
                    <input type="text"
                        value="{{ old('eta', !empty($sd2->eta) ? date('d/m/Y', strtotime($sd2->eta)) : '') }}"
                        placeholder="First Via ETA" autocomplete="off"
            ...
            <div class="col-md-6">
                <div class="form-group">
                    ...
                    <input type="text"
                        value="{{ old('dest_eta_date', !empty($sd2->dest_eta_date) ? date('d/m/Y', strtotime($sd2->dest_eta_date)) : '') }}"
                        placeholder="First Via ETD" autocomplete="off"
                ...
                <div class="form-group">
                    ...
                    <select class="coloader-select @error('coloader_code') is-invalid @enderror"
                        ...
                        <option value="{{ old('coloader_code', $sd2->coloader_code) }}">
                            {{ old('coloader_code', $sd2->coloader_code) }}
                        </option>
                    </select>
                    @error('coloader_code')
                        <div class="invalid-feedback">
            ...
            <div class="col-md-4">
                <div class="form-group">
                    ...
                    <select class="stuff-select @error('stuff_warehouse_code') is-invalid @enderror"
                        ...
                        <option value="{{ old('stuff_warehouse_code', $sd2->stuff_warehouse_code) }}">
                            {{ old('stuff_warehouse_code', $sd2->stuff_warehouse_code) }}</option>
                    </select>
            ...
            <div class="col-md-8">
                <div class="form-group">
                    ...
                    <input type="text" readonly class="form-control stuff-name"
                        value="{{ old('stuff_warehouse_name', $sd2->stuff_warehouse_name) }}"
            ...
            <div class="col-md-4">
                <div class="form-group">
                    ...
                    <select class="forward-select @error('forward_agent_code') is-invalid @enderror"
                        ...
                        <option value="{{ old('forward_agent_code', $sd2->forward_agent_code) }}">
                            {{ old('forward_agent_code', $sd2->forward_agent_code) }}</option>
                    </select>
            ...
            <div class="col-md-8">
                <div class="form-group">
                    ...
                    <input type="text" readonly class="form-control forward-name"
                        value="{{ old('forward_agent_name', $sd2->forward_agent_name) }}" name="forward_agent_name"
                        id="forward-name-1">
                </div>
            </div>
        </div>
