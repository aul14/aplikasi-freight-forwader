<div class="row">
    <div class="col-md-6">
            ...
            <div class="col-md-8 mt-2">
                <div class="form-group">
                    <select class="stuffagent-select @error('stuff_agent_code') is-invalid @enderror"
                        ...
                        <option value="{{ old('stuff_agent_code', $sd3->stuff_agent_code) }}">
                            {{ old('stuff_agent_code', $sd3->stuff_agent_code) }}</option>
                    </select>
        ...
        <div class="row align-items-center">
            ...
            <div class="col-md-8 mt-2">
                <div class="form-group">
                    <input type="text" value="{{ old('stuff_agent_name', $sd3->stuff_agent_name) }}"
        ...
        <div class="row align-items-center">
            ...
            <div class="col-md-8 mt-2">
                <div class="form-group">
                    <input type="text" value="{{ old('stuff_agent_address_1', $sd3->stuff_agent_address_1) }}"
            ...
            <div class="col-md-8 mt-2">
                <div class="form-group">
                    <input type="text" value="{{ old('stuff_agent_address_2', $sd3->stuff_agent_address_2) }}"
            ...
            <div class="col-md-8 mt-2">
                <div class="form-group">
                    <input type="text" value="{{ old('stuff_agent_address_3', $sd3->stuff_agent_address_3) }}"
            ...
            <div class="col-md-8 mt-2">
                <div class="form-group">
                    <input type="text" value="{{ old('stuff_agent_address_4', $sd3->stuff_agent_address_4) }}"
    ...
    <div class="col-md-6">
        ...
        <div class="form-group">
            ...
            <input type="text"
                value="{{ old('cargo_receipt', empty($sd3->cargo_receipt) ? '' : date('Y/m/d H:i', strtotime($sd3->cargo_receipt))) }}"
                placeholder="Cargo Receipt" autocomplete="off"
        ...
        <div class="form-group">
            ...
            <input type="text"
                value="{{ old('stuff', empty($sd3->stuff) ? '' : date('Y/m/d H:i', strtotime($sd3->stuff))) }}"
        ...
        <div class="form-group">
            ...
            <input type="text" value="{{ old('stuff_agent_contact_name', $sd3->stuff_agent_contact_name) }}"
