<div class="row">
    <div class="col-md-6">
            ...
            <div class="col-md-8">
                <div class="form-group">
                    ...
                    <input type="text" class="form-control @error('booking_no') is-invalid @enderror"
                        name="booking_no" value="{{ old('booking_no', $sj->booking_no) }}" id="booking_no">
                    @error('booking_no')
                        <div class="invalid-feedback">
                            {{ $message }}
                        </div>
        ...
        <div class="row">
            ...
            <div class="col-md-2">
                <div class="form-group">
                    <label for="customer_code">&nbsp;</label>
                    <a href="javascript:void(0)" class="btn btn-danger form-control btn-deleted-cus">
                        <i class="fa fa-close"></i>
                    </a>
                </div>
            </div>
                        ...
                        <div class="form-group">
                            <select class="shipper-select @error('shipper_code') is-invalid @enderror"
                                ...
                                <option value="{{ old('shipper_code', $jm->shipper_code) }}">
                                    {{ old('shipper_code', $jm->shipper_code) }}
                                </option>
                            </select>
    ...
    <div class="col-md-6">
        ...
        <div class="form-group">
            ...
            <div class="col-md-6">
                <input type="checkbox" name="bl_surrendered" @checked(old('bl_surrendered', $jm->bl_surrendered) == 'yes') value="yes"
        ...
        <div class="form-group">
            ...
            <div class="col-md-6">
                <input type="checkbox" name="bl_attach" @checked(old('bl_attach', $jm->bl_attach) == 'yes') value="yes"
                    data-toggle="toggle" data-on="Yes" data-off="No" data-onstyle="primary"
                    data-offstyle="danger">
                @error('bl_attach')
                    <div class="invalid-feedback">
        ...
        <div class="form-group">
            ...
            <input type="number" value="{{ old('no_of_original_bl', $sj->no_of_original_bl) }}" autocomplete="off"
                ...
                <div class="form-group">
                    ...
                    <select class="salesman-select @error('salesman_code') is-invalid @enderror"
                        ...
                        <option value="{{ old('salesman_code', $jm->salesman_code) }}">
                            {{ old('salesman_code', $jm->salesman_code) }}</option>
                    </select>
        ...
        <div class="form-group">
            ...
            <select class="select-2 @error('freight') is-invalid @enderror" name="freight">
                <option value=""></option>
                <option value="COLLECT" @selected(old('freight', $sj->freight) == 'COLLECT')>COLLECT</option>
                <option value="PREPAID" @selected(old('freight', $sj->freight) == 'PREPAID')>PREPAID</option>
            </select>
            @error('freight')
                <div class="invalid-feedback">
                    {{ $message }}
                ...
                <div class="col-md-12">
                    ...
                    <div class="row align-items-center">
                        ...
                        <div class="col-md-7 mt-2">
                            <div class="form-group">
                                <input type="text"
                                    value="{{ old('delivery_agent_address_1', $jm->delivery_agent_address_1) }}"
                        ...
                        <div class="col-md-7 mt-2">
                            <div class="form-group">
                                <input type="text"
                                    value="{{ old('delivery_agent_address_2', $jm->delivery_agent_address_2) }}"
                        ...
                        <div class="col-md-7 mt-2">
                            <div class="form-group">
                                <input type="text"
                                    value="{{ old('delivery_agent_address_3', $jm->delivery_agent_address_3) }}"
                        ...
                        <div class="col-md-7 mt-2">
                            <div class="form-group">
                                <input type="text"
                                    value="{{ old('delivery_agent_address_4', $jm->delivery_agent_address_4) }}"
    ...
    <script>
        ...
        function clickRemoveValBook(classBtn) {
            $(classBtn).click(function(e) {
                ...
                $("input[name=etd]").val('');
                $("input[name=eta_sub]").val('');
                $("input[name=close_date_time]").val('');
                $("input[name=first_via_ata]").val('');
                $("input[name=first_via_eta]").val('');
                $("input[name=first_via_etd]").val('');
                $("input[name=total_sales]").val('');
                $("input[name=eta]").val('');
                $("input[name=dest_eta_date]").val('');
                $("input[name=booking_no]").val('');
                $("input[name=place_of_receipt]").val('');
                $("input[name=place_of_delivery]").val('');
                $("input[name=voyage_no]").val('');
                $("input[name=mother_voyage]").val('');
                $("input[name=mother_vessel_name]").val('');
                ...
                var lastFrom = new Option('JKT', 'JKT', true, true);
                $("select[name=origin_code]").append(lastFrom).trigger('change');
                $("input[name=origin_name]").val("JAKARTA");
                $("select[name=dest_code]").empty();
                $("input[name=dest_name]").val("");
                var lastLoadingCode = new Option('IDJKT', 'IDJKT', true, true);
                $("select[name=port_loading_code]").append(lastLoadingCode).trigger('change');
                $("input[name=port_loading_name]").val("JAKARTA, INDONESIA");
                ...
                cloneCi = `<div class="row row-list-fch">
                                        <div class="col-md-2">
                                            ...
                                            <div class="row my-3">
                                                <div class="col-md-6">
                                                    <a href="javascript:void(0)" class="btn btn-primary add-btn-fch" id="add-btn-fch-1" title="Add row"
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-8">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" readonly class="form-control cargo-commodity" name="cargo_commodity[]"
                                                            id="cargo-commodity-1">
                                        ...
                                        <div class="col-md-5">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="text" data-type='currency4' autocomplete="off" title="Volume" placeholder="Volume"
                                                    class="form-control " name="cargo_volume[]" id="cargo-volume-1">
                                        ...
                                        <div class="col-md-5">
                                            <div class="form-group">
                                                ...
                                                <input type="text" placeholder="Description 02" class="form-control  my-2" name="good_desc_2[]"
                                                    id="good_desc_2">

                                                <input type="text" placeholder="Description 03" class="form-control  my-2" name="good_desc_3[]"
                                                    id="good_desc_3">

                                                <input type="text" placeholder="Description 04" class="form-control  my-2" name="good_desc_4[]"
                                                    id="good_desc_4">

                                                <input type="text" placeholder="Description 05" class="form-control  my-2" name="good_desc_5[]"
                                                    id="good_desc_5">

                                                <input type="text" placeholder="Description 06" class="form-control  my-2" name="good_desc_6[]"
                                                    id="good_desc_6">

                                                <input type="text" placeholder="Description 07" class="form-control  my-2" name="good_desc_7[]"
                                                    id="good_desc_7">

                                                <input type="text" placeholder="Description 08" class="form-control  my-2" name="good_desc_8[]"
                                                    id="good_desc_8">
                                            </div>
                ...
                $(`.wrapper-row-list-fch`).append(
                    cloneCi);
                evtCommodity(`#cargo-select-1`,
                    `#cargo-commodity-1`);
                evtContainerType(`#cont-type-select-1`,
                    `#cargo-container-1`);
                evtUom(`#cargo-uom-select-1`,
                    `#cargo-uom-1`);
                $("input[data-type='currency4']").on({
                    keyup: function() {
                        formatCurrency4($(
        ...
        function dataTableBooking(idTable) {
            var table = $(idTable).DataTable({
                ...
                ajax: {
                    url: '{{ route('get.table.book_ex_job_sea') }}',
                    dataType: "json",
                    type: "POST",
                },
                oLanguage: {
            ...
            $(document).on('click', '.modal-table1 .tbody-book td', function() {
                ...
                if (table.rows(colIdx).nodes().to$().find('td:first-child .input_check').is(':checked') === true) {
                    ...
                    $.ajax({
                        type: "POST",
                        url: '{{ route('search.book_ex_job_sea') }}',
                        data: {
                        ...
                        success: function(res) {
                            ...
                            if (quotation_no != 0) {
                                $.ajax({
                                    type: "post",
                                    url: '{{ route('get.jc.from.quot_sea') }}',
                                    data: {
                                        ...
                                        if (data.length > 0) {
                                            ...
                                            for (let i = 0; i < data.length; i++) {
                                                ...
                                                cloneJc = `<tr class="dynamic-field" id="dynamic-field-${i+1}" onclick="click_tr(${i+1})">
                                                    <input type="hidden" name="id_key[]" id="id-key-${i+1}" class="id-key" value="${i+1}">
                                                            <td class="text-center">
                                                            ...
                                                            <td>
                                                                <div class="form-group">
                                                                    <select name="code[${i+1}]" id="code-select-${i+1}" class="code-select">
                                                            ...
                                                            <td>
                                                                <div class="form-group">
                                                                    <input type="text" class="form-control desc" name="description[${i+1}]" id="desc-${i+1}" value="${data[i].item_desc != null ? data[i].item_desc : ''}">
                                                                </div>
                                                            </td>

                                                            <td style="background-color: darksalmon;">
                                                                <div class="form-group">
                                                                    <input type="text" class="form-control qty-sales" name="qty_sales[${i+1}]" id="qty-sales-${i+1}"
                                                            ...
                                                            <td style="background-color: darksalmon;">
                                                                <div class="form-group">
                                                                    <select name="uom_sales[${i+1}]" id="uom-sales-${i+1}" class="uom-sales">
                                                            ...
                                                            <td style="background-color: darksalmon;">
                                                                <div class="form-group">
                                                                    <select name="pc_sales[${i+1}]" id="pc-sales-${i+1}" class="pc-sales">
                                                                        <option value="">Search</option>
                                                            ...
                                                            <td style="background-color: darksalmon;">
                                                                <div class="form-group">
                                                                    <select name="cust_code_sales[${i+1}]" id="cust-code-sales-${i+1}" class="cust-code-sales">
                                                            ...
                                                            <td style="background-color: darksalmon;">
                                                                <div class="form-group">
                                                                    <input type="text" value='${res.customer}' class="form-control cust-name-sales" name="cust_name_sales[${i+1}]"
                                                            ...
                                                            <td style="background-color: darksalmon;">
                                                                <div class="form-group">
                                                                    <select name="vat_sales[${i+1}]" id="vat-sales-${i+1}" class="vat-sales">
                                                            ...
                                                            <td style="background-color: darksalmon;">
                                                                <div class="form-group">
                                                                    <select name="curr_sales[${i+1}]" id="curr-sales-${i+1}" class="curr-sales">
                                                            ...
                                                            <td style="background-color: darksalmon;">
                                                                <div class="form-group">
                                                                    <input type="text" class="form-control rate-sales" id="rate-sales-${i+1}"
                                                                        autocomplete="off" data-type='currency' name="rate_sales[${i+1}]" 
                                                            ...
                                                            <td style="background-color: darksalmon;">
                                                                <div class="form-group">
                                                                    <input type="text" class="form-control unit-rate-sales" id="unit-rate-sales-${i+1}"
                                                                        autocomplete="off" data-type='currency' name="unit_rate_sales[${i+1}]"
                                                            ...
                                                            <td style="background-color: darksalmon;">
                                                                <div class="form-group">
                                                                    ...
                                                                    value='${data[i].amt != null ? numberFormatter(parseFloat(data[i].amt)) : ''}'
                                                                        autocomplete="off" data-type='currency' name="amt_sales[${i+1}]">
                                                                </div>
                                                            </td>
                                                            ...
                                                            <td style="background-color: darksalmon;">
                                                                <div class="form-group">
                                                                    ...
                                                                    value='${data[i].idr_amt != null ? numberFormatter(parseFloat(data[i].idr_amt)) : ''}'
                                                                        autocomplete="off" data-type='currency' name="sales[${i+1}]" data-total_sales="1">
                                                                </div>
                                                            </td>

                                                            <td style="background-color: cadetblue;">
                                                                <div class="form-group">
                                                                    <input type="text" class="form-control qty-vendor" name="qty_vendor[${i+1}]"
                                                            ...
                                                            <td style="background-color: cadetblue;">
                                                                <div class="form-group">
                                                                    <select name="pc_vendor[${i+1}]" id="pc-vendor-${i+1}" class="pc-vendor">
                                                                        <option value="">Search</option>
                                                                        <option value="Prepaid">Prepaid</option>
                                                                        <option value="Collect">Collect</option>
                                                                    </select>
                                                            ...
                                                            <td style="background-color: cadetblue;">
                                                                <div class="form-group">
                                                                    <select name="code_vendor[${i+1}]" id="code-vendor-${i+1}" class="code-vendor">
                                                                        <option value="">Search</option>
                                                                    </select>
                                                                </div>
                                                            </td>
                                                            ...
                                                            <td style="background-color: cadetblue;">
                                                                <div class="form-group">
                                                                    <input type="text" class="form-control name-vendor" name="name_vendor[${i+1}]"
                                                                        id="name-vendor-${i+1}">
                                                                </div>
                                                            </td>
                                                            ...
                                                            <td style="background-color: cadetblue;">
                                                                <div class="form-group">
                                                                    <select name="vat_vendor[${i+1}]" id="vat-vendor-${i+1}" class="vat-vendor">
                                                                        <option value="">Search</option>
                                                                    </select>
                                                                </div>
                                                            </td>
                                                            ...
                                                            <td style="background-color: cadetblue;">
                                                                <div class="form-group">
                                                                    <select name="curr_vendor[${i+1}]" id="curr-vendor-${i+1}" class="curr-vendor">
                                                                        <option value="">Search</option>
                                                                    </select>
                                                                </div>
                                                            </td>
                                                            ...
                                                            <td style="background-color: cadetblue;">
                                                                <div class="form-group">
                                                                    <input type="text" class="form-control rate-vendor" id="rate-vendor-${i+1}"
                                                                        autocomplete="off" data-type='currency' name="rate_vendor[${i+1}]"
                                                                        onkeyup="sum_idr_vendor(${i+1}, 1)">
                                                                </div>
                                                            </td>
                                                            ...
                                                            <td style="background-color: cadetblue;">
                                                                <div class="form-group">
                                                                    <input type="text" class="form-control unit-rate-vendor" id="unit-rate-vendor-${i+1}"
                                                                        autocomplete="off" data-type='currency' name="unit_rate_vendor[${i+1}]"
                                                                        onkeyup="sum_idr_vendor(${i+1}, 1)">
                                                                </div>
                                                            </td>
                                                            ...
                                                            <td style="background-color: cadetblue;">
                                                                <div class="form-group">
                                                                    <input type="text" class="form-control amt-vendor" readonly id="amt-vendor-${i+1}"
                                                                        autocomplete="off" data-type='currency' name="amt_vendor[${i+1}]">
                                                                </div>
                                                            </td>
                                                            ...
                                                            <td style="background-color: cadetblue;">
                                                                <div class="form-group">
                                                                    <input type="text" class="form-control cost" readonly id="cost-${i+1}"
                                                                        autocomplete="off" data-type='currency' name="cost[${i+1}]" data-total_vendor="1">
                                                                </div>
                                                            </td>
                                                ...
                                                cloneCi = `<div class="row row-list-fch">
                                                            ...
                                                            <div class="col-md-5">
                                                                ...
                                                                <div class="form-group">
                                                                    <label for="gross_weight">Gross Weight</label>
                                                                    <input type="text" data-type='currency4' autocomplete="off" title="Gross Weight"
                                                                        placeholder="Gross Weight" class="form-control " name="gross_weight[]" value="${response[i].gross_weight != null ? numberFormatter4(parseFloat(response[i].gross_weight)) : ''}" id="gross-weight-${i+1}">
                                                                </div>
                                                                <div class="row">
                                                                    <div class="col-md-4">
                                                                        <div class="form-group">
                                                            ...
                                                            <div class="col-md-5">
                                                                ...
                                                                <div class="form-group">
                                                                    <label for="cargo_volume">Volume</label>
                                                                    <input type="text" data-type='currency4' autocomplete="off" title="Volume" placeholder="Volume"
                                                                        class="form-control " name="cargo_volume[]" id="cargo-volume-${i+1}" value="${response[i].cargo_volume != null ? numberFormatter4(parseFloat(response[i].cargo_volume)) : ''}">
