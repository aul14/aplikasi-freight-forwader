    ...
    <div class="row mt-1 px-1">
        <div class="col-12">
            ...
            <div class="card">
                ...
                <form action="{{ route('sea_ex_job.store') }}" method="post">
                    @csrf
                    @method('POST')
                    <div class="card-body">
                        <div class="row">
                                ...
                                <div class="tabset">
                                    ...
                                    <div class="tab-panels col-md-12">
                                        <section id="b_l" class="tab-panel">
                                            @include('trx.sea_ex_job.bl')
                                        </section>

                                        <section id="s_i" class="tab-panel">
                                            @include('trx.sea_ex_job.si')
                                        </section>

                                        <section id="v_d" class="tab-panel">
                                            @include('trx.sea_ex_job.vd')
                                        </section>

                                        <section id="c_i" class="tab-panel">
                                            @include('trx.sea_ex_job.ci')
                                        </section>

                                        <section id="e_i" class="tab-panel">
                                            @include('trx.sea_ex_job.ei')
                                        </section>

                                        <section id="j_c" class="tab-panel">
                                            @include('trx.sea_ex_job.jc')
                                        </section>
                                    </div>
                                </div>
                            </div>
