<div class="row">
    <div class="col-md-6">
        ...
        <div class="form-group">
            ...
            <input type="text" value="{{ old('place_of_issue') }}"
        ...
        <div class="form-group">
            ...
            <input type="text" value="{{ old('date_of_issue') }}" placeholder="Date of Issue" autocomplete="off"
        ...
        <div class="form-group">
            ...
            <input type="text" value="{{ old('issue_by') }}"
        ...
        <div class="form-group">
            ...
            <input type="text" value="{{ old('said_to_contain') }}"
        ...
        <div class="form-group">
            ...
            <input type="text" value="{{ old('total_pcs_in_word') }}"
        ...
        <div class="form-group">
            ...
            <input type="text" value="{{ old('do_release_to') }}"
        ...
        <div class="row">
            <div class="col-md-6">
                <div class="form-group">
                    ...
                    <input type="text" value="{{ old('do_release_date') }}"
            ...
            <div class="col-md-6">
                <div class="form-group">
                    ...
                    <input type="text" value="{{ old('cargo_collection_date') }}"
    ...
    <div class="col-md-6">
        <div class="form-group">
            ...
            <div class="col-md-6">
                <input type="checkbox" name="obl_surrendered" @checked(old('obl_surrendered') == 'yes') value="yes"
        ...
        <div class="form-group">
            ...
            <select class="select-2 @error('obl_freight') is-invalid @enderror" name="obl_freight">
                <option value=""></option>
                <option value="COLLECT" @selected(old('obl_freight') == 'COLLECT')>COLLECT</option>
                <option value="PREPAID" @selected(old('obl_freight') == 'PREPAID')>PREPAID</option>
            </select>
            @error('obl_freight')
                <div class="invalid-feedback">
                    {{ $message }}
        ...
        <div class="form-group">
            ...
            <input type="text" value="{{ old('laden_on_board') }}" placeholder="Laden/On Board Date"
                autocomplete="off" class="form-control @error('laden_on_board') is-invalid @enderror date-picker"
                name="laden_on_board" id="laden_on_board">
