<div class="row">
    <div class="col-md-6">
            ...
            <div class="col-md-4">
                <div class="form-group">
                    ...
                    <select class="deltype-select @error('delivery_type_code') is-invalid @enderror"
                        ...
                        <option value="{{ old('delivery_type_code', $sd1->delivery_type_code) }}">
                            {{ old('delivery_type_code', $sd1->delivery_type_code) }}</option>
                    </select>
            ...
            <div class="col-md-8">
                <div class="form-group">
                    ...
                    <input type="text" readonly class="form-control @error('delivery_type') is-invalid @enderror"
                        name="delivery_type" value="{{ old('delivery_type', $sd1->delivery_type) }}" id="delivery_type">
                    @error('delivery_type')
                        <div class="invalid-feedback">
                            {{ $message }}
                        </div>
        ...
        <div class="row">
            <div class="col-md-4">
                <div class="form-group">
                    ...
                    <select class="commodity-select @error('commodity_code') is-invalid @enderror"
                        name="commodity_code">
                        <option value="{{ old('commodity_code', $sd1->commodity_code) }}">
                            {{ old('commodity_code', $sd1->commodity_code) }}</option>
                    </select>
            ...
            <div class="col-md-8">
                <div class="form-group">
                    ...
                    <input type="text" value="{{ old('commodity', $sd1->commodity) }}" readonly
        ...
        <div class="form-group">
            ...
            <select class="select-2 @error('cargo_class') is-invalid @enderror" name="cargo_class">
                <option value=""></option>
                <option value="0 - LIGUID BULK" @selected(old('cargo_class', $sd1->cargo_class) == '0 - LIGUID BULK')>0 - LIGUID BULK</option>
                <option value="1 - BREAK BULK/GENERAL BULK" @selected(old('cargo_class', $sd1->cargo_class) == '1 - BREAK BULK/GENERAL BULK')>1 - BREAK BULK/GENERAL BULK
                </option>
                <option value="2 - CONTAINER" @selected(old('cargo_class', $sd1->cargo_class) == '2 - CONTAINER')>2 - CONTAINER</option>
                <option value="6 - PASSENGER" @selected(old('cargo_class', $sd1->cargo_class) == '6 - PASSENGER')>6 - PASSENGER</option>
                <option value="7 - VEHICLES" @selected(old('cargo_class', $sd1->cargo_class) == '7 - VEHICLES')>7 - VEHICLES</option>
                <option value="9 - GENERAL" @selected(old('cargo_class', $sd1->cargo_class) == '9 - GENERAL')>9 - GENERAL</option>
                <option value="A - DANGEROUS GOODS CLASS I" @selected(old('cargo_class', $sd1->cargo_class) == 'A - DANGEROUS GOODS CLASS I')>A - DANGEROUS GOODS CLASS I
                </option>
                <option value="B - DANGEROUS GOODS CLASS II" @selected(old('cargo_class', $sd1->cargo_class) == 'B - DANGEROUS GOODS CLASS II')>B - DANGEROUS GOODS CLASS II
                </option>
                <option value="C - DANGEROUS GOODS CLASS III" @selected(old('cargo_class', $sd1->cargo_class) == 'C - DANGEROUS GOODS CLASS III')>C - DANGEROUS GOODS CLASS III
                </option>
                <option value="L - LIVE STOCK" @selected(old('cargo_class', $sd1->cargo_class) == 'L - LIVE STOCK')>L - LIVE STOCK</option>
                <option value="S - SPECIAL" @selected(old('cargo_class', $sd1->cargo_class) == 'S - SPECIAL')>S - SPECIAL</option>
                <option value="V - VALUABLE" @selected(old('cargo_class', $sd1->cargo_class) == 'V - VALUABLE')>V - VALUABLE</option>
            </select>
            @error('cargo_class')
                <div class="invalid-feedback">
                    {{ $message }}
            ...
            <div class="col-md-4">
                <div class="form-group">
                    ...
                    <select class="origin-select @error('origin_code') is-invalid @enderror" id="origin-select-1"
                        name="origin_code">
                        <option
                            value="{{ old('origin_code', !empty($sd1->origin_code) ? $sd1->origin_code : 'JKT') }}">
                            {{ old('origin_code', !empty($sd1->origin_code) ? $sd1->origin_code : 'JKT') }}</option>
                    </select>
                    @error('origin_code')
                        <div class="invalid-feedback">
                            {{ $message }}
            ...
            <div class="col-md-8">
                <div class="form-group">
                    ...
                    <input type="text" readonly
                        value="{{ old('origin_name', !empty($sd1->origin_name) ? $sd1->origin_name : 'JAKARTA') }}"
        ...
        <div class="row">
            <div class="col-md-4">
                <div class="form-group">
                    ...
                    <select class="dest-select @error('dest_code') is-invalid @enderror" required id="dest-select-1"
                        name="dest_code">
                        <option value="{{ old('dest_code', $sd1->dest_code) }}">
                            {{ old('dest_code', $sd1->dest_code) }}
                        </option>
                    </select>
                    @error('dest_code')
                        <div class="invalid-feedback">
            ...
            <div class="col-md-8">
                <div class="form-group">
                    ...
                    <input type="text" readonly value="{{ old('dest_name', $sd1->dest_name) }}"
        ...
        <div class="form-group">
            ...
            <input type="text"
                value="{{ old('place_of_receipt', !empty($sd1->place_of_receipt) ? $sd1->place_of_receipt : 'JAKARTA CY') }}"
            ...
            <div class="col-md-4">
                <div class="form-group">
                    ...
                    <select class="portloading-select @error('port_loading_code') is-invalid @enderror" required
                        ...
                        <option
                            value="{{ old('port_loading_code', !empty($sd1->port_loading_code) ? $sd1->port_loading_code : 'IDJKT') }}">
                            {{ old('port_loading_code', !empty($sd1->port_loading_code) ? $sd1->port_loading_code : 'IDJKT') }}
                        </option>
                    </select>
            ...
            <div class="col-md-8">
                <div class="form-group">
                    ...
                    <input type="text" readonly class="form-control portloading-name"
                        value="{{ old('port_loading_name', !empty($sd1->port_loading_name) ? $sd1->port_loading_name : 'JAKARTA, INDONESIA') }}"
            ...
            <div class="col-md-4">
                <div class="form-group">
                    ...
                    <select class="viaport-select @error('via_port_code') is-invalid @enderror" id="viaport-select-1"
                        name="via_port_code">
                        <option value="{{ old('via_port_code', $sd1->via_port_code) }}">
                            {{ old('via_port_code', $sd1->via_port_code) }}
                        </option>
                    </select>
                    @error('via_port_code')
                        <div class="invalid-feedback">
            ...
            <div class="col-md-8">
                <div class="form-group">
                    ...
                    <input type="text" readonly class="form-control viaport-name"
                        value="{{ old('via_port_name', $sd1->via_port_name) }}" name="via_port_name"
                        id="viaport-name-1">
                </div>
            </div>
        </div>
            ...
            <div class="col-md-4">
                <div class="form-group">
                    ...
                    <select class="portdischarge-select @error('port_discharge_code') is-invalid @enderror" required
                        ...
                        <option value="{{ old('port_discharge_code', $sd1->port_discharge_code) }}">
                            {{ old('port_discharge_code', $sd1->port_discharge_code) }}</option>
                    </select>
            ...
            <div class="col-md-8">
                <div class="form-group">
                    ...
                    <input type="text" readonly class="form-control portdischarge-name"
                        value="{{ old('port_discharge_name', $sd1->port_discharge_name) }}"
        ...
        <div class="form-group">
            ...
            <input type="text" value="{{ old('place_of_delivery', $sd1->place_of_delivery) }}"
        ...
        <div class="form-group">
            ...
            <input type="text" value="{{ old('pre_carriage', $sd1->pre_carriage) }}"
            ...
            <div class="col-md-4">
                <div class="form-group">
                    ...
                    <select class="vessel-select @error('vessel_code') is-invalid @enderror" required
                        ...
                        <option value="{{ old('vessel_code', $sd1->vessel_code) }}">
                            {{ old('vessel_code', $sd1->vessel_code) }}</option>
                    </select>
                    @error('vessel_code')
                        <div class="invalid-feedback">
                            {{ $message }}
            ...
            <div class="col-md-8">
                <div class="form-group">
                    ...
                    <input type="text" readonly class="form-control vessel-name"
                        value="{{ old('vessel_name', $sd1->vessel_name) }}" name="vessel_name" id="vessel-name-1">
                </div>
            </div>
        </div>
        <div class="form-group">
            <label for="voyage_no">Feeder/Direct Voyage</label>
            <input type="text" value="{{ old('voyage_no', $sd1->voyage_no) }}"
        ...
        <div class="row">
            <div class="col-md-4">
                <div class="form-group">
                    ...
                    <input type="text" value="{{ old('mother_voyage', $sd1->mother_voyage) }}"
            ...
            <div class="col-md-8">
                <div class="form-group">
                    ...
                    <input type="text" value="{{ old('mother_vessel_name', $sd1->mother_vessel_name) }}"
    ...
    <div class="col-md-6">
        <div class="row">
            <div class="col-md-6">
                <div class="form-group">
                    ...
                    <input type="text"
                        value="{{ old('eta_sub', !empty($sd1->eta_sub) ? date('Y/m/d H:i', strtotime($sd1->eta_sub)) : '') }}"
                        placeholder="ETA SUB" autocomplete="off"
            ...
            <div class="col-md-6">
                <div class="form-group">
                    ...
                    <input type="text"
                        value="{{ old('close_date_time', !empty($sj->s_d2->close_date_time) ? date('Y/m/d H:i', strtotime($sj->s_d2->close_date_time)) : '') }}"
                        placeholder="Close Date/Time" autocomplete="off"
        ...
        <div class="row">
            <div class="col-md-6">
                <div class="form-group">
                    ...
                    <input type="text"
                        value="{{ old('etd', !empty($sd1->etd) ? date('d/m/Y', strtotime($sd1->etd)) : '') }}"
                        placeholder="ETD" required autocomplete="off"
            ...
            <div class="col-md-6">
                <div class="form-group">
                    ...
                    <input type="text"
                        value="{{ old('first_via_ata', !empty($sd1->first_via_ata) ? date('d/m/Y', strtotime($sd1->first_via_ata)) : '') }}"
                        placeholder="First Via ATA" autocomplete="off"
        ...
        <div class="row">
            <div class="col-md-6">
                <div class="form-group">
                    ...
                    <input type="text"
                        value="{{ old('first_via_eta', !empty($sd1->first_via_eta) ? date('d/m/Y', strtotime($sd1->first_via_eta)) : '') }}"
            ...
            <div class="col-md-6">
                <div class="form-group">
                    ...
                    <input type="text"
                        value="{{ old('first_via_etd', !empty($sd1->first_via_etd) ? date('d/m/Y', strtotime($sd1->first_via_etd)) : '') }}"
        ...
        <div class="row">
            <div class="col-md-6">
                <div class="form-group">
                    ...
                    <input type="text"
                        value="{{ old('eta', !empty($sd1->eta) ? date('d/m/Y', strtotime($sd1->eta)) : '') }}"
                        placeholder="First Via ETA" autocomplete="off"
                        class="form-control @error('eta') is-invalid @enderror date-picker" name="eta"
                        id="eta">
                    @error('eta')
                        <div class="invalid-feedback">
                            {{ $message }}
        ...
        <div class="row">
            <div class="col-md-6">
                <div class="form-group">
                    ...
                    <input type="text" value="{{ old('vessel_remark', $sd1->vessel_remark) }}"
            ...
            <div class="col-md-6">
                <div class="form-group">
                    ...
                    <select class="select-2 @error('shipmode') is-invalid @enderror" name="shipmode">
                        <option value=""></option>
                        <option value="ROUTING ORDER" @selected(old('shipmode', $sd1->shipmode) == 'ROUTING ORDER')>ROUTING ORDER</option>
                        <option value="FREE HANDS" @selected(old('shipmode', $sd1->shipmode) == 'FREE HANDS')>FREE HANDS</option>
                        <option value="TRANSIT" @selected(old('shipmode', $sd1->shipmode) == 'TRANSIT')>TRANSIT</option>
                    </select>
                    @error('shipmode')
                        <div class="invalid-feedback">
                            {{ $message }}
        ...
        <div class="form-group">
            ...
            <input type="text" value="{{ old('service_level', $sd1->service_level) }}"
            ...
            <div class="col-md-4">
                <div class="form-group">
                    ...
                    <select class="shipping-select @error('shippline_code') is-invalid @enderror"
                        ...
                        <option value="{{ old('shippline_code', $sd1->shippline_code) }}">
                            {{ old('shippline_code', $sd1->shippline_code) }}</option>
                    </select>
            ...
            <div class="col-md-8">
                <div class="form-group">
                    ...
                    <input type="text" readonly class="form-control shipping-name"
                        value="{{ old('shippline_name', $sd1->shippline_name) }}" name="shippline_name"
                        id="shipping-name-1">
                </div>
            </div>
        </div>
        <div class="form-group">
            ...
            <input type="text" value="{{ old('shippline_ref_no', $sd1->shippline_ref_no) }}"
            ...
            <div class="col-md-4">
                <div class="form-group">
                    ...
                    <select class="coloader-select @error('coloader_code') is-invalid @enderror"
                        ...
                        <option value="{{ old('coloader_code', $sd1->coloader_code) }}">
                            {{ old('coloader_code', $sd1->coloader_code) }}</option>
                    </select>
                    @error('coloader_code')
                        <div class="invalid-feedback">
                            {{ $message }}
            ...
            <div class="col-md-8">
                <div class="form-group">
                    ...
                    <input type="text" readonly class="form-control coloader-name"
                        value="{{ old('coloader_name', $sd1->coloader_name) }}" name="coloader_name"
                        id="coloader-name-1">
                </div>
            </div>
        </div>
        <div class="form-group">
            ...
            <input type="text" value="{{ old('coloader_ref_no', $sd1->coloader_ref_no) }}"
        ...
        <div class="row">
            <div class="col-md-6">
                <div class="form-group">
                    ...
                    <input type="number" value="{{ old('detention_free_day', $sd1->detention_free_day) }}"
            ...
            <div class="col-md-6">
                <div class="form-group">
                    ...
                    <input type="number" value="{{ old('demurage_free_day', $sd1->demurage_free_day) }}"
            ...
            <div class="col-md-4">
                <div class="form-group">
                    ...
                    <select class="stuff-select @error('stuff_warehouse_code') is-invalid @enderror"
                        ...
                        <option value="{{ old('stuff_warehouse_code', $sd1->stuff_warehouse_code) }}">
                            {{ old('stuff_warehouse_code', $sd1->stuff_warehouse_code) }}</option>
                    </select>
            ...
            <div class="col-md-8">
                <div class="form-group">
                    ...
                    <input type="text" readonly class="form-control stuff-name"
                        value="{{ old('stuff_warehouse_name', $sd1->stuff_warehouse_name) }}"
                        name="stuff_warehouse_name" id="stuff-name-1">
                </div>
            </div>
        </div>
        <div class="form-group">
            <label for="permit_no">Permit/Approval No.</label>
            <input type="number" value="{{ old('permit_no', $sd1->permit_no) }}"
