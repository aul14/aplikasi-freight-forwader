<div class="row">
    <div class="col-md-6">
        ...
        <div class="form-group">
            ...
            <input type="text" value="{{ old('consignee_contact') }}"
        ...
        <div class="row">
            <div class="col-md-6">
                <div class="form-group">
                    ...
                    <input type="number" value="{{ old('consignee_telp') }}"
            ...
            <div class="col-md-6">
                <div class="form-group">
                    ...
                    <input type="number" value="{{ old('consignee_postal_code') }}"
    ...
    <div class="col-md-6">
        ...
        <div class="row">
            <div class="col-md-6">
                <div class="form-group">
                    ...
                    <div class="col-md-6">
                        <input type="checkbox" name="do_ready" @checked(old('do_ready') == 'yes') value="yes"
            ...
            <div class="col-md-6">
                <div class="form-group">
                    ...
                    <input type="text" value="{{ old('do_ready_remark') }}"
        ...
        <div class="form-group">
            ...
            <div class="col-md-6">
                <input type="checkbox" name="telex_release" @checked(old('telex_release') == 'yes') value="yes"
                    data-toggle="toggle" data-on="Yes" data-off="No" data-onstyle="primary"
                    data-offstyle="danger">
                @error('telex_release')
                    <div class="invalid-feedback">
        ...
        <div class="form-group">
            ...
            <select class="select-2 @error('frt_pp_cc') is-invalid @enderror" name="frt_pp_cc">
                <option value="PREPAID" @selected(old('frt_pp_cc') == 'PREPAID')>PREPAID</option>
                <option value="COLLECT" @selected(old('frt_pp_cc') == 'COLLECT')>COLLECT</option>
            </select>
            @error('frt_pp_cc')
                <div class="invalid-feedback">
                    {{ $message }}
            ...
            <div class="col-md-12">
                <div class="col-md-12">
                    ...
                    <div class="row align-items-center">
                        ...
                        <div class="col-md-7 mt-2">
                            <div class="form-group">
                                <input type="text" value="{{ old('footer_1') }}" placeholder="Footer 1"
                        ...
                        <div class="col-md-7 mt-2">
                            <div class="form-group">
                                <input type="text" value="{{ old('footer_2') }}" placeholder="Footer 2"
                        ...
                        <div class="col-md-7 mt-2">
                            <div class="form-group">
                                <input type="text" value="{{ old('footer_3') }}" placeholder="Footer 3"
                        ...
                        <div class="col-md-7 mt-2">
                            <div class="form-group">
                                <input type="text" value="{{ old('footer_4') }}" placeholder="Footer 4"
                        ...
                        <div class="col-md-7 mt-2">
                            <div class="form-group">
                                <input type="text" value="{{ old('footer_5') }}" placeholder="Footer 5"
