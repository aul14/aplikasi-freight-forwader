        ...
        <div class="col-12">
            ...
            <div class="card">
                <div class="card-header pb-0">
                    <h6>Form Add Sea Import Job</h6>
                </div>
                <form action="{{ route('sea_im_job.store') }}" method="post">
                    @csrf
                    @method('POST')
                    <div class="card-body">
                        <div class="row">
                                ...
                                <div class="tabset">
                                    ...
                                    <div class="tab-panels col-md-12">
                                        <section id="b_l" class="tab-panel">
                                            @include('trx.sea_im_job.bl')
                                        </section>

                                        <section id="d_i" class="tab-panel">
                                            @include('trx.sea_im_job.di')
                                        </section>

                                        <section id="s_i" class="tab-panel">
                                            @include('trx.sea_im_job.si')
                                        </section>

                                        <section id="v_d" class="tab-panel">
                                            @include('trx.sea_im_job.vd')
                                        </section>

                                        <section id="c_i" class="tab-panel">
                                            @include('trx.sea_im_job.ci')
                                        </section>

                                        <section id="j_c" class="tab-panel">
                                            @include('trx.sea_im_job.jc')
                                        </section>
                                    </div>
                                </div>
                            </div>
