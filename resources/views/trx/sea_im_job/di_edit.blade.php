<div class="row">
        ...
        <div class="row">
            <div class="col-md-12">
                    ...
                    <div class="col-md-7 mt-2">
                        <div class="form-group">
                            <select class="collect-select @error('collect_from_code') is-invalid @enderror"
                                ...
                                <option value="{{ old('collect_from_code', $sd1->collect_from_code) }}">
                                    {{ old('collect_from_code', $sd1->collect_from_code) }}</option>
                            </select>
                ...
                <div class="row align-items-center">
                    ...
                    <div class="col-md-7 mt-2">
                        <div class="form-group">
                            <input type="text" value="{{ old('collect_from_name', $sd1->collect_from_name) }}"
                ...
                <div class="row align-items-center">
                    ...
                    <div class="col-md-7 mt-2">
                        <div class="form-group">
                            <input type="text"
                                value="{{ old('collect_from_address_1', $sd1->collect_from_address_1) }}"
                    ...
                    <div class="col-md-7 mt-2">
                        <div class="form-group">
                            <input type="text"
                                value="{{ old('collect_from_address_2', $sd1->collect_from_address_2) }}"
                    ...
                    <div class="col-md-7 mt-2">
                        <div class="form-group">
                            <input type="text"
                                value="{{ old('collect_from_address_3', $sd1->collect_from_address_3) }}"
                    ...
                    <div class="col-md-7 mt-2">
                        <div class="form-group">
                            <input type="text"
                                value="{{ old('collect_from_address_4', $sd1->collect_from_address_4) }}"
        ...
        <div class="row">
            <div class="col-md-12">
                    ...
                    <div class="col-md-7 mt-2">
                        <div class="form-group">
                            <select class="delivery-select @error('delivery_to_code') is-invalid @enderror"
                                ...
                                <option value="{{ old('delivery_to_code', $sd1->delivery_to_code) }}">
                                    {{ old('delivery_to_code', $sd1->delivery_to_code) }}</option>
                            </select>
                ...
                <div class="row align-items-center">
                    ...
                    <div class="col-md-7 mt-2">
                        <div class="form-group">
                            <input type="text" value="{{ old('delivery_to_name', $sd1->delivery_to_name) }}"
                ...
                <div class="row align-items-center">
                    ...
                    <div class="col-md-7 mt-2">
                        <div class="form-group">
                            <input type="text"
                                value="{{ old('delivery_to_address_1', $sd1->delivery_to_address_1) }}"
                    ...
                    <div class="col-md-7 mt-2">
                        <div class="form-group">
                            <input type="text"
                                value="{{ old('delivery_to_address_2', $sd1->delivery_to_address_2) }}"
                    ...
                    <div class="col-md-7 mt-2">
                        <div class="form-group">
                            <input type="text"
                                value="{{ old('delivery_to_address_3', $sd1->delivery_to_address_3) }}"
                    ...
                    <div class="col-md-7 mt-2">
                        <div class="form-group">
                            <input type="text"
                                value="{{ old('delivery_to_address_4', $sd1->delivery_to_address_4) }}"
            ...
            <div class="col-md-12">
                    ...
                    <div class="col-md-7 mt-2">
                        <div class="form-group">
                            <select class="transport-select @error('transport_company_code') is-invalid @enderror"
                                ...
                                <option value="{{ old('transport_company_code', $sd1->transport_company_code) }}">
                                    {{ old('transport_company_code', $sd1->transport_company_code) }}</option>
                            </select>
                ...
                <div class="row align-items-center">
                    ...
                    <div class="col-md-7 mt-2">
                        <div class="form-group">
                            <input type="text"
                                value="{{ old('transport_company_name', $sd1->transport_company_name) }}"
                ...
                <div class="row align-items-center">
                    ...
                    <div class="col-md-7 mt-2">
                        <div class="form-group">
                            <input type="text"
                                value="{{ old('transport_company_address_1', $sd1->transport_company_address_1) }}"
                    ...
                    <div class="col-md-7 mt-2">
                        <div class="form-group">
                            <input type="text"
                                value="{{ old('transport_company_address_2', $sd1->transport_company_address_2) }}"
                    ...
                    <div class="col-md-7 mt-2">
                        <div class="form-group">
                            <input type="text"
                                value="{{ old('transport_company_address_3', $sd1->transport_company_address_3) }}"
                    ...
                    <div class="col-md-7 mt-2">
                        <div class="form-group">
                            <input type="text"
                                value="{{ old('transport_company_address_4', $sd1->transport_company_address_4) }}"
    ...
    <div class="col-md-6">
        <div class="form-group">
            ...
            <input type="text"
                value="{{ old('transport_company_contact_name', $sd1->transport_company_contact_name) }}"
        ...
        <div class="row">
            <div class="col-md-6">
                <div class="form-group">
                    ...
                    <input type="text" value="{{ old('transport_company_telp', $sd1->transport_company_telp) }}"
            ...
            <div class="col-md-6">
                <div class="form-group">
                    ...
                    <input type="text" value="{{ old('transport_company_fax', $sd1->transport_company_fax) }}"
        ...
        <div class="row">
            <div class="col-md-6">
                <div class="form-group">
                    ...
                    <input type="text" value="{{ old('cr_no', $sd1->cr_no) }}"
            ...
            <div class="col-md-6">
                <div class="form-group">
                    ...
                    <input type="text" value="{{ old('vehicle_no', $sd1->vehicle_no) }}"
        ...
        <div class="row">
            <div class="col-md-6">
                <div class="form-group">
                    ...
                    <input type="text"
                        value="{{ old('delivery_date', !empty($sd1->delivery_date) ? date('Y/m/d H:i', strtotime($sd1->delivery_date)) : '') }}"
            ...
            <div class="col-md-6">
                <div class="form-group">
                    ...
                    <input type="text" value="{{ old('driver_name', $sd1->driver_name) }}"
        ...
        <div class="row">
            <div class="col-md-6">
                <div class="form-group">
                    ...
                    <input type="text" value="{{ old('driver_contact_1', $sd1->driver_contact_1) }}"
            ...
            <div class="col-md-6">
                <div class="form-group">
                    ...
                    <input type="text" value="{{ old('driver_contact_2', $sd1->driver_contact_2) }}"
        ...
        <div class="row">
            <div class="col-md-6">
                <div class="form-group">
                    ...
                    <input type="text" value="{{ old('delivery_instruction_1', $sd1->delivery_instruction_1) }}"
            ...
            <div class="col-md-6">
                <div class="form-group">
                    ...
                    <input type="text" value="{{ old('delivery_instruction_2', $sd1->delivery_instruction_2) }}"
            ...
            <div class="col-md-6">
                <div class="form-group">
                    ...
                    <input type="text" value="{{ old('delivery_instruction_3', $sd1->delivery_instruction_3) }}"
            ...
            <div class="col-md-6">
                <div class="form-group">
                    ...
                    <input type="text" value="{{ old('delivery_instruction_4', $sd1->delivery_instruction_4) }}"
