        ...
        <div class="col-12">
            ...
            <div class="card">
                <div class="card-header pb-0">
                    <h6>Form Edit Sea Import Job</h6>
                </div>
                <form action="{{ route('sea_im_job.update', $sj->id) }}" method="post">
                    @csrf
                    @method('PUT')
                    <div class="card-body">
                        <div class="row">
                            <div class="col-md-12">
                                <div class="tabset">
                                    ...
                                    <!-- Tab 2 -->
                                    <input type="radio" name="tabset" id="tab2" aria-controls="d_i">
                                    <label for="tab2">Delivery Info</label>
                                    <!-- Tab 3 -->
                                    ...
                                    <!-- Tab 5 -->
                                    <input type="radio" name="tabset" id="tab5" aria-controls="c_i">
                                    <label for="tab5">Cargo Info</label>
                                    <!-- Tab 6 -->
                                    ...
                                    <div class="tab-panels col-md-12">
                                        <section id="b_l" class="tab-panel">
                                            @include('trx.sea_im_job.bl_edit', ['jm' => $sj->jm])
                                        </section>

                                        <section id="d_i" class="tab-panel">
                                            @include('trx.sea_im_job.di_edit', ['sd1' => $sj->sd1])
                                        </section>

                                        <section id="s_i" class="tab-panel">
                                            @include('trx.sea_im_job.si_edit', ['sd2' => $sj->sd2])
                                        </section>

                                        <section id="v_d" class="tab-panel">
                                            @include('trx.sea_im_job.vd_edit', ['sd3' => $sj->sd3])
                                        </section>

                                        <section id="c_i" class="tab-panel">
                                            @include('trx.sea_im_job.ci_edit', ['sd4' => $sj->sd4])
                                        </section>

                                        <section id="j_c" class="tab-panel">
                                            @include('trx.sea_im_job.jc_edit', ['sd5' => $sj->sd5])
                                        </section>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <a href="{{ route('sea_im_job.index') }}" class="btn btn-danger btn-back">Back</a>
