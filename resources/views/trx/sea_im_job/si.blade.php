<div class="row">
    <div class="col-md-6">
        ...
        <div class="form-group">
            ...
            <div class="col-md-6">
                <input type="checkbox" name="dg_cargo" @checked(old('dg_cargo') == 'yes') value="yes" data-toggle="toggle"
        ...
        <div class="row">
            <div class="col-md-4">
                <div class="form-group">
                    ...
                    <select class="origin-select @error('origin_code') is-invalid @enderror" required
                        ...
                        <option value="{{ old('origin_code') }}">{{ old('origin_code') }}</option>
                    </select>
                    @error('origin_code')
                        <div class="invalid-feedback">
                            {{ $message }}
            ...
            <div class="col-md-8">
                <div class="form-group">
                    ...
                    <input type="text" readonly value="{{ old('origin_name') }}"
        ...
        <div class="row">
            <div class="col-md-4">
                <div class="form-group">
                    ...
                    <select class="dest-select @error('dest_code') is-invalid @enderror" id="dest-select-1"
                        name="dest_code">
                        <option value="{{ old('dest_code', 'JKT') }}">{{ old('dest_code', 'JKT') }}</option>
                    </select>
                    @error('dest_code')
                        <div class="invalid-feedback">
                            {{ $message }}
            ...
            <div class="col-md-8">
                <div class="form-group">
                    ...
                    <input type="text" readonly value="{{ old('dest_name', 'JAKARTA') }}"
        ...
        <div class="form-group">
            ...
            <input type="text" value="{{ old('place_of_receipt', 'CFS') }}"
            ...
            <div class="col-md-4">
                <div class="form-group">
                    ...
                    <select class="portloading-select @error('port_loading_code') is-invalid @enderror" required
                        ...
                        <option value="{{ old('port_loading_code') }}">
                            {{ old('port_loading_code') }}</option>
                    </select>
            ...
            <div class="col-md-8">
                <div class="form-group">
                    ...
                    <input type="text" readonly class="form-control portloading-name"
                        value="{{ old('port_loading_name') }}" name="port_loading_name" id="portloading-name-1">
                </div>
            </div>
        </div>
        <div class="row">
            ...
            <div class="col-md-4">
                <div class="form-group">
                    ...
                    <select class="portdischarge-select @error('port_discharge_code') is-invalid @enderror" required
                        ...
                        <option value="{{ old('port_discharge_code', 'IDJKT') }}">
                            {{ old('port_discharge_code', 'IDJKT') }}</option>
                    </select>
            ...
            <div class="col-md-8">
                <div class="form-group">
                    ...
                    <input type="text" readonly class="form-control portdischarge-name"
                        value="{{ old('port_discharge_name', 'JAKARTA, INDONESIA') }}" name="port_discharge_name"
        ...
        <div class="form-group">
            ...
            <input type="text" value="{{ old('place_of_delivery', 'JAKARTA CFS') }}"
        ...
        <div class="row">
            <div class="col-md-6">
                <div class="form-group">
                    ...
                    <input type="text" value="{{ old('etd') }}" placeholder="ETD" autocomplete="off"
        ...
        <div class="row">
            <div class="col-md-6">
                <div class="form-group">
                    ...
                    <input type="text" value="{{ old('eta') }}" placeholder="ETA" required autocomplete="off"
        ...
        <div class="row">
            <div class="col-md-6">
                <div class="form-group">
                    ...
                    <input type="text" value="{{ old('permit_no') }}"
            ...
            <div class="col-md-6">
                <div class="form-group">
                    ...
                    <input type="text" value="{{ old('letter_of_credit_no') }}"
