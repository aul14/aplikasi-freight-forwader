<div class="row">
    <div class="col-md-6">
        ...
        <div class="row">
            <div class="col-md-6">
                <div class="form-group">
                    ...
                    <input type="text" value="{{ old('unstuff') }}" placeholder="Unstuffing Date" autocomplete="off"
            ...
            <div class="col-md-6">
                <div class="form-group">
                    ...
                    <input type="text" value="{{ old('billing') }}" placeholder="Storage Billing Date"
                        autocomplete="off" class="form-control @error('billing') is-invalid @enderror date-picker"
        ...
        <div class="row">
            <div class="col-md-6">
                <div class="form-group">
                    ...
                    <input type="text" value="{{ old('truck_in') }}" placeholder="Truck In Date" autocomplete="off"
            ...
            <div class="col-md-6">
                <div class="form-group">
                    ...
                    <input type="text" value="{{ old('truck_out') }}" placeholder="Truck Out Date"
                        autocomplete="off"
        ...
        <div class="form-group">
            ...
            <input type="text" value="{{ old('cfs_warehouse_contact') }}"
            ...
            <div class="col-md-8 mt-2">
                <div class="form-group">
                    <select class="cfswarehouse-select @error('cfs_warehouse_code') is-invalid @enderror"
                        ...
                        <option value="{{ old('cfs_warehouse_code') }}">{{ old('cfs_warehouse_code') }}</option>
                    </select>
        ...
        <div class="row align-items-center">
            ...
            <div class="col-md-8 mt-2">
                <div class="form-group">
                    <input type="text" value="{{ old('cfs_warehouse_name') }}" placeholder="CFS Warehouse Name"
        ...
        <div class="row align-items-center">
            ...
            <div class="col-md-8 mt-2">
                <div class="form-group">
                    <input type="text" value="{{ old('cfs_warehouse_address_1') }}"
            ...
            <div class="col-md-8 mt-2">
                <div class="form-group">
                    <input type="text" value="{{ old('cfs_warehouse_address_2') }}"
            ...
            <div class="col-md-8 mt-2">
                <div class="form-group">
                    <input type="text" value="{{ old('cfs_warehouse_address_3') }}"
            ...
            <div class="col-md-8 mt-2">
                <div class="form-group">
                    <input type="text" value="{{ old('cfs_warehouse_address_4') }}"
    ...
    <div class="col-md-6">
        ...
        <div class="form-group">
            ...
            <input type="text" value="{{ old('empty_container') }}" placeholder="Empty Container Date"
                autocomplete="off"
