        ...
        <div class="row mt-2">
            <div class="col-md-4">
                <div class="form-group">
                    ...
                    <select class="salesman-select @error('salesman_code') is-invalid @enderror" required
                        name="salesman_code">
                        <option value="{{ $sq->quotation->salesman_code }}">
                            {{ !empty($sq->quotation->salesman_code) ? $sq->quotation->salesman_code : '' }}</option>
                    </select>
            ...
            <div class="col-md-8">
                <div class="form-group">
                    ...
                    <input type="text"
                        value="{{ old('salesman', !empty($sq->quotation->salesman) ? $sq->quotation->salesman : '') }}"
        ...
        <div class="row mt-2">
            <div class="col-md-4">
                <div class="form-group">
                    ...
                    <select class="customer-select @error('customer_code') is-invalid @enderror" name="customer_code">
                        <option value="{{ $sq->quotation->customer_code }}">
                            {{ !empty($sq->quotation->customer_code) ? $sq->quotation->customer_code : '' }}
                        </option>
                    </select>
            ...
            <div class="col-md-8">
                <div class="form-group">
                    ...
                    <input type="text"
                        value="{{ old('customer', !empty($sq->quotation->customer) ? $sq->quotation->customer : '') }}"
            ...
            <div class="col-md-4">
                <div class="form-group">
                    ...
                    <select class="deltype-select @error('delivery_type_code') is-invalid @enderror"
                        ...
                        <option value="{{ $sq->quotation->delivery_type_code }}">
                            {{ !empty($sq->quotation->delivery_type_code) ? $sq->quotation->delivery_type_code : '' }}
                        </option>
                    </select>
            ...
            <div class="col-md-8">
                <div class="form-group">
                    ...
                    <input type="text" readonly class="form-control"
                        value="{{ !empty($sq->quotation->delivery_type) ? $sq->quotation->delivery_type : '' }}"
        ...
        <div class="row mt-1">
            <div class="col-md-4">
                <div class="form-group">
                    ...
                    <select class="term-select @error('term_code') is-invalid @enderror" name="term_code">
                        <option value="{{ $sq->quotation->term_code }}">
                            {{ !empty($sq->quotation->term_code) ? $sq->quotation->term_code : '' }}
                        </option>
                    </select>
            ...
            <div class="col-md-8">
                <div class="form-group">
                    ...
                    <input type="text"
                        value="{{ old('term', !empty($sq->quotation->term) ? $sq->quotation->term : '') }}" disabled
                        class="form-control" name="term" id="term">
                </div>
            </div>
        </div>
        ...
        <div class="row">
            <div class="col-md-4">
                <div class="form-group">
                    ...
                    <select class="commodity-select @error('commodity_code_name') is-invalid @enderror"
                        ...
                        <option value="{{ $sq->quotation->commodity_code }}">
            ...
            <div class="col-md-8">
                <div class="form-group">
                    ...
                    <input type="text"
                        value="{{ old('commodity', !empty($sq->quotation->commodity) ? $sq->quotation->commodity : '') }}"
            ...
            <div class="d-flex flex-row">
                ...
                <div class="p-2" style="width: 12%">
                    <select name="uom_code" class="uom-select @error('uom_code') is-invalid @enderror">
                        <option value="{{ $sq->quotation->uom_code }}">
                            {{ !empty($sq->quotation->uom_code) ? $sq->quotation->uom_code : '' }}</option>
                    </select>
                    @error('uom_code')
                        <div class="invalid-feedback">
                            {{ $message }}
                ...
                <div class="p-2" style="width: 20%">
                    <input type="text" class="form-control" readonly name="uom_name"
                        value="{{ !empty($sq->quotation->uom) ? $sq->quotation->uom : '' }}" id="uom_name">
                </div>
                <div class="p-1 my-2">/</div>
                <div class="p-2" style="width: 20%">
