        ...
        <div class="col-12">
            ...
            <div class="card mb-4 ">
                <div class="card-header pb-0">
                    <h6>Form Edit Sea Freight Quotation</h6>
                </div>
                <div class="card-body px-0 pt-0 pb-0">
                    <form action="{{ route('sea_quot.update', $sq->id) }}" method="post">
                        @csrf
                        @method('PUT')
                                    ...
                                    <div class="tabset">
                                        ...
                                        <div class="tab-panels col-md-12">
                                            <section id="corres" class="tab-panel">
                                                @include('trx.sea_quot.corres_edit')
                                            </section>
                                            <section id="fch" class="tab-panel">
                                                @include('trx.sea_quot.fch_edit')
                                            </section>
                                            <section id="lch" class="tab-panel">
                                                @include('trx.sea_quot.lch_edit')
                                            </section>
