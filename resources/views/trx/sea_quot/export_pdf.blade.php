        ...
        <div class="page_break">
            ...
            <div class="row">
                <table>
                    ...
                    <tr>
                        <td colspan="5" style="text-align: left;">{{ $sq->quotation->title }}</td>
                    ...
                    <tr>
                        <td colspan="5" style="text-align: left;">
                            {{ !empty($sq->quotation->bisnis_party_id) ? $sq->quotation->bisnis_party->name : '' }}</td>
                ...
                <table>
                    ...
                    <tbody>
                        ...
                        @foreach ($item['sea_quotation_s_d1'] as $item_d1)
                            @php
                                $total_vat = (int) $item_d1['idr_amt'] * ($item_d1['vat']['vat_code_detail_satu'][0]['vat_rate'] / 100);
                                $total = $item_d1['idr_amt'] + $total_vat;
                                $total_all += $total;
                            ...
                            <tr>
                                ...
                                <td style="text-align: right">{{ number_format($item_d1['idr_amt'], 2, '.', ',') }}
                                </td>
