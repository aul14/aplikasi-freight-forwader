    ...
    <div class="row row-list-fch">
        ...
        <div class="col-md-5">
            <div class="row">
                ...
                <div class="col-md-8">
                    <div class="form-group">
                        ...
                        <input type="text" readonly class="form-control portloading-name" name="port_loading_name[]"
            ...
            <div class="row">
                <div class="col-md-4">
                    <div class="form-group">
                        ...
                        <select class="portdischarge-select" id="portdischarge-select-1" name="port_discharge_code[]">
                            <option value=""></option>
                        </select>
                    </div>
                </div>
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control @error('frequency') is-invalid @enderror" name="frequency[]"
                    id="frequency">
            ...
            <div class="row">
                ...
                <div class="col-md-8">
                    <div class="form-group">
                        ...
                        <input type="text" readonly class="form-control shipping-name" name="shipping_line_name[]"
                            id="shipping-name-1">
                    </div>
                </div>
            </div>
            ...
            <div class="row">
                ...
                <div class="col-md-8">
                    <div class="form-group">
                        ...
                        <input type="text" readonly class="form-control secondport-name" name="second_port_name[]"
                            id="secondport-name-1">
                    </div>
                </div>
            </div>
            <div class="row">
            ...
            <div class="row">
                ...
                <div class="col-md-8">
                    <div class="form-group">
                        ...
                        <input type="text" readonly class="form-control commodity-name" name="commodity_name[]"
                            id="commodity-name-1">
                    </div>
                </div>
            </div>
    ...
    <script>
        ...
        function add_row_fch(obj) {
            if (totalFields() < maxFields) {
                ...
                obj_new.find(add_btn_fch).attr("id", "add-btn-fch-" + row_number);
