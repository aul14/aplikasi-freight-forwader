            ...
            <div class="card">
                <div class="card-header pb-0">
                    <div class="d-flex align-items-center">
                        @permission('create-sea_quot')
                            <a href="{{ route('sea_quot.create') }}" type="button" class="btn btn-sm btn-primary mb-2">Add</a>
                        @endpermission
                    </div>
                </div>
                        ...
                        <table id="myTable" class="my-table1 table my-tableview my-table-striped table-hover w-100">
                            <thead>
                                <tr>
                                    <th>Action</th>
                                    <th>No</th>
                                    <th class="select-filter">Sea Quotation No</th>
                                    <th class="select-filter">Sea Quotation Date</th>
                            ...
                            <tfoot>
                                <tr>
                                    <th></th>
                                    <th></th>
                                    <th>Sea Quotation No</th>
                                    <th>Sea Quotation Date</th>
                                    <th>Validity Date</th>
                                    <th>Customer Code</th>
                                    <th>Salesman Code</th>
